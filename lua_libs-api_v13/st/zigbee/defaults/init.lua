...
---
--- @param driver st.zigbee.Driver
--- @param capabilities table capabilities for which to register defaults
--- @param opts table options, `native_capability_cmds_enabled` is only option available and is a boolean
function default_handlers.register_for_default_handlers(driver, capabilities, opts)
  ...
  driver.default_handler_opts = opts or {}
