...
---
--- Some DTHs (smartsense-motion-sensor) did not configure this attribute for reporting and doing so
--- in the driver has led to significant battery drain. This should only be done if the device will
--- report these values anyway.
---
--- @param device st.zigbee.Device The device that should _not_ configure reporting
function motionSensor_defaults.disable_ias_reporting_configuration(device)
