...
--- @field public default_active_power_ac_power_divisor_configuration st.zigbee.defaults.powerMeter.ActivePowerACPowerDivisorConfiguration
--- @field public default_active_power_ac_power_multiplier_configuration st.zigbee.defaults.powerMeter.ActiveACPowerMultiplierConfiguration
...
--- @class st.zigbee.defaults.powerMeter.ActivePowerACPowerDivisorConfiguration
--- @field public cluster number ElectricalMeasurement ID 0x0B04
--- @field public attribute number ACPowerDivisor ID 0x0605
--- @field public minimum_interval number 1 seconds
--- @field public maximum_interval number 43200 seconds (12 hour)
--- @field public data_type st.zigbee.data_types.Uint16 the Uint16 class
--- @field public reportable_change number 1
local active_power_ac_power_divisor_configuration = {
  cluster = zcl_clusters.ElectricalMeasurement.ID,
  attribute = zcl_clusters.ElectricalMeasurement.attributes.ACPowerDivisor.ID,
  minimum_interval = 1,
  maximum_interval = 43200,
  data_type = zcl_clusters.ElectricalMeasurement.attributes.ACPowerDivisor.base_type,
  reportable_change = 1
}

--- @class st.zigbee.defaults.powerMeter.ActiveACPowerMultiplierConfiguration
--- @field public cluster number ElectricalMeasurement ID 0x0B04
--- @field public attribute number ACPowerMultiplier ID 0x0604
--- @field public minimum_interval number 1 seconds
--- @field public maximum_interval number 43200 seconds (12 hour)
--- @field public data_type st.zigbee.data_types.Uint16 the Uint16 class
--- @field public reportable_change number 1
...
powerMeter_defaults.default_active_power_ac_power_divisor_configuration = active_power_ac_power_divisor_configuration
powerMeter_defaults.default_active_power_ac_power_multiplier_configuration = active_power_ac_power_multiplier_configuration
...
powerMeter_defaults.attribute_configurations = {
  ...
  active_power_ac_power_divisor_configuration,
  active_power_ac_power_multiplier_configuration,
