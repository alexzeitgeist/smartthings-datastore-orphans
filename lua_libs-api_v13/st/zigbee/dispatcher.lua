...
--- the corresponding ZigbeeMessageGlobalCommandHandler,
--- ZigbeeMessageClusterCommandHandler, ZigbeeMessageHandler or
--- CommandResponseHandler.
---
function ZigbeeMessageDispatcher:standardize_default_handlers()
  utils.merge(self.default_handlers, {
    attr = {},
    global = {},
    cluster = {},
    zdo = {}
  ...
  self.default_handlers.global = new_globals
  ...
  self.default_handlers.cluster = new_clusters

  local new_zdos = {}
  for cluster, handlers in pairs(self.default_handlers.zdo) do
    new_zdos[cluster] = ZigbeeMessageHandler("ZdoHandler", handlers)
  end
  self.default_handlers.zdo = new_zdos
