...
-----------------------------------------------------------
-- DeviceEnergyManagement command ModifyForecastRequest
-----------------------------------------------------------

--- @class st.matter.clusters.DeviceEnergyManagement.ModifyForecastRequest
--- @alias ModifyForecastRequest
---
--- @field public ID number 0x0005 the ID of this command
--- @field public NAME string "ModifyForecastRequest" the name of this command
--- @field public forecastid st.matter.data_types.Uint32
--- @field public slot_adjustments st.matter.data_types.Array
--- @field public cause st.matter.generated.zap_clusters.DeviceEnergyManagement.types.AdjustmentCauseEnum
local ModifyForecastRequest = {}

ModifyForecastRequest.NAME = "ModifyForecastRequest"
ModifyForecastRequest.ID = 0x0005
ModifyForecastRequest.field_defs = {
  {
    name = "forecastid",
    field_id = 0,
    is_nullable = false,
  ...
  {
    name = "slot_adjustments",
    field_id = 1,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.data_types.Array",
    element_type = require "st.matter.generated.zap_clusters.DeviceEnergyManagement.types.SlotAdjustmentStruct",
  },
  {
    name = "cause",
    field_id = 2,
...
function ModifyForecastRequest:build_test_command_response(device, endpoint_id, status)
...
---
--- @param self ModifyForecastRequest the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param forecastid st.matter.data_types.Uint32
--- @param slot_adjustments st.matter.data_types.Array
...
function ModifyForecastRequest:init(device, endpoint_id, forecastid, slot_adjustments, cause)
  local out = {}
  local args = {forecastid, slot_adjustments, cause}
  ...
  setmetatable(out, {
    __index = ModifyForecastRequest,
    __tostring = ModifyForecastRequest.pretty_print
  })
...
function ModifyForecastRequest:set_parent_cluster(cluster)
...
function ModifyForecastRequest:augment_type(base_type_obj)
  local elems = {}
...
function ModifyForecastRequest:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(ModifyForecastRequest, {__call = ModifyForecastRequest.init})
