...
-----------------------------------------------------------
-- DeviceEnergyManagement command StartTimeAdjustRequest
-----------------------------------------------------------

--- @class st.matter.clusters.DeviceEnergyManagement.StartTimeAdjustRequest
--- @alias StartTimeAdjustRequest
---
--- @field public ID number 0x0002 the ID of this command
--- @field public NAME string "StartTimeAdjustRequest" the name of this command
--- @field public requested_start_time st.matter.data_types.Uint32
--- @field public cause st.matter.generated.zap_clusters.DeviceEnergyManagement.types.AdjustmentCauseEnum
local StartTimeAdjustRequest = {}

StartTimeAdjustRequest.NAME = "StartTimeAdjustRequest"
StartTimeAdjustRequest.ID = 0x0002
StartTimeAdjustRequest.field_defs = {
  {
...
function StartTimeAdjustRequest:build_test_command_response(device, endpoint_id, status)
...
---
--- @param self StartTimeAdjustRequest the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param requested_start_time st.matter.data_types.Uint32
...
function StartTimeAdjustRequest:init(device, endpoint_id, requested_start_time, cause)
  local out = {}
  local args = {requested_start_time, cause}
  ...
  setmetatable(out, {
    __index = StartTimeAdjustRequest,
    __tostring = StartTimeAdjustRequest.pretty_print
  })
...
function StartTimeAdjustRequest:set_parent_cluster(cluster)
...
function StartTimeAdjustRequest:augment_type(base_type_obj)
  local elems = {}
...
function StartTimeAdjustRequest:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(StartTimeAdjustRequest, {__call = StartTimeAdjustRequest.init})
