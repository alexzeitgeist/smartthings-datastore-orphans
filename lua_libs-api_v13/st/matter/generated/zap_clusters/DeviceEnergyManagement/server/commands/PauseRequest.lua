...
-----------------------------------------------------------
-- DeviceEnergyManagement command PauseRequest
-----------------------------------------------------------

--- @class st.matter.clusters.DeviceEnergyManagement.PauseRequest
--- @alias PauseRequest
---
--- @field public ID number 0x0003 the ID of this command
--- @field public NAME string "PauseRequest" the name of this command
...
PauseRequest.NAME = "PauseRequest"
PauseRequest.ID = 0x0003
PauseRequest.field_defs = {
  {
    name = "duration",
    field_id = 0,
    is_nullable = false,
...
function PauseRequest:build_test_command_response(device, endpoint_id, status)
...
---
--- @param self PauseRequest the template class for this command
--- @param device st.matter.Device the device to build this message to
...
function PauseRequest:init(device, endpoint_id, duration, cause)
  local out = {}
  local args = {duration, cause}
  ...
  setmetatable(out, {
    __index = PauseRequest,
    __tostring = PauseRequest.pretty_print
  })
...
function PauseRequest:set_parent_cluster(cluster)
...
function PauseRequest:augment_type(base_type_obj)
  local elems = {}
...
function PauseRequest:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(PauseRequest, {__call = PauseRequest.init})
