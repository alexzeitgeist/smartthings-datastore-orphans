...
-----------------------------------------------------------
-- DeviceEnergyManagement command CancelPowerAdjustRequest
-----------------------------------------------------------

--- @class st.matter.clusters.DeviceEnergyManagement.CancelPowerAdjustRequest
--- @alias CancelPowerAdjustRequest
---
--- @field public ID number 0x0001 the ID of this command
--- @field public NAME string "CancelPowerAdjustRequest" the name of this command
local CancelPowerAdjustRequest = {}

CancelPowerAdjustRequest.NAME = "CancelPowerAdjustRequest"
CancelPowerAdjustRequest.ID = 0x0001
CancelPowerAdjustRequest.field_defs = {
}
...
function CancelPowerAdjustRequest:build_test_command_response(device, endpoint_id, status)
...
---
--- @param self CancelPowerAdjustRequest the template class for this command
--- @param device st.matter.Device the device to build this message to

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function CancelPowerAdjustRequest:init(device, endpoint_id)
  local out = {}
  local args = {}
  ...
  setmetatable(out, {
    __index = CancelPowerAdjustRequest,
    __tostring = CancelPowerAdjustRequest.pretty_print
  })
...
function CancelPowerAdjustRequest:set_parent_cluster(cluster)
...
function CancelPowerAdjustRequest:augment_type(base_type_obj)
  local elems = {}
...
function CancelPowerAdjustRequest:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(CancelPowerAdjustRequest, {__call = CancelPowerAdjustRequest.init})
