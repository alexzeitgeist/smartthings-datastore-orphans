...
-----------------------------------------------------------
-- DeviceEnergyManagement command CancelRequest
-----------------------------------------------------------

--- @class st.matter.clusters.DeviceEnergyManagement.CancelRequest
--- @alias CancelRequest
---
--- @field public ID number 0x0007 the ID of this command
--- @field public NAME string "CancelRequest" the name of this command
local CancelRequest = {}

CancelRequest.NAME = "CancelRequest"
CancelRequest.ID = 0x0007
CancelRequest.field_defs = {
}
...
function CancelRequest:build_test_command_response(device, endpoint_id, status)
...
---
--- @param self CancelRequest the template class for this command
--- @param device st.matter.Device the device to build this message to

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function CancelRequest:init(device, endpoint_id)
  local out = {}
  local args = {}
  ...
  setmetatable(out, {
    __index = CancelRequest,
    __tostring = CancelRequest.pretty_print
  })
...
function CancelRequest:set_parent_cluster(cluster)
...
function CancelRequest:augment_type(base_type_obj)
  local elems = {}
...
function CancelRequest:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(CancelRequest, {__call = CancelRequest.init})
