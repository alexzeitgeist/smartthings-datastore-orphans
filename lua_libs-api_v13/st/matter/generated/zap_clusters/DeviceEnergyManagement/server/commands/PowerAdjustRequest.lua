...
-----------------------------------------------------------
-- DeviceEnergyManagement command PowerAdjustRequest
-----------------------------------------------------------

--- @class st.matter.clusters.DeviceEnergyManagement.PowerAdjustRequest
--- @alias PowerAdjustRequest
---
--- @field public ID number 0x0000 the ID of this command
--- @field public NAME string "PowerAdjustRequest" the name of this command
--- @field public power st.matter.data_types.Int64
--- @field public duration st.matter.data_types.Uint32
--- @field public cause st.matter.generated.zap_clusters.DeviceEnergyManagement.types.AdjustmentCauseEnum
local PowerAdjustRequest = {}

PowerAdjustRequest.NAME = "PowerAdjustRequest"
PowerAdjustRequest.ID = 0x0000
PowerAdjustRequest.field_defs = {
  {
    name = "power",
    field_id = 0,
    is_nullable = false,
...
function PowerAdjustRequest:build_test_command_response(device, endpoint_id, status)
...
---
--- @param self PowerAdjustRequest the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param power st.matter.data_types.Int64
--- @param duration st.matter.data_types.Uint32
...
function PowerAdjustRequest:init(device, endpoint_id, power, duration, cause)
  local out = {}
  local args = {power, duration, cause}
  ...
  setmetatable(out, {
    __index = PowerAdjustRequest,
    __tostring = PowerAdjustRequest.pretty_print
  })
...
function PowerAdjustRequest:set_parent_cluster(cluster)
...
function PowerAdjustRequest:augment_type(base_type_obj)
  local elems = {}
...
function PowerAdjustRequest:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(PowerAdjustRequest, {__call = PowerAdjustRequest.init})
