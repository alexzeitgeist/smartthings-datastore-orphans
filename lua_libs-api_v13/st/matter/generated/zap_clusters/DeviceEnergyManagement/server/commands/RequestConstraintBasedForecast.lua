...
-----------------------------------------------------------
-- DeviceEnergyManagement command RequestConstraintBasedForecast
-----------------------------------------------------------

--- @class st.matter.clusters.DeviceEnergyManagement.RequestConstraintBasedForecast
--- @alias RequestConstraintBasedForecast
---
--- @field public ID number 0x0006 the ID of this command
--- @field public NAME string "RequestConstraintBasedForecast" the name of this command
--- @field public constraints st.matter.data_types.Array
--- @field public cause st.matter.generated.zap_clusters.DeviceEnergyManagement.types.AdjustmentCauseEnum
local RequestConstraintBasedForecast = {}

RequestConstraintBasedForecast.NAME = "RequestConstraintBasedForecast"
RequestConstraintBasedForecast.ID = 0x0006
RequestConstraintBasedForecast.field_defs = {
  {
    name = "constraints",
    field_id = 0,
    is_nullable = false,
    ...
    element_type = require "st.matter.generated.zap_clusters.DeviceEnergyManagement.types.ConstraintsStruct",
  },
  {
    name = "cause",
    field_id = 1,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.DeviceEnergyManagement.types.AdjustmentCauseEnum",
  },
}
...
function RequestConstraintBasedForecast:build_test_command_response(device, endpoint_id, status)
...
---
--- @param self RequestConstraintBasedForecast the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param constraints st.matter.data_types.Array
--- @param cause st.matter.generated.zap_clusters.DeviceEnergyManagement.types.AdjustmentCauseEnum

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function RequestConstraintBasedForecast:init(device, endpoint_id, constraints, cause)
  local out = {}
  local args = {constraints, cause}
  ...
  setmetatable(out, {
    __index = RequestConstraintBasedForecast,
    __tostring = RequestConstraintBasedForecast.pretty_print
  })
...
function RequestConstraintBasedForecast:set_parent_cluster(cluster)
...
function RequestConstraintBasedForecast:augment_type(base_type_obj)
  local elems = {}
...
function RequestConstraintBasedForecast:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(RequestConstraintBasedForecast, {__call = RequestConstraintBasedForecast.init})
