...
-----------------------------------------------------------
-- DeviceEnergyManagement command ResumeRequest
-----------------------------------------------------------

--- @class st.matter.clusters.DeviceEnergyManagement.ResumeRequest
--- @alias ResumeRequest
---
--- @field public ID number 0x0004 the ID of this command
--- @field public NAME string "ResumeRequest" the name of this command
local ResumeRequest = {}

ResumeRequest.NAME = "ResumeRequest"
ResumeRequest.ID = 0x0004
ResumeRequest.field_defs = {
}
...
function ResumeRequest:build_test_command_response(device, endpoint_id, status)
...
---
--- @param self ResumeRequest the template class for this command
--- @param device st.matter.Device the device to build this message to

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function ResumeRequest:init(device, endpoint_id)
  local out = {}
  local args = {}
  ...
  setmetatable(out, {
    __index = ResumeRequest,
    __tostring = ResumeRequest.pretty_print
  })
...
function ResumeRequest:set_parent_cluster(cluster)
...
function ResumeRequest:augment_type(base_type_obj)
  local elems = {}
...
function ResumeRequest:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(ResumeRequest, {__call = ResumeRequest.init})
