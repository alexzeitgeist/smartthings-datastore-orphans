...
--- @class st.matter.clusters.DeviceEnergyManagement.PowerAdjustEnd
--- @alias PowerAdjustEnd
---
--- @field public ID number 0x0001 the ID of this event
--- @field public NAME string "PowerAdjustEnd" the name of this event
--- @field public cause st.matter.generated.zap_clusters.DeviceEnergyManagement.types.CauseEnum
--- @field public duration st.matter.data_types.Uint32
--- @field public energy_use st.matter.data_types.Int64
local PowerAdjustEnd = {
  ID = 0x0001,
  NAME = "PowerAdjustEnd",
  base_type = data_types.Structure,
}

PowerAdjustEnd.field_defs = {
  {
    name = "cause",
    field_id = 0,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.DeviceEnergyManagement.types.CauseEnum",
  },
  {
    name = "duration",
    field_id = 1,
...
function PowerAdjustEnd:augment_type(base_type_obj)
  local elems = {}
...
function PowerAdjustEnd:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function PowerAdjustEnd:subscribe(device, endpoint_id)
...
function PowerAdjustEnd:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "PowerAdjustEndEventData", ID = 0x15}))
...
function PowerAdjustEnd:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function PowerAdjustEnd:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

return PowerAdjustEnd
