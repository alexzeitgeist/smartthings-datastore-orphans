...
--- @class st.matter.clusters.DeviceEnergyManagement.PowerAdjustStart
--- @alias PowerAdjustStart
---
--- @field public ID number 0x0000 the ID of this event
--- @field public NAME string "PowerAdjustStart" the name of this event
local PowerAdjustStart = {
  ID = 0x0000,
  NAME = "PowerAdjustStart",
  base_type = data_types.Structure,
}

PowerAdjustStart.field_defs = {
}
--- Add field names to each event field
---
--- @param base_type_obj st.matter.data_types.Structure
function PowerAdjustStart:augment_type(base_type_obj)
  local elems = {}
...
function PowerAdjustStart:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function PowerAdjustStart:subscribe(device, endpoint_id)
...
function PowerAdjustStart:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "PowerAdjustStartEventData", ID = 0x15}))
...
function PowerAdjustStart:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function PowerAdjustStart:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

return PowerAdjustStart
