...
--- @class st.matter.clusters.DeviceEnergyManagement.AbsMaxPower
--- @alias AbsMaxPower
---
--- @field public ID number 0x0004 the ID of this attribute
--- @field public NAME string "AbsMaxPower" the name of this attribute
--- @field public data_type st.matter.data_types.Int64 the data type of this attribute
...
--- @return st.matter.data_types.Int64
function AbsMaxPower:new_value(...)
...
function AbsMaxPower:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function AbsMaxPower:subscribe(device, endpoint_id)
...
function AbsMaxPower:set_parent_cluster(cluster)
...
function AbsMaxPower:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function AbsMaxPower:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(AbsMaxPower, {__call = AbsMaxPower.new_value, __index = AbsMaxPower.base_type})
return AbsMaxPower
