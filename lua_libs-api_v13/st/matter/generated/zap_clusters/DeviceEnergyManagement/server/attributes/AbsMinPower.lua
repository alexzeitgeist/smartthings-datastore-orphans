...
--- @class st.matter.clusters.DeviceEnergyManagement.AbsMinPower
--- @alias AbsMinPower
---
--- @field public ID number 0x0003 the ID of this attribute
--- @field public NAME string "AbsMinPower" the name of this attribute
...
function AbsMinPower:new_value(...)
...
function AbsMinPower:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function AbsMinPower:subscribe(device, endpoint_id)
...
function AbsMinPower:set_parent_cluster(cluster)
...
function AbsMinPower:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function AbsMinPower:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(AbsMinPower, {__call = AbsMinPower.new_value, __index = AbsMinPower.base_type})
return AbsMinPower
