...
--- @class st.matter.clusters.DeviceEnergyManagement.ESACanGenerate
--- @alias ESACanGenerate
---
--- @field public ID number 0x0001 the ID of this attribute
--- @field public NAME string "ESACanGenerate" the name of this attribute
--- @field public data_type st.matter.data_types.Boolean the data type of this attribute

local ESACanGenerate = {
  ID = 0x0001,
  NAME = "ESACanGenerate",
...
function ESACanGenerate:new_value(...)
...
function ESACanGenerate:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ESACanGenerate:subscribe(device, endpoint_id)
...
function ESACanGenerate:set_parent_cluster(cluster)
...
function ESACanGenerate:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ESACanGenerate:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(ESACanGenerate, {__call = ESACanGenerate.new_value, __index = ESACanGenerate.base_type})
