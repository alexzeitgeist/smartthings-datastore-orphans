...
--- @alias ConstraintsStruct
--- @class st.matter.clusters.DeviceEnergyManagement.types.ConstraintsStruct: st.matter.data_types.Structure
---
...
--- @field public maximum_energy st.matter.data_types.Int64
--- @field public load_control st.matter.data_types.Int8
local ConstraintsStruct = {}
local new_mt = StructureABC.new_mt({NAME = "ConstraintsStruct", ID = data_types.name_to_id_map["Structure"]})

ConstraintsStruct.field_defs = {
  {
    name = "start_time",
    field_id = 0,
    is_nullable = false,
...
ConstraintsStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
ConstraintsStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = ConstraintsStruct.init
new_mt.__index.serialize = ConstraintsStruct.serialize

ConstraintsStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(ConstraintsStruct, new_mt)

return ConstraintsStruct
