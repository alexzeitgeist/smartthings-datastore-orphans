...
--- @alias SlotAdjustmentStruct
--- @class st.matter.clusters.DeviceEnergyManagement.types.SlotAdjustmentStruct: st.matter.data_types.Structure
---
--- @field public slot_index st.matter.data_types.Uint8
--- @field public nominal_power st.matter.data_types.Int64
--- @field public duration st.matter.data_types.Uint32
local SlotAdjustmentStruct = {}
local new_mt = StructureABC.new_mt({NAME = "SlotAdjustmentStruct", ID = data_types.name_to_id_map["Structure"]})

SlotAdjustmentStruct.field_defs = {
  {
    name = "slot_index",
    field_id = 0,
    is_nullable = false,
...
SlotAdjustmentStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
SlotAdjustmentStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = SlotAdjustmentStruct.init
new_mt.__index.serialize = SlotAdjustmentStruct.serialize

SlotAdjustmentStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(SlotAdjustmentStruct, new_mt)

return SlotAdjustmentStruct
