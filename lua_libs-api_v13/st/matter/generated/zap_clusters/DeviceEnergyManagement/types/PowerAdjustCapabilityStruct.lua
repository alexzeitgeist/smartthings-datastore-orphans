...
--- @alias PowerAdjustCapabilityStruct
--- @class st.matter.clusters.DeviceEnergyManagement.types.PowerAdjustCapabilityStruct: st.matter.data_types.Structure
---
--- @field public power_adjust_capability st.matter.data_types.Array
--- @field public cause st.matter.generated.zap_clusters.DeviceEnergyManagement.types.PowerAdjustReasonEnum
local PowerAdjustCapabilityStruct = {}
local new_mt = StructureABC.new_mt({NAME = "PowerAdjustCapabilityStruct", ID = data_types.name_to_id_map["Structure"]})

PowerAdjustCapabilityStruct.field_defs = {
  {
    name = "power_adjust_capability",
    field_id = 0,
    is_nullable = true,
    is_optional = false,
    data_type = require "st.matter.data_types.Array",
    element_type = require "st.matter.generated.zap_clusters.DeviceEnergyManagement.types.PowerAdjustStruct",
  },
  {
    name = "cause",
    field_id = 1,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.DeviceEnergyManagement.types.PowerAdjustReasonEnum",
  },
}

PowerAdjustCapabilityStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
PowerAdjustCapabilityStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = PowerAdjustCapabilityStruct.init
new_mt.__index.serialize = PowerAdjustCapabilityStruct.serialize

PowerAdjustCapabilityStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(PowerAdjustCapabilityStruct, new_mt)

return PowerAdjustCapabilityStruct
