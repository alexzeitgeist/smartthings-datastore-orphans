...
--- @alias PowerAdjustStruct
--- @class st.matter.clusters.DeviceEnergyManagement.types.PowerAdjustStruct: st.matter.data_types.Structure
---
...
local PowerAdjustStruct = {}
local new_mt = StructureABC.new_mt({NAME = "PowerAdjustStruct", ID = data_types.name_to_id_map["Structure"]})

PowerAdjustStruct.field_defs = {
  {
    name = "min_power",
    field_id = 0,
    is_nullable = false,
...
PowerAdjustStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
PowerAdjustStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = PowerAdjustStruct.init
new_mt.__index.serialize = PowerAdjustStruct.serialize

PowerAdjustStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(PowerAdjustStruct, new_mt)

return PowerAdjustStruct
