...
--- @alias CostStruct
--- @class st.matter.clusters.DeviceEnergyManagement.types.CostStruct: st.matter.data_types.Structure
---
--- @field public cost_type st.matter.generated.zap_clusters.DeviceEnergyManagement.types.CostTypeEnum
--- @field public value st.matter.data_types.Int32
--- @field public decimal_points st.matter.data_types.Uint8
--- @field public currency st.matter.data_types.Uint16
local CostStruct = {}
local new_mt = StructureABC.new_mt({NAME = "CostStruct", ID = data_types.name_to_id_map["Structure"]})

CostStruct.field_defs = {
  {
    name = "cost_type",
    field_id = 0,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.DeviceEnergyManagement.types.CostTypeEnum",
  },
  {
    name = "value",
    field_id = 1,
...
CostStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
CostStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = CostStruct.init
new_mt.__index.serialize = CostStruct.serialize

CostStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(CostStruct, new_mt)
