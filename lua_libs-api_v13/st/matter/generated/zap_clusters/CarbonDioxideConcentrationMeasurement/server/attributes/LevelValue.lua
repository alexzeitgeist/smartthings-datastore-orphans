...
--- @field public data_type st.matter.generated.zap_clusters.CarbonDioxideConcentrationMeasurement.types.LevelValueEnum the data type of this attribute

local LevelValue = {
  ID = 0x000A,
  NAME = "LevelValue",
  base_type = require "st.matter.generated.zap_clusters.CarbonDioxideConcentrationMeasurement.types.LevelValueEnum",
}
...
--- @return st.matter.generated.zap_clusters.CarbonDioxideConcentrationMeasurement.types.LevelValueEnum
