...
--- @class st.matter.clusters.EnergyEvseMode.types.ModeTag: st.matter.data_types.Uint16
--- @alias ModeTag
---
...
--- @field public MANUAL number 16384
--- @field public TIME_OF_USE number 16385
--- @field public SOLAR_CHARGING number 16386
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.EnergyEvseMode.types.ModeTag")
if has_aliases then
