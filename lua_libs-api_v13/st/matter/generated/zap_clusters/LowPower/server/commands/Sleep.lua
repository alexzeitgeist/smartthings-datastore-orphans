...
-----------------------------------------------------------
-- LowPower command Sleep
-----------------------------------------------------------

--- @class st.matter.clusters.LowPower.Sleep
--- @alias Sleep
---
--- @field public ID number 0x0000 the ID of this command
--- @field public NAME string "Sleep" the name of this command
local Sleep = {}
...
--- Builds an Sleep test command reponse for the driver integration testing framework
---
...
function Sleep:build_test_command_response(device, endpoint_id, status)
...
---
--- @param self Sleep the template class for this command
--- @param device st.matter.Device the device to build this message to

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function Sleep:init(device, endpoint_id)
  local out = {}
  local args = {}
...
function Sleep:set_parent_cluster(cluster)
...
function Sleep:augment_type(base_type_obj)
  local elems = {}
...
function Sleep:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(Sleep, {__call = Sleep.init})
