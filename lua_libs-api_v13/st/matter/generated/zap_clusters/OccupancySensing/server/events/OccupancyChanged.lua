...
--- @class st.matter.clusters.OccupancySensing.OccupancyChanged
--- @alias OccupancyChanged
---
--- @field public ID number 0x0000 the ID of this event
--- @field public NAME string "OccupancyChanged" the name of this event
--- @field public occupancy st.matter.generated.zap_clusters.OccupancySensing.types.OccupancyBitmap
local OccupancyChanged = {
  ID = 0x0000,
  NAME = "OccupancyChanged",
  base_type = data_types.Structure,
}

OccupancyChanged.field_defs = {
  {
    name = "occupancy",
    field_id = 0,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.OccupancySensing.types.OccupancyBitmap",
  },
}
--- Add field names to each event field
---
--- @param base_type_obj st.matter.data_types.Structure
function OccupancyChanged:augment_type(base_type_obj)
  local elems = {}
...
function OccupancyChanged:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function OccupancyChanged:subscribe(device, endpoint_id)
...
function OccupancyChanged:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "OccupancyChangedEventData", ID = 0x15}))
...
function OccupancyChanged:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function OccupancyChanged:set_parent_cluster(cluster)
