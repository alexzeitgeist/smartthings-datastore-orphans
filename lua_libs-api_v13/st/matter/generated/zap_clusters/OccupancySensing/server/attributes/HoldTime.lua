...
--- @class st.matter.clusters.OccupancySensing.HoldTime
--- @alias HoldTime
---
--- @field public ID number 0x0003 the ID of this attribute
--- @field public NAME string "HoldTime" the name of this attribute
...
function HoldTime:read(device, endpoint_id)
...
function HoldTime:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function HoldTime:subscribe(device, endpoint_id)
...
function HoldTime:set_parent_cluster(cluster)
...
function HoldTime:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function HoldTime:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(HoldTime, {__call = HoldTime.new_value, __index = HoldTime.base_type})
return HoldTime
