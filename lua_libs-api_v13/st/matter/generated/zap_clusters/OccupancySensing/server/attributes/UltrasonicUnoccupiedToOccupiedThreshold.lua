...
setmetatable(UltrasonicUnoccupiedToOccupiedThreshold, {__call = UltrasonicUnoccupiedToOccupiedThreshold.new_value, __index = UltrasonicUnoccupiedToOccupiedThreshold.base_type})
