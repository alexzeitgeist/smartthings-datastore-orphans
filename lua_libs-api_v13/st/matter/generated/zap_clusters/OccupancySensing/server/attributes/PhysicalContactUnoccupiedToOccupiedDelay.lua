...
setmetatable(PhysicalContactUnoccupiedToOccupiedDelay, {__call = PhysicalContactUnoccupiedToOccupiedDelay.new_value, __index = PhysicalContactUnoccupiedToOccupiedDelay.base_type})
