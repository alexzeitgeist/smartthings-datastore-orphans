...
setmetatable(UltrasonicOccupiedToUnoccupiedDelay, {__call = UltrasonicOccupiedToUnoccupiedDelay.new_value, __index = UltrasonicOccupiedToUnoccupiedDelay.base_type})
