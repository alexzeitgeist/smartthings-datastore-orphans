...
setmetatable(UltrasonicUnoccupiedToOccupiedDelay, {__call = UltrasonicUnoccupiedToOccupiedDelay.new_value, __index = UltrasonicUnoccupiedToOccupiedDelay.base_type})
