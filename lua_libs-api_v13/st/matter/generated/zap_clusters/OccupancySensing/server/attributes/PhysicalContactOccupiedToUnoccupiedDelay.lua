...
setmetatable(PhysicalContactOccupiedToUnoccupiedDelay, {__call = PhysicalContactOccupiedToUnoccupiedDelay.new_value, __index = PhysicalContactOccupiedToUnoccupiedDelay.base_type})
