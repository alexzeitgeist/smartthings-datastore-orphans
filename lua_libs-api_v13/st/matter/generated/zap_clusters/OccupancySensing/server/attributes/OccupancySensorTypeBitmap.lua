...
--- @field public data_type st.matter.generated.zap_clusters.OccupancySensing.types.OccupancySensorTypeBitmap the data type of this attribute

local OccupancySensorTypeBitmap = {
  ID = 0x0002,
  NAME = "OccupancySensorTypeBitmap",
  base_type = require "st.matter.generated.zap_clusters.OccupancySensing.types.OccupancySensorTypeBitmap",
}
...
---
--- @vararg vararg the values needed to construct a OccupancySensorTypeBitmap
--- @return st.matter.generated.zap_clusters.OccupancySensing.types.OccupancySensorTypeBitmap
...
setmetatable(OccupancySensorTypeBitmap, {__call = OccupancySensorTypeBitmap.new_value, __index = OccupancySensorTypeBitmap.base_type})
