...
setmetatable(PhysicalContactUnoccupiedToOccupiedThreshold, {__call = PhysicalContactUnoccupiedToOccupiedThreshold.new_value, __index = PhysicalContactUnoccupiedToOccupiedThreshold.base_type})
