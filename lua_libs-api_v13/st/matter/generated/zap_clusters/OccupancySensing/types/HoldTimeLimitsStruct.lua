...
--- @alias HoldTimeLimitsStruct
--- @class st.matter.clusters.OccupancySensing.types.HoldTimeLimitsStruct: st.matter.data_types.Structure
---
--- @field public hold_time_min st.matter.data_types.Uint16
--- @field public hold_time_max st.matter.data_types.Uint16
--- @field public hold_time_default st.matter.data_types.Uint16
local HoldTimeLimitsStruct = {}
local new_mt = StructureABC.new_mt({NAME = "HoldTimeLimitsStruct", ID = data_types.name_to_id_map["Structure"]})

HoldTimeLimitsStruct.field_defs = {
  {
    name = "hold_time_min",
    field_id = 0,
    is_nullable = false,
...
HoldTimeLimitsStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
HoldTimeLimitsStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = HoldTimeLimitsStruct.init
new_mt.__index.serialize = HoldTimeLimitsStruct.serialize

HoldTimeLimitsStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(HoldTimeLimitsStruct, new_mt)
