...
--- @alias MeasurementRangeStruct
--- @class st.matter.clusters.ElectricalPowerMeasurement.types.MeasurementRangeStruct: st.matter.data_types.Structure
---
--- @field public measurement_type st.matter.generated.zap_clusters.ElectricalPowerMeasurement.types.MeasurementTypeEnum
--- @field public min st.matter.data_types.Int64
--- @field public max st.matter.data_types.Int64
--- @field public start_timestamp st.matter.data_types.Uint32
--- @field public end_timestamp st.matter.data_types.Uint32
--- @field public min_timestamp st.matter.data_types.Uint32
--- @field public max_timestamp st.matter.data_types.Uint32
--- @field public start_systime st.matter.data_types.Uint64
--- @field public end_systime st.matter.data_types.Uint64
--- @field public min_systime st.matter.data_types.Uint64
--- @field public max_systime st.matter.data_types.Uint64
...
MeasurementRangeStruct.field_defs = {
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.ElectricalPowerMeasurement.types.MeasurementTypeEnum",
  },
  {
    name = "min",
    field_id = 1,
