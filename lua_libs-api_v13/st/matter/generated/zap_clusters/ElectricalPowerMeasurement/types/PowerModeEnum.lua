...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.ElectricalPowerMeasurement.types.PowerModeEnum")
if has_aliases then
  aliases:add_to_class(PowerModeEnum)
end
