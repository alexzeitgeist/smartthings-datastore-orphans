...
--- @alias Feature
---
--- @field public DIRECT_CURRENT number 1
--- @field public ALTERNATING_CURRENT number 2
--- @field public POLYPHASE_POWER number 4
--- @field public HARMONICS number 8
--- @field public POWER_QUALITY number 16
...
--- @function Feature:is_direct_current_set
--- @return boolean True if the value of DIRECT_CURRENT is non-zero
Feature.is_direct_current_set = function(self)
  return (self.value & self.DIRECT_CURRENT) ~= 0
end

--- @function Feature:set_direct_current
...
--- @function Feature:unset_direct_current
...
--- @function Feature:is_alternating_current_set
--- @return boolean True if the value of ALTERNATING_CURRENT is non-zero
Feature.is_alternating_current_set = function(self)
  return (self.value & self.ALTERNATING_CURRENT) ~= 0
end

--- @function Feature:set_alternating_current
...
--- @function Feature:unset_alternating_current
...
--- @function Feature:is_polyphase_power_set
--- @return boolean True if the value of POLYPHASE_POWER is non-zero
Feature.is_polyphase_power_set = function(self)
  return (self.value & self.POLYPHASE_POWER) ~= 0
end

--- @function Feature:set_polyphase_power
...
--- @function Feature:unset_polyphase_power
...
--- @function Feature:is_harmonics_set
--- @return boolean True if the value of HARMONICS is non-zero
Feature.is_harmonics_set = function(self)
  return (self.value & self.HARMONICS) ~= 0
end

--- @function Feature:set_harmonics
...
--- @function Feature:unset_harmonics
...
--- @function Feature:set_power_quality
...
--- @function Feature:unset_power_quality
