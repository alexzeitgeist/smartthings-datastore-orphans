...
event_mt.__index = function(self, key)
  if event_mt.__event_cache[key] == nil then
    local req_loc = string.format("st.matter.generated.zap_clusters.ElectricalPowerMeasurement.server.events.%s", key)
...
--- @class st.matter.generated.zap_clusters.ElectricalPowerMeasurementEvents
---
--- @field public MeasurementPeriodRanges st.matter.generated.zap_clusters.ElectricalPowerMeasurement.server.events.MeasurementPeriodRanges
