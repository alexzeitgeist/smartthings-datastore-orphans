...
--- @alias ApparentCurrent
---
--- @field public ID number 0x0007 the ID of this attribute
--- @field public NAME string "ApparentCurrent" the name of this attribute
...
setmetatable(ApparentCurrent, {__call = ApparentCurrent.new_value, __index = ApparentCurrent.base_type})
