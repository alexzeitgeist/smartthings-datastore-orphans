...
--- @field public NAME string "Ranges" the name of this attribute
...
local Ranges = {
  ...
  element_type = require "st.matter.generated.zap_clusters.ElectricalPowerMeasurement.types.MeasurementRangeStruct",
}

--- Add additional functionality to the base type object
---
--- @param base_type_obj st.matter.data_types.Array the base data type object to add functionality to
function Ranges:augment_type(data_type_obj)
  for i, v in ipairs(data_type_obj.elements) do
    data_type_obj.elements[i] = data_types.validate_or_build_type(v, Ranges.element_type)
  end
end
...
setmetatable(Ranges, {__call = Ranges.new_value, __index = Ranges.base_type})
return Ranges
