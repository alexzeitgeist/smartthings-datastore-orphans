...
--- @alias NumberOfMeasurementTypes
---
--- @field public ID number 0x0001 the ID of this attribute
--- @field public NAME string "NumberOfMeasurementTypes" the name of this attribute
...
setmetatable(NumberOfMeasurementTypes, {__call = NumberOfMeasurementTypes.new_value, __index = NumberOfMeasurementTypes.base_type})
