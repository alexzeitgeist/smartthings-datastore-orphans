...
--- @field public NAME string "PowerMode" the name of this attribute
--- @field public data_type st.matter.generated.zap_clusters.ElectricalPowerMeasurement.types.PowerModeEnum the data type of this attribute

local PowerMode = {
  ID = 0x0000,
  NAME = "PowerMode",
  base_type = require "st.matter.generated.zap_clusters.ElectricalPowerMeasurement.types.PowerModeEnum",
}
...
--- @return st.matter.generated.zap_clusters.ElectricalPowerMeasurement.types.PowerModeEnum
