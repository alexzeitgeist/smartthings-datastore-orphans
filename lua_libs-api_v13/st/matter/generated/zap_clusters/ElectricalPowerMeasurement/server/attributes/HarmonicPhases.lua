...
--- @alias HarmonicPhases
---
--- @field public ID number 0x0010 the ID of this attribute
--- @field public NAME string "HarmonicPhases" the name of this attribute
...
function HarmonicPhases:augment_type(data_type_obj)
  for i, v in ipairs(data_type_obj.elements) do
    data_type_obj.elements[i] = data_types.validate_or_build_type(v, HarmonicPhases.element_type)
  end
end
...
setmetatable(HarmonicPhases, {__call = HarmonicPhases.new_value, __index = HarmonicPhases.base_type})
