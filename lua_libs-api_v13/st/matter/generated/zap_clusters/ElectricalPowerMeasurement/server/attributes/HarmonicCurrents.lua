...
--- @alias HarmonicCurrents
---
--- @field public ID number 0x000F the ID of this attribute
--- @field public NAME string "HarmonicCurrents" the name of this attribute
...
local HarmonicCurrents = {
  ...
  element_type = require "st.matter.generated.zap_clusters.ElectricalPowerMeasurement.types.HarmonicMeasurementStruct",
}

--- Add additional functionality to the base type object
---
--- @param base_type_obj st.matter.data_types.Array the base data type object to add functionality to
function HarmonicCurrents:augment_type(data_type_obj)
  for i, v in ipairs(data_type_obj.elements) do
    data_type_obj.elements[i] = data_types.validate_or_build_type(v, HarmonicCurrents.element_type)
  end
end
...
setmetatable(HarmonicCurrents, {__call = HarmonicCurrents.new_value, __index = HarmonicCurrents.base_type})
