...
-----------------------------------------------------------
-- RefrigeratorAndTemperatureControlledCabinetMode command ChangeToModeResponse
-----------------------------------------------------------

--- @class st.matter.clusters.RefrigeratorAndTemperatureControlledCabinetMode.ChangeToModeResponse
--- @alias ChangeToModeResponse
---
--- @field public ID number 0x0001 the ID of this command
--- @field public NAME string "ChangeToModeResponse" the name of this command
...
--- Builds an ChangeToModeResponse test command reponse for the driver integration testing framework
---
...
--- Initialize the ChangeToModeResponse command
---
--- @return nil
