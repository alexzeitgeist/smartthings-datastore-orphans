...
--- @class st.matter.clusters.RefrigeratorAndTemperatureControlledCabinetMode.SupportedModes
...
local SupportedModes = {
  ...
  element_type = require "st.matter.generated.zap_clusters.RefrigeratorAndTemperatureControlledCabinetMode.types.ModeOptionStruct",
}
