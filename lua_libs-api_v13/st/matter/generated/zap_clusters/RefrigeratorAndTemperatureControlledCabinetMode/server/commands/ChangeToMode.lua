...
-----------------------------------------------------------
-- RefrigeratorAndTemperatureControlledCabinetMode command ChangeToMode
-----------------------------------------------------------

--- @class st.matter.clusters.RefrigeratorAndTemperatureControlledCabinetMode.ChangeToMode
--- @alias ChangeToMode
---
--- @field public ID number 0x0000 the ID of this command
--- @field public NAME string "ChangeToMode" the name of this command
--- @field public new_mode st.matter.data_types.Uint8
local ChangeToMode = {}
...
--- Refer to ChangeToModeResponse:build_test_command_response for
