...
command_mt.__index = function(self, key)
  if command_mt.__command_cache[key] == nil then
    local req_loc = string.format("st.matter.generated.zap_clusters.RefrigeratorAndTemperatureControlledCabinetMode.server.commands.%s", key)
...
--- @class st.matter.generated.zap_clusters.RefrigeratorAndTemperatureControlledCabinetModeServerCommands
---
--- @field public ChangeToMode st.matter.generated.zap_clusters.RefrigeratorAndTemperatureControlledCabinetMode.ChangeToMode
