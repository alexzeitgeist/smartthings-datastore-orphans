...
--- @class st.matter.clusters.HepaFilterMonitoring.ReplacementProductList
...
local ReplacementProductList = {
  ...
  element_type = require "st.matter.generated.zap_clusters.HepaFilterMonitoring.types.ReplacementProductStruct",
}
