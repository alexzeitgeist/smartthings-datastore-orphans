...
--- @field public data_type st.matter.generated.zap_clusters.HepaFilterMonitoring.types.ChangeIndicationEnum the data type of this attribute

local ChangeIndication = {
  ID = 0x0002,
  NAME = "ChangeIndication",
  base_type = require "st.matter.generated.zap_clusters.HepaFilterMonitoring.types.ChangeIndicationEnum",
}
...
--- @return st.matter.generated.zap_clusters.HepaFilterMonitoring.types.ChangeIndicationEnum
