...
--- @class st.matter.clusters.HepaFilterMonitoring.types.ReplacementProductStruct: st.matter.data_types.Structure
---
--- @field public product_identifier_type st.matter.generated.zap_clusters.HepaFilterMonitoring.types.ProductIdentifierTypeEnum
...
ReplacementProductStruct.field_defs = {
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.HepaFilterMonitoring.types.ProductIdentifierTypeEnum",
  },
  {
