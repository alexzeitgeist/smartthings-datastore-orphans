...
--- @class st.matter.clusters.DeviceEnergyManagementMode.types.Feature
--- @alias Feature
---
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.DeviceEnergyManagementMode.types.Feature")
if has_aliases then
