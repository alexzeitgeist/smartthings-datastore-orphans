...
--- @class st.matter.clusters.DeviceEnergyManagementMode.types.ModeTag: st.matter.data_types.Uint16
--- @alias ModeTag
---
...
--- @field public NO_OPTIMIZATION number 16384
--- @field public DEVICE_OPTIMIZATION number 16385
--- @field public LOCAL_OPTIMIZATION number 16386
--- @field public GRID_OPTIMIZATION number 16387
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.DeviceEnergyManagementMode.types.ModeTag")
if has_aliases then
