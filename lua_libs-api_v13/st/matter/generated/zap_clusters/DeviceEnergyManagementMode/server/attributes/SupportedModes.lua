...
--- @class st.matter.clusters.DeviceEnergyManagementMode.SupportedModes
...
local SupportedModes = {
  ...
  element_type = require "st.matter.generated.zap_clusters.DeviceEnergyManagementMode.types.ModeOptionStruct",
}
