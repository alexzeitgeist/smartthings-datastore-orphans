...
-----------------------------------------------------------
-- ApplicationLauncher command LaunchApp
-----------------------------------------------------------

--- @class st.matter.clusters.ApplicationLauncher.LaunchApp
--- @alias LaunchApp
---
--- @field public ID number 0x0000 the ID of this command
--- @field public NAME string "LaunchApp" the name of this command
--- @field public application st.matter.generated.zap_clusters.ApplicationLauncher.types.ApplicationStruct
--- @field public data st.matter.data_types.OctetString1
local LaunchApp = {}

LaunchApp.NAME = "LaunchApp"
LaunchApp.ID = 0x0000
LaunchApp.field_defs = {
  {
    name = "application",
    field_id = 0,
    is_nullable = false,
    is_optional = true,
    data_type = require "st.matter.generated.zap_clusters.ApplicationLauncher.types.ApplicationStruct",
  },
  {
    name = "data",
    field_id = 1,
...
--- Initialize the LaunchApp command
---
--- @param self LaunchApp the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param application st.matter.generated.zap_clusters.ApplicationLauncher.types.ApplicationStruct
--- @param data st.matter.data_types.OctetString1

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function LaunchApp:init(device, endpoint_id, application, data)
  local out = {}
  local args = {application, data}
  ...
  setmetatable(out, {
    __index = LaunchApp,
    __tostring = LaunchApp.pretty_print
  })
...
function LaunchApp:set_parent_cluster(cluster)
...
function LaunchApp:augment_type(base_type_obj)
  local elems = {}
...
function LaunchApp:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(LaunchApp, {__call = LaunchApp.init})
