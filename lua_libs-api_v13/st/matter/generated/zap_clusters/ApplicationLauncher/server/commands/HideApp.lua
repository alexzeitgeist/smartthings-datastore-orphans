...
-----------------------------------------------------------
-- ApplicationLauncher command HideApp
-----------------------------------------------------------

--- @class st.matter.clusters.ApplicationLauncher.HideApp
--- @alias HideApp
---
--- @field public ID number 0x0002 the ID of this command
--- @field public NAME string "HideApp" the name of this command
--- @field public application st.matter.generated.zap_clusters.ApplicationLauncher.types.ApplicationStruct
local HideApp = {}

HideApp.NAME = "HideApp"
HideApp.ID = 0x0002
HideApp.field_defs = {
  {
    name = "application",
...
--- Initialize the HideApp command
---
--- @param self HideApp the template class for this command
...
function HideApp:init(device, endpoint_id, application)
  local out = {}
  local args = {application}
  ...
  setmetatable(out, {
    __index = HideApp,
    __tostring = HideApp.pretty_print
  })
...
function HideApp:set_parent_cluster(cluster)
...
function HideApp:augment_type(base_type_obj)
  local elems = {}
...
function HideApp:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(HideApp, {__call = HideApp.init})
