...
-----------------------------------------------------------
-- ApplicationLauncher command StopApp
-----------------------------------------------------------

--- @class st.matter.clusters.ApplicationLauncher.StopApp
--- @alias StopApp
---
--- @field public ID number 0x0001 the ID of this command
--- @field public NAME string "StopApp" the name of this command
...
--- Initialize the StopApp command
---
--- @param self StopApp the template class for this command
...
function StopApp:init(device, endpoint_id, application)
  local out = {}
  ...
  setmetatable(out, {
    __index = StopApp,
    __tostring = StopApp.pretty_print
  })
...
function StopApp:set_parent_cluster(cluster)
...
function StopApp:augment_type(base_type_obj)
  local elems = {}
...
function StopApp:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(StopApp, {__call = StopApp.init})
