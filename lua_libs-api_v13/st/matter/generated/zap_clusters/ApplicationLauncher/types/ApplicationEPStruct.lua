...
--- @alias ApplicationEPStruct
--- @class st.matter.clusters.ApplicationLauncher.types.ApplicationEPStruct: st.matter.data_types.Structure
---
--- @field public application st.matter.generated.zap_clusters.ApplicationLauncher.types.ApplicationStruct
--- @field public endpoint st.matter.data_types.Uint16
local ApplicationEPStruct = {}
local new_mt = StructureABC.new_mt({NAME = "ApplicationEPStruct", ID = data_types.name_to_id_map["Structure"]})

ApplicationEPStruct.field_defs = {
  {
    name = "application",
    field_id = 0,
    is_nullable = false,
...
ApplicationEPStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
ApplicationEPStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = ApplicationEPStruct.init
new_mt.__index.serialize = ApplicationEPStruct.serialize

ApplicationEPStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(ApplicationEPStruct, new_mt)

return ApplicationEPStruct
