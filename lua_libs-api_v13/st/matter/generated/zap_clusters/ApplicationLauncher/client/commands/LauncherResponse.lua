...
-----------------------------------------------------------
-- ApplicationLauncher command LauncherResponse
-----------------------------------------------------------

--- @class st.matter.clusters.ApplicationLauncher.LauncherResponse
...
--- @field public status st.matter.generated.zap_clusters.ApplicationLauncher.types.StatusEnum
--- @field public data st.matter.data_types.OctetString1
local LauncherResponse = {}

LauncherResponse.NAME = "LauncherResponse"
LauncherResponse.ID = 0x0003
LauncherResponse.field_defs = {
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.ApplicationLauncher.types.StatusEnum",
  },
  {
    name = "data",
    field_id = 1,
...
--- @param status st.matter.generated.zap_clusters.ApplicationLauncher.types.StatusEnum
