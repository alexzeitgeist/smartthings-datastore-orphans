...
--- @class st.matter.clusters.PowerTopology.AvailableEndpoints
--- @alias AvailableEndpoints
---
--- @field public ID number 0x0000 the ID of this attribute
--- @field public NAME string "AvailableEndpoints" the name of this attribute
...
--- This is also usable with the AvailableEndpoints(...) syntax
---
...
--- Reporting policy: AvailableEndpoints => true => mandatory
...
--- Builds an AvailableEndpoints test attribute reponse for the driver integration testing framework
---
