...
do
  local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.OnOff.server.attributes")
  if has_aliases then
    for alias, _ in pairs(aliases) do
      OnOff.attribute_direction_map[alias] = "server"
    end
  end
end
...
do
  local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.OnOff.server.commands")
  if has_aliases then
    for alias, _ in pairs(aliases) do
      OnOff.command_direction_map[alias] = "server"
    end
  end
end

do
  local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.OnOff.client.commands")
  if has_aliases then
    for alias, _ in pairs(aliases) do
      OnOff.command_direction_map[alias] = "client"
    end
  end
end

OnOff.FeatureMap = OnOff.types.Feature
