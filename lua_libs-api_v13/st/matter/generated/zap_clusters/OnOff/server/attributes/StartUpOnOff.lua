...
--- @field public data_type st.matter.generated.zap_clusters.OnOff.types.StartUpOnOffEnum the data type of this attribute

local StartUpOnOff = {
  ID = 0x4003,
  NAME = "StartUpOnOff",
  base_type = require "st.matter.generated.zap_clusters.OnOff.types.StartUpOnOffEnum",
}
...
---
--- @vararg vararg the values needed to construct a StartUpOnOffEnum
--- @return st.matter.generated.zap_clusters.OnOff.types.StartUpOnOffEnum
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.generated.zap_clusters.OnOff.types.StartUpOnOffEnum the value to write
...
setmetatable(StartUpOnOff, {__call = StartUpOnOff.new_value, __index = StartUpOnOff.base_type})
return StartUpOnOff
