...
--- @field public on_off_control st.matter.generated.zap_clusters.OnOff.types.OnOffControlBitmap
--- @field public on_time st.matter.data_types.Uint16
--- @field public off_wait_time st.matter.data_types.Uint16
...
OnWithTimedOff.field_defs = {
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.OnOff.types.OnOffControlBitmap",
  },
  {
    name = "on_time",
    field_id = 1,
...
--- @param device st.matter.Device the device to build this message to
--- @param on_off_control st.matter.generated.zap_clusters.OnOff.types.OnOffControlBitmap
