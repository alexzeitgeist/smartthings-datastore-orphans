...
--- @field public effect_identifier st.matter.generated.zap_clusters.OnOff.types.EffectIdentifierEnum
--- @field public effect_variant st.matter.data_types.Uint8
local OffWithEffect = {}
...
OffWithEffect.field_defs = {
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.OnOff.types.EffectIdentifierEnum",
  },
  {
    name = "effect_variant",
    field_id = 1,
...
--- @param device st.matter.Device the device to build this message to
--- @param effect_identifier st.matter.generated.zap_clusters.OnOff.types.EffectIdentifierEnum
--- @param effect_variant st.matter.data_types.Uint8

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function OffWithEffect:init(device, endpoint_id, effect_identifier, effect_variant)
  local out = {}
