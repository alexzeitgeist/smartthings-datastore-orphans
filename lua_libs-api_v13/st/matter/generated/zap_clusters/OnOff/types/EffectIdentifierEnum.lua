...
EffectIdentifierEnum.DELAYED_ALL_OFF  = 0x00
EffectIdentifierEnum.DYING_LIGHT  = 0x01
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.OnOff.types.EffectIdentifierEnum")
if has_aliases then
