...
--- @alias NumberOfAliroCredentialIssuerKeysSupported
---
--- @field public ID number 0x0087 the ID of this attribute
--- @field public NAME string "NumberOfAliroCredentialIssuerKeysSupported" the name of this attribute
