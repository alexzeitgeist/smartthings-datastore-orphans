...
--- @alias AliroGroupResolvingKey
---
--- @field public ID number 0x0084 the ID of this attribute
--- @field public NAME string "AliroGroupResolvingKey" the name of this attribute
