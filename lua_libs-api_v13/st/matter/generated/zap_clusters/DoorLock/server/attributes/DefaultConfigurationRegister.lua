...
--- @field public data_type st.matter.generated.zap_clusters.DoorLock.types.DlDefaultConfigurationRegister the data type of this attribute

local DefaultConfigurationRegister = {
  ID = 0x0027,
  NAME = "DefaultConfigurationRegister",
  base_type = require "st.matter.generated.zap_clusters.DoorLock.types.DlDefaultConfigurationRegister",
}
...
---
--- @vararg vararg the values needed to construct a DlDefaultConfigurationRegister
--- @return st.matter.generated.zap_clusters.DoorLock.types.DlDefaultConfigurationRegister
...
setmetatable(DefaultConfigurationRegister, {__call = DefaultConfigurationRegister.new_value, __index = DefaultConfigurationRegister.base_type})
