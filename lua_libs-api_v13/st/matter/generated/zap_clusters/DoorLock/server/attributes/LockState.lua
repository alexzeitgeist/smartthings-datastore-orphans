...
--- @field public data_type st.matter.generated.zap_clusters.DoorLock.types.DlLockState the data type of this attribute

local LockState = {
  ID = 0x0000,
  NAME = "LockState",
  base_type = require "st.matter.generated.zap_clusters.DoorLock.types.DlLockState",
}
...
---
--- @vararg vararg the values needed to construct a DlLockState
--- @return st.matter.generated.zap_clusters.DoorLock.types.DlLockState
