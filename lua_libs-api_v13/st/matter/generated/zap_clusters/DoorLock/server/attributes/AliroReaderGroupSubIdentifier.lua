...
--- @alias AliroReaderGroupSubIdentifier
---
--- @field public ID number 0x0082 the ID of this attribute
--- @field public NAME string "AliroReaderGroupSubIdentifier" the name of this attribute
