...
--- @alias AliroReaderGroupIdentifier
---
--- @field public ID number 0x0081 the ID of this attribute
--- @field public NAME string "AliroReaderGroupIdentifier" the name of this attribute
