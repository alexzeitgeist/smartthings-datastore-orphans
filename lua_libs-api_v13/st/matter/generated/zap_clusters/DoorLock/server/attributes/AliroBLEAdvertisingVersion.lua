...
--- @alias AliroBLEAdvertisingVersion
---
--- @field public ID number 0x0086 the ID of this attribute
--- @field public NAME string "AliroBLEAdvertisingVersion" the name of this attribute
