...
--- @field public data_type st.matter.generated.zap_clusters.DoorLock.types.DoorStateEnum the data type of this attribute

local DoorState = {
  ID = 0x0003,
  NAME = "DoorState",
  base_type = require "st.matter.generated.zap_clusters.DoorLock.types.DoorStateEnum",
}
...
---
--- @vararg vararg the values needed to construct a DoorStateEnum
--- @return st.matter.generated.zap_clusters.DoorLock.types.DoorStateEnum
