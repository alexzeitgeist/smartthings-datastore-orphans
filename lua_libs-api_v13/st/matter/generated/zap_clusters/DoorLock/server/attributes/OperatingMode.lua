...
--- @field public data_type st.matter.generated.zap_clusters.DoorLock.types.OperatingModeEnum the data type of this attribute

local OperatingMode = {
  ID = 0x0025,
  NAME = "OperatingMode",
  base_type = require "st.matter.generated.zap_clusters.DoorLock.types.OperatingModeEnum",
}
...
---
--- @vararg vararg the values needed to construct a OperatingModeEnum
--- @return st.matter.generated.zap_clusters.DoorLock.types.OperatingModeEnum
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.generated.zap_clusters.DoorLock.types.OperatingModeEnum the value to write
