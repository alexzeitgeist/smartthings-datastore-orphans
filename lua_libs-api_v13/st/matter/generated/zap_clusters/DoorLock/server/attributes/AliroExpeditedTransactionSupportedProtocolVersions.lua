...
--- @alias AliroExpeditedTransactionSupportedProtocolVersions
---
--- @field public ID number 0x0083 the ID of this attribute
--- @field public NAME string "AliroExpeditedTransactionSupportedProtocolVersions" the name of this attribute
