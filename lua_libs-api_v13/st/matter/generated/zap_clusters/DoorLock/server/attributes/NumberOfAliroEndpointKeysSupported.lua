...
--- @alias NumberOfAliroEndpointKeysSupported
---
--- @field public ID number 0x0088 the ID of this attribute
--- @field public NAME string "NumberOfAliroEndpointKeysSupported" the name of this attribute
