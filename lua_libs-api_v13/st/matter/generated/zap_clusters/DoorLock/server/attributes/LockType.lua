...
--- @field public data_type st.matter.generated.zap_clusters.DoorLock.types.DlLockType the data type of this attribute

local LockType = {
  ID = 0x0001,
  NAME = "LockType",
  base_type = require "st.matter.generated.zap_clusters.DoorLock.types.DlLockType",
}
...
---
--- @vararg vararg the values needed to construct a DlLockType
--- @return st.matter.generated.zap_clusters.DoorLock.types.DlLockType
...
setmetatable(LockType, {__call = LockType.new_value, __index = LockType.base_type})
return LockType
