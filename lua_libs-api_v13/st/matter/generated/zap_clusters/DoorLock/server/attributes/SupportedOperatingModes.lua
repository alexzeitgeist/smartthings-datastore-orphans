...
--- @field public data_type st.matter.generated.zap_clusters.DoorLock.types.DlSupportedOperatingModes the data type of this attribute

local SupportedOperatingModes = {
  ID = 0x0026,
  NAME = "SupportedOperatingModes",
  base_type = require "st.matter.generated.zap_clusters.DoorLock.types.DlSupportedOperatingModes",
}
...
---
--- @vararg vararg the values needed to construct a DlSupportedOperatingModes
--- @return st.matter.generated.zap_clusters.DoorLock.types.DlSupportedOperatingModes
