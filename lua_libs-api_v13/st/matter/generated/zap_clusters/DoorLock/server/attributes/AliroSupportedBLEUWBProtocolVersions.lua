...
--- @alias AliroSupportedBLEUWBProtocolVersions
---
--- @field public ID number 0x0085 the ID of this attribute
--- @field public NAME string "AliroSupportedBLEUWBProtocolVersions" the name of this attribute
