...
--- @field public AliroReaderVerificationKey st.matter.generated.zap_clusters.DoorLock.server.attributes.AliroReaderVerificationKey
--- @field public AliroReaderGroupIdentifier st.matter.generated.zap_clusters.DoorLock.server.attributes.AliroReaderGroupIdentifier
--- @field public AliroReaderGroupSubIdentifier st.matter.generated.zap_clusters.DoorLock.server.attributes.AliroReaderGroupSubIdentifier
--- @field public AliroExpeditedTransactionSupportedProtocolVersions st.matter.generated.zap_clusters.DoorLock.server.attributes.AliroExpeditedTransactionSupportedProtocolVersions
--- @field public AliroGroupResolvingKey st.matter.generated.zap_clusters.DoorLock.server.attributes.AliroGroupResolvingKey
--- @field public AliroSupportedBLEUWBProtocolVersions st.matter.generated.zap_clusters.DoorLock.server.attributes.AliroSupportedBLEUWBProtocolVersions
--- @field public AliroBLEAdvertisingVersion st.matter.generated.zap_clusters.DoorLock.server.attributes.AliroBLEAdvertisingVersion
--- @field public NumberOfAliroCredentialIssuerKeysSupported st.matter.generated.zap_clusters.DoorLock.server.attributes.NumberOfAliroCredentialIssuerKeysSupported
--- @field public NumberOfAliroEndpointKeysSupported st.matter.generated.zap_clusters.DoorLock.server.attributes.NumberOfAliroEndpointKeysSupported
--- @field public AcceptedCommandList st.matter.generated.zap_clusters.DoorLock.server.attributes.AcceptedCommandList
--- @field public EventList st.matter.generated.zap_clusters.DoorLock.server.attributes.EventList
...
if has_aliases then
  aliases:add_to_class(DoorLockServerAttributes)
end
