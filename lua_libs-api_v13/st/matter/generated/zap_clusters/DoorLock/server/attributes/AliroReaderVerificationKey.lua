...
--- @alias AliroReaderVerificationKey
---
--- @field public ID number 0x0080 the ID of this attribute
--- @field public NAME string "AliroReaderVerificationKey" the name of this attribute
