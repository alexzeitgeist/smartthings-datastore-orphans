...
--- @field public alarm_code st.matter.generated.zap_clusters.DoorLock.types.AlarmCodeEnum
local DoorLockAlarm = {
  ID = 0x0000,
  NAME = "DoorLockAlarm",
...
DoorLockAlarm.field_defs = {
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.DoorLock.types.AlarmCodeEnum",
  },
}
