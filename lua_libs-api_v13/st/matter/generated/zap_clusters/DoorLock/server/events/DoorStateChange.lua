...
--- @field public door_state st.matter.generated.zap_clusters.DoorLock.types.DoorStateEnum
...
DoorStateChange.field_defs = {
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.DoorLock.types.DoorStateEnum",
  },
}
