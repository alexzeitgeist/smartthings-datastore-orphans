...
--- @field public lock_operation_type st.matter.generated.zap_clusters.DoorLock.types.LockOperationTypeEnum
--- @field public operation_source st.matter.generated.zap_clusters.DoorLock.types.OperationSourceEnum
--- @field public operation_error st.matter.generated.zap_clusters.DoorLock.types.OperationErrorEnum
--- @field public user_index st.matter.data_types.Uint16
--- @field public fabric_index st.matter.data_types.Uint8
--- @field public source_node st.matter.data_types.Uint64
...
LockOperationError.field_defs = {
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.DoorLock.types.LockOperationTypeEnum",
  },
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.DoorLock.types.OperationSourceEnum",
  },
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.DoorLock.types.OperationErrorEnum",
  },
  {
    name = "user_index",
    field_id = 3,
