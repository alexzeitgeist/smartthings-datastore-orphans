...
-----------------------------------------------------------
-- DoorLock command UnboltDoor
-----------------------------------------------------------

--- @class st.matter.clusters.DoorLock.UnboltDoor
--- @alias UnboltDoor
---
--- @field public ID number 0x0027 the ID of this command
--- @field public NAME string "UnboltDoor" the name of this command
--- @field public pin_code st.matter.data_types.OctetString1
local UnboltDoor = {}
...
---
--- @param self UnboltDoor the template class for this command
--- @param device st.matter.Device the device to build this message to
