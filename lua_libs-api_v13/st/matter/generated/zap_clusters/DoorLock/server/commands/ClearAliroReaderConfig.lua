...
-----------------------------------------------------------
-- DoorLock command ClearAliroReaderConfig
-----------------------------------------------------------

--- @class st.matter.clusters.DoorLock.ClearAliroReaderConfig
--- @alias ClearAliroReaderConfig
---
--- @field public ID number 0x0029 the ID of this command
--- @field public NAME string "ClearAliroReaderConfig" the name of this command
...
---
--- @param self ClearAliroReaderConfig the template class for this command
--- @param device st.matter.Device the device to build this message to
