...
-----------------------------------------------------------
-- DoorLock command SetAliroReaderConfig
-----------------------------------------------------------

--- @class st.matter.clusters.DoorLock.SetAliroReaderConfig
--- @alias SetAliroReaderConfig
---
--- @field public ID number 0x0028 the ID of this command
--- @field public NAME string "SetAliroReaderConfig" the name of this command
--- @field public signing_key st.matter.data_types.OctetString1
--- @field public verification_key st.matter.data_types.OctetString1
--- @field public group_identifier st.matter.data_types.OctetString1
--- @field public group_resolving_key st.matter.data_types.OctetString1
...
---
--- @param self SetAliroReaderConfig the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param signing_key st.matter.data_types.OctetString1
--- @param verification_key st.matter.data_types.OctetString1
--- @param group_identifier st.matter.data_types.OctetString1
--- @param group_resolving_key st.matter.data_types.OctetString1
