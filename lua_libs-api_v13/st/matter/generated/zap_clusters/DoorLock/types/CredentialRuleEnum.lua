...
--- @alias CredentialRuleEnum
---
--- @field public byte_length number 1
--- @field public SINGLE number 0
--- @field public DUAL number 1
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.DoorLock.types.CredentialRuleEnum")
if has_aliases then
  aliases:add_to_class(CredentialRuleEnum)
end
