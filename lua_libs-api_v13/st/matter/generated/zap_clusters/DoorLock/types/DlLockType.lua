...
--- @field public EUROCYLINDER number 11
...
new_mt.__index.pretty_print = function(self)
  local name_lookup = {
    ...
    [self.EUROCYLINDER] = "EUROCYLINDER",
  }
...
new_mt.__index.EUROCYLINDER  = 0x0B

DlLockType.DEAD_BOLT  = 0x00
DlLockType.MAGNETIC  = 0x01
DlLockType.OTHER  = 0x02
DlLockType.MORTISE  = 0x03
DlLockType.RIM  = 0x04
DlLockType.LATCH_BOLT  = 0x05
DlLockType.CYLINDRICAL_LOCK  = 0x06
DlLockType.TUBULAR_LOCK  = 0x07
DlLockType.INTERCONNECTED_LOCK  = 0x08
DlLockType.DEAD_LATCH  = 0x09
DlLockType.DOOR_FURNITURE  = 0x0A
DlLockType.EUROCYLINDER  = 0x0B
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.DoorLock.types.DlLockType")
if has_aliases then
  aliases:add_to_class(DlLockType)
end
