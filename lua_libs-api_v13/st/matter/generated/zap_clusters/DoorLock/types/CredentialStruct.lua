...
--- @alias CredentialStruct
--- @class st.matter.clusters.DoorLock.types.CredentialStruct: st.matter.data_types.Structure
---
--- @field public credential_type st.matter.generated.zap_clusters.DoorLock.types.CredentialTypeEnum
...
CredentialStruct.field_defs = {
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.DoorLock.types.CredentialTypeEnum",
  },
  {
