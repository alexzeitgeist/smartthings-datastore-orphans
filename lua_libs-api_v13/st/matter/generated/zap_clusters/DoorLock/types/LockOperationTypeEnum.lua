...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.DoorLock.types.LockOperationTypeEnum")
if has_aliases then
  aliases:add_to_class(LockOperationTypeEnum)
end
