...
--- @field public ALIRO_CREDENTIAL_ISSUER_KEY number 6
--- @field public ALIRO_EVICTABLE_ENDPOINT_KEY number 7
--- @field public ALIRO_NON_EVICTABLE_ENDPOINT_KEY number 8
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.DoorLock.types.CredentialTypeEnum")
if has_aliases then
  aliases:add_to_class(CredentialTypeEnum)
end
