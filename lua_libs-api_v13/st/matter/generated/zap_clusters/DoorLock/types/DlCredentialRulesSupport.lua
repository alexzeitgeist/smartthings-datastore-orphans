...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.DoorLock.types.DlCredentialRulesSupport")
if has_aliases then
  aliases:add_to_class(DlCredentialRulesSupport)
end
