...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.DoorLock.types.DlDefaultConfigurationRegister")
if has_aliases then
  aliases:add_to_class(DlDefaultConfigurationRegister)
end
