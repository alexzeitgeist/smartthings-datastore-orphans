...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.DoorLock.types.UserStatusEnum")
if has_aliases then
  aliases:add_to_class(UserStatusEnum)
end
