...
--- @field public UNLATCHED number 3
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.DoorLock.types.DlLockState")
if has_aliases then
  aliases:add_to_class(DlLockState)
end
