...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.DoorLock.types.DlRemoteProgrammingEventMask")
if has_aliases then
  aliases:add_to_class(DlRemoteProgrammingEventMask)
end
