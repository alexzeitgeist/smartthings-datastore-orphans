...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.DoorLock.types.DoorLockProgrammingEventCode")
if has_aliases then
  aliases:add_to_class(DoorLockProgrammingEventCode)
end
