...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.DoorLock.types.DlLocalProgrammingFeatures")
if has_aliases then
  aliases:add_to_class(DlLocalProgrammingFeatures)
end
