...
--- @field public FINGER_VEIN number 9
--- @field public FACE number 10
--- @field public ALIRO_CREDENTIAL_ISSUER_KEY number 11
--- @field public ALIRO_EVICTABLE_ENDPOINT_KEY number 12
--- @field public ALIRO_NON_EVICTABLE_ENDPOINT_KEY number 13
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.DoorLock.types.LockDataTypeEnum")
if has_aliases then
  aliases:add_to_class(LockDataTypeEnum)
end
