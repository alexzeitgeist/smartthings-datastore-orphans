...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.DoorLock.types.OperatingModeEnum")
if has_aliases then
  aliases:add_to_class(OperatingModeEnum)
end
