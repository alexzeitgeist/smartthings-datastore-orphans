...
--- @field public user_name st.matter.data_types.UTF8String1
--- @field public user_uniqueid st.matter.data_types.Uint32
...
--- @field public credential_rule st.matter.generated.zap_clusters.DoorLock.types.CredentialRuleEnum
--- @field public credentials st.matter.data_types.Array
...
--- @field public next_user_index st.matter.data_types.Uint16
...
GetUserResponse.field_defs = {
  ...
  },
  {
    ...
    is_nullable = true,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.DoorLock.types.CredentialRuleEnum",
  },
  {
    name = "credentials",
    field_id = 6,
    ...
    element_type = require "st.matter.generated.zap_clusters.DoorLock.types.CredentialStruct",
  },
  {
...
--- @param user_uniqueid st.matter.data_types.Uint32
...
--- @param credential_rule st.matter.generated.zap_clusters.DoorLock.types.CredentialRuleEnum
--- @param credentials st.matter.data_types.Array
--- @param creator_fabric_index st.matter.data_types.Uint8
--- @param last_modified_fabric_index st.matter.data_types.Uint8
--- @param next_user_index st.matter.data_types.Uint16
