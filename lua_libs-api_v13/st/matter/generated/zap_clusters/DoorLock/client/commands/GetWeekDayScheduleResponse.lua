...
--- @field public week_day_index st.matter.data_types.Uint8
--- @field public user_index st.matter.data_types.Uint16
--- @field public status st.matter.generated.zap_clusters.DoorLock.types.DlStatus
--- @field public days_mask st.matter.generated.zap_clusters.DoorLock.types.DaysMaskMap
--- @field public start_hour st.matter.data_types.Uint8
--- @field public start_minute st.matter.data_types.Uint8
--- @field public end_hour st.matter.data_types.Uint8
--- @field public end_minute st.matter.data_types.Uint8
...
GetWeekDayScheduleResponse.field_defs = {
  ...
  },
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.DoorLock.types.DlStatus",
  },
  {
    name = "days_mask",
    field_id = 3,
    is_nullable = false,
    is_optional = true,
    data_type = require "st.matter.generated.zap_clusters.DoorLock.types.DaysMaskMap",
  },
  {
    name = "start_hour",
    field_id = 4,
...
--- @param status st.matter.generated.zap_clusters.DoorLock.types.DlStatus
--- @param days_mask st.matter.generated.zap_clusters.DoorLock.types.DaysMaskMap
