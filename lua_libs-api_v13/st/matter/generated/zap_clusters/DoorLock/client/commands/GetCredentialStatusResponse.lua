...
--- @field public credential_exists st.matter.data_types.Boolean
--- @field public user_index st.matter.data_types.Uint16
--- @field public creator_fabric_index st.matter.data_types.Uint8
--- @field public last_modified_fabric_index st.matter.data_types.Uint8
--- @field public next_credential_index st.matter.data_types.Uint16
--- @field public credential_data st.matter.data_types.OctetString1
...
--- @param credential_exists st.matter.data_types.Boolean
--- @param user_index st.matter.data_types.Uint16
--- @param creator_fabric_index st.matter.data_types.Uint8
--- @param last_modified_fabric_index st.matter.data_types.Uint8
--- @param next_credential_index st.matter.data_types.Uint16
--- @param credential_data st.matter.data_types.OctetString1
--- @return st.matter.st.matter.interaction_model.InteractionResponse of type COMMAND_RESPONSE
function GetCredentialStatusResponse:build_test_command_response(device, endpoint_id, credential_exists, user_index, creator_fabric_index, last_modified_fabric_index, next_credential_index, credential_data, interaction_status)
  local function init(self, device, endpoint_id, credential_exists, user_index, creator_fabric_index, last_modified_fabric_index, next_credential_index, credential_data)
    local out = {}
    local args = {credential_exists, user_index, creator_fabric_index, last_modified_fabric_index, next_credential_index, credential_data}
  ...
  local self_request =  init(self, device, endpoint_id, credential_exists, user_index, creator_fabric_index, last_modified_fabric_index, next_credential_index, credential_data)
