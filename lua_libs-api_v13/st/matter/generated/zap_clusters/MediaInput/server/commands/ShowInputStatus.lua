...
-----------------------------------------------------------
-- MediaInput command ShowInputStatus
-----------------------------------------------------------

--- @class st.matter.clusters.MediaInput.ShowInputStatus
--- @alias ShowInputStatus
---
--- @field public ID number 0x0001 the ID of this command
--- @field public NAME string "ShowInputStatus" the name of this command
local ShowInputStatus = {}

ShowInputStatus.NAME = "ShowInputStatus"
ShowInputStatus.ID = 0x0001
ShowInputStatus.field_defs = {
}

--- Builds an ShowInputStatus test command reponse for the driver integration testing framework
---
...
function ShowInputStatus:build_test_command_response(device, endpoint_id, status)
...
--- Initialize the ShowInputStatus command
---
--- @param self ShowInputStatus the template class for this command
--- @param device st.matter.Device the device to build this message to

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function ShowInputStatus:init(device, endpoint_id)
  local out = {}
  local args = {}
  ...
  setmetatable(out, {
    __index = ShowInputStatus,
    __tostring = ShowInputStatus.pretty_print
  })
...
function ShowInputStatus:set_parent_cluster(cluster)
...
function ShowInputStatus:augment_type(base_type_obj)
  local elems = {}
...
function ShowInputStatus:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(ShowInputStatus, {__call = ShowInputStatus.init})
