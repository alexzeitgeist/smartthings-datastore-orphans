...
-----------------------------------------------------------
-- MediaInput command HideInputStatus
-----------------------------------------------------------

--- @class st.matter.clusters.MediaInput.HideInputStatus
--- @alias HideInputStatus
---
--- @field public ID number 0x0002 the ID of this command
--- @field public NAME string "HideInputStatus" the name of this command
local HideInputStatus = {}

HideInputStatus.NAME = "HideInputStatus"
HideInputStatus.ID = 0x0002
HideInputStatus.field_defs = {
}

--- Builds an HideInputStatus test command reponse for the driver integration testing framework
---
...
function HideInputStatus:build_test_command_response(device, endpoint_id, status)
...
--- Initialize the HideInputStatus command
---
--- @param self HideInputStatus the template class for this command
--- @param device st.matter.Device the device to build this message to

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function HideInputStatus:init(device, endpoint_id)
  local out = {}
  local args = {}
  ...
  setmetatable(out, {
    __index = HideInputStatus,
    __tostring = HideInputStatus.pretty_print
  })
...
function HideInputStatus:set_parent_cluster(cluster)
...
function HideInputStatus:augment_type(base_type_obj)
  local elems = {}
...
function HideInputStatus:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(HideInputStatus, {__call = HideInputStatus.init})
