...
-----------------------------------------------------------
-- MediaInput command SelectInput
-----------------------------------------------------------

--- @class st.matter.clusters.MediaInput.SelectInput
--- @alias SelectInput
---
--- @field public ID number 0x0000 the ID of this command
--- @field public NAME string "SelectInput" the name of this command
--- @field public index st.matter.data_types.Uint8
local SelectInput = {}

SelectInput.NAME = "SelectInput"
SelectInput.ID = 0x0000
SelectInput.field_defs = {
  {
    name = "index",
    field_id = 0,
    is_nullable = false,
...
--- Builds an SelectInput test command reponse for the driver integration testing framework
---
...
function SelectInput:build_test_command_response(device, endpoint_id, status)
...
--- Initialize the SelectInput command
---
--- @param self SelectInput the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param index st.matter.data_types.Uint8

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function SelectInput:init(device, endpoint_id, index)
  local out = {}
  local args = {index}
  ...
  setmetatable(out, {
    __index = SelectInput,
    __tostring = SelectInput.pretty_print
  })
...
function SelectInput:set_parent_cluster(cluster)
...
function SelectInput:augment_type(base_type_obj)
  local elems = {}
...
function SelectInput:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(SelectInput, {__call = SelectInput.init})
