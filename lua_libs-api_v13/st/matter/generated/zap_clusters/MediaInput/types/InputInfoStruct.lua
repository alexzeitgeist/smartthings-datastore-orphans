...
--- @alias InputInfoStruct
--- @class st.matter.clusters.MediaInput.types.InputInfoStruct: st.matter.data_types.Structure
---
--- @field public index st.matter.data_types.Uint8
--- @field public input_type st.matter.generated.zap_clusters.MediaInput.types.InputTypeEnum
--- @field public name st.matter.data_types.UTF8String1
--- @field public description st.matter.data_types.UTF8String1
local InputInfoStruct = {}
local new_mt = StructureABC.new_mt({NAME = "InputInfoStruct", ID = data_types.name_to_id_map["Structure"]})

InputInfoStruct.field_defs = {
  {
    name = "index",
    field_id = 0,
    is_nullable = false,
  ...
  },
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.MediaInput.types.InputTypeEnum",
  },
  {
    name = "name",
    field_id = 2,
...
InputInfoStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
InputInfoStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = InputInfoStruct.init
new_mt.__index.serialize = InputInfoStruct.serialize

InputInfoStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(InputInfoStruct, new_mt)

return InputInfoStruct
