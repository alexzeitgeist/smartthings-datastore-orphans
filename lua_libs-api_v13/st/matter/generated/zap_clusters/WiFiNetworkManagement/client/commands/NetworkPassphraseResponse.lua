...
-----------------------------------------------------------
-- WiFiNetworkManagement command NetworkPassphraseResponse
-----------------------------------------------------------

--- @class st.matter.clusters.WiFiNetworkManagement.NetworkPassphraseResponse
--- @alias NetworkPassphraseResponse
---
--- @field public ID number 0x0001 the ID of this command
--- @field public NAME string "NetworkPassphraseResponse" the name of this command
--- @field public passphrase st.matter.data_types.OctetString1
local NetworkPassphraseResponse = {}

NetworkPassphraseResponse.NAME = "NetworkPassphraseResponse"
NetworkPassphraseResponse.ID = 0x0001
NetworkPassphraseResponse.field_defs = {
  {
    name = "passphrase",
    field_id = 0,
    is_nullable = false,
...
function NetworkPassphraseResponse:augment_type(base_type_obj)
  local elems = {}
...
--- Builds an NetworkPassphraseResponse test command reponse for the driver integration testing framework
---
--- @param device st.matter.Device the device to build this message to
--- @param endpoint_id number|nil
--- @param passphrase st.matter.data_types.OctetString1
--- @return st.matter.st.matter.interaction_model.InteractionResponse of type COMMAND_RESPONSE
function NetworkPassphraseResponse:build_test_command_response(device, endpoint_id, passphrase, interaction_status)
  local function init(self, device, endpoint_id, passphrase)
    local out = {}
    ...
    setmetatable(out, {
      __index = NetworkPassphraseResponse,
      __tostring = NetworkPassphraseResponse.pretty_print
    })
  ...
  local self_request =  init(self, device, endpoint_id, passphrase)
...
--- Initialize the NetworkPassphraseResponse command
---
--- @return nil
function NetworkPassphraseResponse:init()
  return nil
end

function NetworkPassphraseResponse:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

function NetworkPassphraseResponse:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(NetworkPassphraseResponse, {__call = NetworkPassphraseResponse.init})
