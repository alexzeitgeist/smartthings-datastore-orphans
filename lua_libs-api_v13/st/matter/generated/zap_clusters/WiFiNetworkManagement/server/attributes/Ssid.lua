...
--- @class st.matter.clusters.WiFiNetworkManagement.Ssid
--- @alias Ssid
---
--- @field public ID number 0x0000 the ID of this attribute
--- @field public NAME string "Ssid" the name of this attribute
...
--- This is also usable with the Ssid(...) syntax
---
...
--- Reporting policy: Ssid => true => mandatory
...
--- Builds an Ssid test attribute reponse for the driver integration testing framework
---
