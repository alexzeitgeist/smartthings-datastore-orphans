...
-----------------------------------------------------------
-- WiFiNetworkManagement command NetworkPassphraseRequest
-----------------------------------------------------------

--- @class st.matter.clusters.WiFiNetworkManagement.NetworkPassphraseRequest
--- @alias NetworkPassphraseRequest
---
--- @field public ID number 0x0000 the ID of this command
--- @field public NAME string "NetworkPassphraseRequest" the name of this command
local NetworkPassphraseRequest = {}

NetworkPassphraseRequest.NAME = "NetworkPassphraseRequest"
NetworkPassphraseRequest.ID = 0x0000
NetworkPassphraseRequest.field_defs = {
}

--- Refer to NetworkPassphraseResponse:build_test_command_response for
--- building a test command reponse for the driver integration testing framework

--- Initialize the NetworkPassphraseRequest command
---
--- @param self NetworkPassphraseRequest the template class for this command
...
function NetworkPassphraseRequest:init(device, endpoint_id)
  local out = {}
  local args = {}
  ...
  setmetatable(out, {
    __index = NetworkPassphraseRequest,
    __tostring = NetworkPassphraseRequest.pretty_print
  })
...
function NetworkPassphraseRequest:set_parent_cluster(cluster)
...
function NetworkPassphraseRequest:augment_type(base_type_obj)
  local elems = {}
...
function NetworkPassphraseRequest:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(NetworkPassphraseRequest, {__call = NetworkPassphraseRequest.init})
