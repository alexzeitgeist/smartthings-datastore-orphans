...
--- @field public NAME string "ValveFault" the name of this event
--- @field public valve_fault st.matter.generated.zap_clusters.ValveConfigurationAndControl.types.ValveFaultBitmap
local ValveFault = {
  ID = 0x0001,
  NAME = "ValveFault",
