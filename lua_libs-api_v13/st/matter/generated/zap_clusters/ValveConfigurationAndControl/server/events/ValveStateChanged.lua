...
--- @class st.matter.clusters.ValveConfigurationAndControl.ValveStateChanged
--- @alias ValveStateChanged
---
--- @field public ID number 0x0000 the ID of this event
--- @field public NAME string "ValveStateChanged" the name of this event
--- @field public valve_state st.matter.generated.zap_clusters.ValveConfigurationAndControl.types.ValveStateEnum
--- @field public valve_level st.matter.data_types.Uint8
