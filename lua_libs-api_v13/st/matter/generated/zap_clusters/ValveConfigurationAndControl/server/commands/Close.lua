...
-----------------------------------------------------------
-- ValveConfigurationAndControl command Close
-----------------------------------------------------------

--- @class st.matter.clusters.ValveConfigurationAndControl.Close
--- @alias Close
---
--- @field public ID number 0x0001 the ID of this command
--- @field public NAME string "Close" the name of this command
local Close = {}
...
---
--- @param self Close the template class for this command
--- @param device st.matter.Device the device to build this message to
