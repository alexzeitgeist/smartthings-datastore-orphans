...
-----------------------------------------------------------
-- ValveConfigurationAndControl command Open
-----------------------------------------------------------

--- @class st.matter.clusters.ValveConfigurationAndControl.Open
--- @alias Open
---
--- @field public ID number 0x0000 the ID of this command
--- @field public NAME string "Open" the name of this command
--- @field public open_duration st.matter.data_types.Uint32
--- @field public target_level st.matter.data_types.Uint8
local Open = {}
...
---
--- @param self Open the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param open_duration st.matter.data_types.Uint32
--- @param target_level st.matter.data_types.Uint8
