...
--- @class st.matter.clusters.ValveConfigurationAndControl.DefaultOpenDuration
--- @alias DefaultOpenDuration
---
--- @field public ID number 0x0001 the ID of this attribute
--- @field public NAME string "DefaultOpenDuration" the name of this attribute
