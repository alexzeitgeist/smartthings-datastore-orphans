...
--- @class st.matter.clusters.ValveConfigurationAndControl.ValveFault
--- @alias ValveFault
---
--- @field public ID number 0x0009 the ID of this attribute
--- @field public NAME string "ValveFault" the name of this attribute
--- @field public data_type st.matter.generated.zap_clusters.ValveConfigurationAndControl.types.ValveFaultBitmap the data type of this attribute
...
---
--- @vararg vararg the values needed to construct a ValveFaultBitmap
--- @return st.matter.generated.zap_clusters.ValveConfigurationAndControl.types.ValveFaultBitmap
