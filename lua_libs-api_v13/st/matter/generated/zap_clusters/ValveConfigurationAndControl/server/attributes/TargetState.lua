...
--- @class st.matter.clusters.ValveConfigurationAndControl.TargetState
--- @alias TargetState
---
--- @field public ID number 0x0005 the ID of this attribute
--- @field public NAME string "TargetState" the name of this attribute
--- @field public data_type st.matter.generated.zap_clusters.ValveConfigurationAndControl.types.ValveStateEnum the data type of this attribute
...
---
--- @vararg vararg the values needed to construct a ValveStateEnum
--- @return st.matter.generated.zap_clusters.ValveConfigurationAndControl.types.ValveStateEnum
