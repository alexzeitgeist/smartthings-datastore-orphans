...
--- @class st.matter.clusters.ValveConfigurationAndControl.DefaultOpenLevel
--- @alias DefaultOpenLevel
---
--- @field public ID number 0x0008 the ID of this attribute
--- @field public NAME string "DefaultOpenLevel" the name of this attribute
