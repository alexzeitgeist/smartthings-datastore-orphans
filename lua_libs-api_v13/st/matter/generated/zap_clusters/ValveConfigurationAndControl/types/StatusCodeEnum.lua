...
--- @class st.matter.clusters.ValveConfigurationAndControl.types.StatusCodeEnum: st.matter.data_types.Uint8
--- @alias StatusCodeEnum
---
--- @field public byte_length number 1
--- @field public FAILURE_DUE_TO_FAULT number 2
