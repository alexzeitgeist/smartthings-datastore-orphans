...
--- @alias ActivePresetHandle
---
--- @field public ID number 0x004E the ID of this attribute
--- @field public NAME string "ActivePresetHandle" the name of this attribute
--- @field public data_type st.matter.data_types.OctetString1 the data type of this attribute

local ActivePresetHandle = {
  ID = 0x004E,
...
function ActivePresetHandle:new_value(...)
...
function ActivePresetHandle:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ActivePresetHandle:subscribe(device, endpoint_id)
...
function ActivePresetHandle:set_parent_cluster(cluster)
...
function ActivePresetHandle:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ActivePresetHandle:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(ActivePresetHandle, {__call = ActivePresetHandle.new_value, __index = ActivePresetHandle.base_type})
