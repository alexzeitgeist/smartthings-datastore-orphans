...
--- @alias SetpointHoldExpiryTimestamp
---
--- @field public ID number 0x0052 the ID of this attribute
--- @field public NAME string "SetpointHoldExpiryTimestamp" the name of this attribute
--- @field public data_type st.matter.data_types.Uint32 the data type of this attribute

local SetpointHoldExpiryTimestamp = {
  ID = 0x0052,
...
function SetpointHoldExpiryTimestamp:new_value(...)
...
function SetpointHoldExpiryTimestamp:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function SetpointHoldExpiryTimestamp:subscribe(device, endpoint_id)
...
function SetpointHoldExpiryTimestamp:set_parent_cluster(cluster)
...
function SetpointHoldExpiryTimestamp:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function SetpointHoldExpiryTimestamp:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(SetpointHoldExpiryTimestamp, {__call = SetpointHoldExpiryTimestamp.new_value, __index = SetpointHoldExpiryTimestamp.base_type})
