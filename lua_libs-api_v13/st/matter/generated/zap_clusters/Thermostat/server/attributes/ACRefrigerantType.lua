...
--- @field public data_type st.matter.generated.zap_clusters.Thermostat.types.ACRefrigerantTypeEnum the data type of this attribute

local ACRefrigerantType = {
  ID = 0x0042,
  NAME = "ACRefrigerantType",
  base_type = require "st.matter.generated.zap_clusters.Thermostat.types.ACRefrigerantTypeEnum",
}
...
--- @return st.matter.generated.zap_clusters.Thermostat.types.ACRefrigerantTypeEnum
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.generated.zap_clusters.Thermostat.types.ACRefrigerantTypeEnum the value to write
...
setmetatable(ACRefrigerantType, {__call = ACRefrigerantType.new_value, __index = ACRefrigerantType.base_type})
