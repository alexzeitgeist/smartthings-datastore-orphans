...
--- @field public NAME string "Schedules" the name of this attribute
...
local Schedules = {
  ...
  element_type = require "st.matter.generated.zap_clusters.Thermostat.types.ScheduleStruct",
}

--- Add additional functionality to the base type object
---
--- @param base_type_obj st.matter.data_types.Array the base data type object to add functionality to
function Schedules:augment_type(data_type_obj)
  for i, v in ipairs(data_type_obj.elements) do
    data_type_obj.elements[i] = data_types.validate_or_build_type(v, Schedules.element_type)
  end
end
...
function Schedules:read(device, endpoint_id)
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.data_types.Array the value to write
--- @return st.matter.interaction_model.InteractionRequest
function Schedules:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function Schedules:subscribe(device, endpoint_id)
...
function Schedules:set_parent_cluster(cluster)
...
function Schedules:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Schedules:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(Schedules, {__call = Schedules.new_value, __index = Schedules.base_type})
return Schedules
