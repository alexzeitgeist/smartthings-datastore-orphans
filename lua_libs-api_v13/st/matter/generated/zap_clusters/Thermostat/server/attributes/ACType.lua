...
--- @field public data_type st.matter.generated.zap_clusters.Thermostat.types.ACTypeEnum the data type of this attribute

local ACType = {
  ID = 0x0040,
  NAME = "ACType",
  base_type = require "st.matter.generated.zap_clusters.Thermostat.types.ACTypeEnum",
}
...
--- @return st.matter.generated.zap_clusters.Thermostat.types.ACTypeEnum
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.generated.zap_clusters.Thermostat.types.ACTypeEnum the value to write
...
setmetatable(ACType, {__call = ACType.new_value, __index = ACType.base_type})
return ACType
