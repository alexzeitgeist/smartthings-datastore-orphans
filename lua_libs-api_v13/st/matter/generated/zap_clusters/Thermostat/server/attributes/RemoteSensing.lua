...
--- @field public data_type st.matter.generated.zap_clusters.Thermostat.types.RemoteSensingBitmap the data type of this attribute

local RemoteSensing = {
  ID = 0x001A,
  NAME = "RemoteSensing",
  base_type = require "st.matter.generated.zap_clusters.Thermostat.types.RemoteSensingBitmap",
}
...
--- @return st.matter.generated.zap_clusters.Thermostat.types.RemoteSensingBitmap
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.generated.zap_clusters.Thermostat.types.RemoteSensingBitmap the value to write
...
setmetatable(RemoteSensing, {__call = RemoteSensing.new_value, __index = RemoteSensing.base_type})
