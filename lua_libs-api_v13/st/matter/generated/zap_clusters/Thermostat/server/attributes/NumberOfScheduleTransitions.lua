...
--- @alias NumberOfScheduleTransitions
---
--- @field public ID number 0x004C the ID of this attribute
--- @field public NAME string "NumberOfScheduleTransitions" the name of this attribute
--- @field public data_type st.matter.data_types.Uint8 the data type of this attribute

local NumberOfScheduleTransitions = {
  ID = 0x004C,
...
function NumberOfScheduleTransitions:new_value(...)
...
function NumberOfScheduleTransitions:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function NumberOfScheduleTransitions:subscribe(device, endpoint_id)
...
function NumberOfScheduleTransitions:set_parent_cluster(cluster)
...
function NumberOfScheduleTransitions:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function NumberOfScheduleTransitions:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(NumberOfScheduleTransitions, {__call = NumberOfScheduleTransitions.new_value, __index = NumberOfScheduleTransitions.base_type})
