...
--- @field public data_type st.matter.generated.zap_clusters.Thermostat.types.ACCompressorTypeEnum the data type of this attribute

local ACCompressorType = {
  ID = 0x0043,
  NAME = "ACCompressorType",
  base_type = require "st.matter.generated.zap_clusters.Thermostat.types.ACCompressorTypeEnum",
}
...
--- @return st.matter.generated.zap_clusters.Thermostat.types.ACCompressorTypeEnum
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.generated.zap_clusters.Thermostat.types.ACCompressorTypeEnum the value to write
...
setmetatable(ACCompressorType, {__call = ACCompressorType.new_value, __index = ACCompressorType.base_type})
