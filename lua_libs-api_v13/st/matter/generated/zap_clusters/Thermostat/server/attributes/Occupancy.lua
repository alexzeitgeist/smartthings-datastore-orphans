...
--- @field public data_type st.matter.generated.zap_clusters.Thermostat.types.OccupancyBitmap the data type of this attribute

local Occupancy = {
  ID = 0x0002,
  NAME = "Occupancy",
  base_type = require "st.matter.generated.zap_clusters.Thermostat.types.OccupancyBitmap",
}
...
--- @return st.matter.generated.zap_clusters.Thermostat.types.OccupancyBitmap
