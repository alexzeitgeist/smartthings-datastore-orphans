...
--- @field public data_type st.matter.generated.zap_clusters.Thermostat.types.StartOfWeekEnum the data type of this attribute

local StartOfWeek = {
  ID = 0x0020,
  NAME = "StartOfWeek",
  base_type = require "st.matter.generated.zap_clusters.Thermostat.types.StartOfWeekEnum",
}
...
--- @return st.matter.generated.zap_clusters.Thermostat.types.StartOfWeekEnum
...
setmetatable(StartOfWeek, {__call = StartOfWeek.new_value, __index = StartOfWeek.base_type})
return StartOfWeek
