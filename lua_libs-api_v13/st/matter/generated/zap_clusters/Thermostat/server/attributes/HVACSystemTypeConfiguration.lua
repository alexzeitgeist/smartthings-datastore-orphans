...
--- @field public data_type st.matter.generated.zap_clusters.Thermostat.types.HVACSystemTypeBitmap the data type of this attribute

local HVACSystemTypeConfiguration = {
  ID = 0x0009,
  NAME = "HVACSystemTypeConfiguration",
  base_type = require "st.matter.generated.zap_clusters.Thermostat.types.HVACSystemTypeBitmap",
}
...
---
--- @vararg vararg the values needed to construct a HVACSystemTypeBitmap
--- @return st.matter.generated.zap_clusters.Thermostat.types.HVACSystemTypeBitmap
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.generated.zap_clusters.Thermostat.types.HVACSystemTypeBitmap the value to write
...
setmetatable(HVACSystemTypeConfiguration, {__call = HVACSystemTypeConfiguration.new_value, __index = HVACSystemTypeConfiguration.base_type})
