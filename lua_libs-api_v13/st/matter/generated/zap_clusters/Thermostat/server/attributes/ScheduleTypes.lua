...
--- @alias ScheduleTypes
---
--- @field public ID number 0x0049 the ID of this attribute
--- @field public NAME string "ScheduleTypes" the name of this attribute
...
local ScheduleTypes = {
  ...
  element_type = require "st.matter.generated.zap_clusters.Thermostat.types.ScheduleTypeStruct",
}

--- Add additional functionality to the base type object
---
--- @param base_type_obj st.matter.data_types.Array the base data type object to add functionality to
function ScheduleTypes:augment_type(data_type_obj)
  for i, v in ipairs(data_type_obj.elements) do
    data_type_obj.elements[i] = data_types.validate_or_build_type(v, ScheduleTypes.element_type)
  end
end
...
function ScheduleTypes:new_value(...)
...
function ScheduleTypes:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ScheduleTypes:subscribe(device, endpoint_id)
...
function ScheduleTypes:set_parent_cluster(cluster)
...
function ScheduleTypes:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ScheduleTypes:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(ScheduleTypes, {__call = ScheduleTypes.new_value, __index = ScheduleTypes.base_type})
