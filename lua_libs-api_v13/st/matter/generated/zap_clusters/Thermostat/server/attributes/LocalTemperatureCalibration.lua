...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.data_types.Int8 the value to write
...
setmetatable(LocalTemperatureCalibration, {__call = LocalTemperatureCalibration.new_value, __index = LocalTemperatureCalibration.base_type})
