...
--- @alias ActiveScheduleHandle
---
--- @field public ID number 0x004F the ID of this attribute
--- @field public NAME string "ActiveScheduleHandle" the name of this attribute
--- @field public data_type st.matter.data_types.OctetString1 the data type of this attribute

local ActiveScheduleHandle = {
  ID = 0x004F,
...
function ActiveScheduleHandle:new_value(...)
...
function ActiveScheduleHandle:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ActiveScheduleHandle:subscribe(device, endpoint_id)
...
function ActiveScheduleHandle:set_parent_cluster(cluster)
...
function ActiveScheduleHandle:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ActiveScheduleHandle:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(ActiveScheduleHandle, {__call = ActiveScheduleHandle.new_value, __index = ActiveScheduleHandle.base_type})
