...
--- @field public data_type st.matter.generated.zap_clusters.Thermostat.types.ACLouverPositionEnum the data type of this attribute

local ACLouverPosition = {
  ID = 0x0045,
  NAME = "ACLouverPosition",
  base_type = require "st.matter.generated.zap_clusters.Thermostat.types.ACLouverPositionEnum",
}
...
--- @return st.matter.generated.zap_clusters.Thermostat.types.ACLouverPositionEnum
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.generated.zap_clusters.Thermostat.types.ACLouverPositionEnum the value to write
...
setmetatable(ACLouverPosition, {__call = ACLouverPosition.new_value, __index = ACLouverPosition.base_type})
