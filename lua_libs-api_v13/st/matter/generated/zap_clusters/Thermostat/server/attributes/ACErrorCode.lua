...
--- @field public data_type st.matter.generated.zap_clusters.Thermostat.types.ACErrorCodeBitmap the data type of this attribute

local ACErrorCode = {
  ID = 0x0044,
  NAME = "ACErrorCode",
  base_type = require "st.matter.generated.zap_clusters.Thermostat.types.ACErrorCodeBitmap",
}
...
--- @return st.matter.generated.zap_clusters.Thermostat.types.ACErrorCodeBitmap
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.generated.zap_clusters.Thermostat.types.ACErrorCodeBitmap the value to write
...
setmetatable(ACErrorCode, {__call = ACErrorCode.new_value, __index = ACErrorCode.base_type})
return ACErrorCode
