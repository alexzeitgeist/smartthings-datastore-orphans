...
--- @field public data_type st.matter.generated.zap_clusters.Thermostat.types.ThermostatRunningModeEnum the data type of this attribute

local ThermostatRunningMode = {
  ID = 0x001E,
  NAME = "ThermostatRunningMode",
  base_type = require "st.matter.generated.zap_clusters.Thermostat.types.ThermostatRunningModeEnum",
}
...
--- @return st.matter.generated.zap_clusters.Thermostat.types.ThermostatRunningModeEnum
...
setmetatable(ThermostatRunningMode, {__call = ThermostatRunningMode.new_value, __index = ThermostatRunningMode.base_type})
