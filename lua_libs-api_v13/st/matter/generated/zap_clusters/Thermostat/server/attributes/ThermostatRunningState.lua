...
--- @field public data_type st.matter.generated.zap_clusters.Thermostat.types.RelayStateBitmap the data type of this attribute

local ThermostatRunningState = {
  ID = 0x0029,
  NAME = "ThermostatRunningState",
  base_type = require "st.matter.generated.zap_clusters.Thermostat.types.RelayStateBitmap",
}
...
--- @return st.matter.generated.zap_clusters.Thermostat.types.RelayStateBitmap
...
setmetatable(ThermostatRunningState, {__call = ThermostatRunningState.new_value, __index = ThermostatRunningState.base_type})
