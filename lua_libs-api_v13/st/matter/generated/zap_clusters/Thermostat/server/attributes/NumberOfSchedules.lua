...
--- @alias NumberOfSchedules
---
--- @field public ID number 0x004B the ID of this attribute
--- @field public NAME string "NumberOfSchedules" the name of this attribute
--- @field public data_type st.matter.data_types.Uint8 the data type of this attribute

local NumberOfSchedules = {
  ID = 0x004B,
...
function NumberOfSchedules:new_value(...)
...
function NumberOfSchedules:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function NumberOfSchedules:subscribe(device, endpoint_id)
...
function NumberOfSchedules:set_parent_cluster(cluster)
...
function NumberOfSchedules:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function NumberOfSchedules:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(NumberOfSchedules, {__call = NumberOfSchedules.new_value, __index = NumberOfSchedules.base_type})
