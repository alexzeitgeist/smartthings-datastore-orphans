...
--- @field public data_type st.matter.generated.zap_clusters.Thermostat.types.SetpointChangeSourceEnum the data type of this attribute

local SetpointChangeSource = {
  ID = 0x0030,
  NAME = "SetpointChangeSource",
  base_type = require "st.matter.generated.zap_clusters.Thermostat.types.SetpointChangeSourceEnum",
}
...
--- @return st.matter.generated.zap_clusters.Thermostat.types.SetpointChangeSourceEnum
...
setmetatable(SetpointChangeSource, {__call = SetpointChangeSource.new_value, __index = SetpointChangeSource.base_type})
