...
--- @field public NAME string "Presets" the name of this attribute
...
local Presets = {
  ...
  element_type = require "st.matter.generated.zap_clusters.Thermostat.types.PresetStruct",
}

--- Add additional functionality to the base type object
---
--- @param base_type_obj st.matter.data_types.Array the base data type object to add functionality to
function Presets:augment_type(data_type_obj)
  for i, v in ipairs(data_type_obj.elements) do
    data_type_obj.elements[i] = data_types.validate_or_build_type(v, Presets.element_type)
  end
end
...
function Presets:read(device, endpoint_id)
...
function Presets:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function Presets:subscribe(device, endpoint_id)
...
function Presets:set_parent_cluster(cluster)
...
function Presets:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Presets:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(Presets, {__call = Presets.new_value, __index = Presets.base_type})
return Presets
