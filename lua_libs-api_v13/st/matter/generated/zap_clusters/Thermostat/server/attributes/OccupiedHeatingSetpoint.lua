...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.data_types.Int16 the value to write
...
setmetatable(OccupiedHeatingSetpoint, {__call = OccupiedHeatingSetpoint.new_value, __index = OccupiedHeatingSetpoint.base_type})
