...
--- @field public data_type st.matter.generated.zap_clusters.Thermostat.types.ProgrammingOperationModeBitmap the data type of this attribute

local ThermostatProgrammingOperationMode = {
  ID = 0x0025,
  NAME = "ThermostatProgrammingOperationMode",
  base_type = require "st.matter.generated.zap_clusters.Thermostat.types.ProgrammingOperationModeBitmap",
}
...
--- @return st.matter.generated.zap_clusters.Thermostat.types.ProgrammingOperationModeBitmap
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.generated.zap_clusters.Thermostat.types.ProgrammingOperationModeBitmap the value to write
...
setmetatable(ThermostatProgrammingOperationMode, {__call = ThermostatProgrammingOperationMode.new_value, __index = ThermostatProgrammingOperationMode.base_type})
