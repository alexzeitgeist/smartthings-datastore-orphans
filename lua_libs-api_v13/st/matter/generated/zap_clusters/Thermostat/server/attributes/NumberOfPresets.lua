...
--- @alias NumberOfPresets
---
--- @field public ID number 0x004A the ID of this attribute
--- @field public NAME string "NumberOfPresets" the name of this attribute
--- @field public data_type st.matter.data_types.Uint8 the data type of this attribute

local NumberOfPresets = {
  ID = 0x004A,
...
function NumberOfPresets:new_value(...)
...
function NumberOfPresets:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function NumberOfPresets:subscribe(device, endpoint_id)
...
function NumberOfPresets:set_parent_cluster(cluster)
...
function NumberOfPresets:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function NumberOfPresets:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(NumberOfPresets, {__call = NumberOfPresets.new_value, __index = NumberOfPresets.base_type})
