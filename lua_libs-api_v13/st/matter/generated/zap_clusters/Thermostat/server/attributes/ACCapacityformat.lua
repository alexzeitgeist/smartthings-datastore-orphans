...
--- @field public data_type st.matter.generated.zap_clusters.Thermostat.types.ACCapacityFormatEnum the data type of this attribute

local ACCapacityformat = {
  ID = 0x0047,
  NAME = "ACCapacityformat",
  base_type = require "st.matter.generated.zap_clusters.Thermostat.types.ACCapacityFormatEnum",
}
...
--- @return st.matter.generated.zap_clusters.Thermostat.types.ACCapacityFormatEnum
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.generated.zap_clusters.Thermostat.types.ACCapacityFormatEnum the value to write
...
setmetatable(ACCapacityformat, {__call = ACCapacityformat.new_value, __index = ACCapacityformat.base_type})
