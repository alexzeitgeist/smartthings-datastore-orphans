...
--- @field public data_type st.matter.generated.zap_clusters.Thermostat.types.SystemModeEnum the data type of this attribute

local SystemMode = {
  ID = 0x001C,
  NAME = "SystemMode",
  base_type = require "st.matter.generated.zap_clusters.Thermostat.types.SystemModeEnum",
}
...
--- @return st.matter.generated.zap_clusters.Thermostat.types.SystemModeEnum
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.generated.zap_clusters.Thermostat.types.SystemModeEnum the value to write
...
setmetatable(SystemMode, {__call = SystemMode.new_value, __index = SystemMode.base_type})
return SystemMode
