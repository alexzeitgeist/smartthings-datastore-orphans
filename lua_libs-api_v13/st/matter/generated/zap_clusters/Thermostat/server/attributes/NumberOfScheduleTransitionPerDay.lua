...
--- @alias NumberOfScheduleTransitionPerDay
---
--- @field public ID number 0x004D the ID of this attribute
--- @field public NAME string "NumberOfScheduleTransitionPerDay" the name of this attribute
--- @field public data_type st.matter.data_types.Uint8 the data type of this attribute

local NumberOfScheduleTransitionPerDay = {
  ID = 0x004D,
...
function NumberOfScheduleTransitionPerDay:new_value(...)
...
function NumberOfScheduleTransitionPerDay:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function NumberOfScheduleTransitionPerDay:subscribe(device, endpoint_id)
...
function NumberOfScheduleTransitionPerDay:set_parent_cluster(cluster)
...
function NumberOfScheduleTransitionPerDay:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function NumberOfScheduleTransitionPerDay:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(NumberOfScheduleTransitionPerDay, {__call = NumberOfScheduleTransitionPerDay.new_value, __index = NumberOfScheduleTransitionPerDay.base_type})
