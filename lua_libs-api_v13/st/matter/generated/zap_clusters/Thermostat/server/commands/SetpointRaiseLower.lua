...
--- @field public mode st.matter.generated.zap_clusters.Thermostat.types.SetpointRaiseLowerModeEnum
--- @field public amount st.matter.data_types.Int8
...
SetpointRaiseLower.field_defs = {
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.Thermostat.types.SetpointRaiseLowerModeEnum",
  },
  {
    name = "amount",
    field_id = 1,
...
--- @param device st.matter.Device the device to build this message to
--- @param mode st.matter.generated.zap_clusters.Thermostat.types.SetpointRaiseLowerModeEnum
