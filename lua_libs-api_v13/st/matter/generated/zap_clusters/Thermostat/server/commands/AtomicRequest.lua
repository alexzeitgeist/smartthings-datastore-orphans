...
-----------------------------------------------------------
-- Thermostat command AtomicRequest
-----------------------------------------------------------

--- @class st.matter.clusters.Thermostat.AtomicRequest
--- @alias AtomicRequest
---
--- @field public ID number 0x00FE the ID of this command
--- @field public NAME string "AtomicRequest" the name of this command
--- @field public request_type st.matter.generated.zap_clusters.Global.types.AtomicRequestTypeEnum
--- @field public attribute_requests st.matter.data_types.Array
--- @field public timeout st.matter.data_types.Uint16
local AtomicRequest = {}

AtomicRequest.NAME = "AtomicRequest"
AtomicRequest.ID = 0x00FE
AtomicRequest.field_defs = {
  {
    name = "request_type",
    field_id = 0,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.Global.types.AtomicRequestTypeEnum",
  },
  {
...
--- Initialize the AtomicRequest command
---
--- @param self AtomicRequest the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param request_type st.matter.generated.zap_clusters.Global.types.AtomicRequestTypeEnum
--- @param attribute_requests st.matter.data_types.Array
--- @param timeout st.matter.data_types.Uint16

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function AtomicRequest:init(device, endpoint_id, request_type, attribute_requests, timeout)
  local out = {}
  local args = {request_type, attribute_requests, timeout}
  ...
  setmetatable(out, {
    __index = AtomicRequest,
    __tostring = AtomicRequest.pretty_print
  })
...
function AtomicRequest:set_parent_cluster(cluster)
...
function AtomicRequest:augment_type(base_type_obj)
  local elems = {}
...
function AtomicRequest:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(AtomicRequest, {__call = AtomicRequest.init})
