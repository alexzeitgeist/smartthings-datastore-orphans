...
-----------------------------------------------------------
-- Thermostat command SetActiveScheduleRequest
-----------------------------------------------------------

--- @class st.matter.clusters.Thermostat.SetActiveScheduleRequest
--- @alias SetActiveScheduleRequest
---
--- @field public ID number 0x0005 the ID of this command
--- @field public NAME string "SetActiveScheduleRequest" the name of this command
--- @field public schedule_handle st.matter.data_types.OctetString1
local SetActiveScheduleRequest = {}

SetActiveScheduleRequest.NAME = "SetActiveScheduleRequest"
SetActiveScheduleRequest.ID = 0x0005
SetActiveScheduleRequest.field_defs = {
  {
...
function SetActiveScheduleRequest:build_test_command_response(device, endpoint_id, status)
...
---
--- @param self SetActiveScheduleRequest the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param schedule_handle st.matter.data_types.OctetString1

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function SetActiveScheduleRequest:init(device, endpoint_id, schedule_handle)
  local out = {}
  local args = {schedule_handle}
  ...
  setmetatable(out, {
    __index = SetActiveScheduleRequest,
    __tostring = SetActiveScheduleRequest.pretty_print
  })
...
function SetActiveScheduleRequest:set_parent_cluster(cluster)
...
function SetActiveScheduleRequest:augment_type(base_type_obj)
  local elems = {}
...
function SetActiveScheduleRequest:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(SetActiveScheduleRequest, {__call = SetActiveScheduleRequest.init})
