...
--- @alias WeeklyScheduleTransitionStruct
...
local WeeklyScheduleTransitionStruct = {}
local new_mt = StructureABC.new_mt({NAME = "WeeklyScheduleTransitionStruct", ID = data_types.name_to_id_map["Structure"]})

WeeklyScheduleTransitionStruct.field_defs = {
  {
...
WeeklyScheduleTransitionStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
WeeklyScheduleTransitionStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = WeeklyScheduleTransitionStruct.init
new_mt.__index.serialize = WeeklyScheduleTransitionStruct.serialize

WeeklyScheduleTransitionStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(WeeklyScheduleTransitionStruct, new_mt)

return WeeklyScheduleTransitionStruct
