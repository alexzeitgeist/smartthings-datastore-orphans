...
--- @class st.matter.clusters.Thermostat.types.OccupancyBitmap
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.Thermostat.types.OccupancyBitmap")
if has_aliases then
