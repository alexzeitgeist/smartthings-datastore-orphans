...
--- @field public number_of_presets st.matter.data_types.Uint8
--- @field public preset_type_features st.matter.generated.zap_clusters.Thermostat.types.PresetTypeFeaturesBitmap
local PresetTypeStruct = {}
local new_mt = StructureABC.new_mt({NAME = "PresetTypeStruct", ID = data_types.name_to_id_map["Structure"]})

PresetTypeStruct.field_defs = {
  {
  ...
  {
    name = "preset_type_features",
    field_id = 2,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.Thermostat.types.PresetTypeFeaturesBitmap",
  },
}

PresetTypeStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
PresetTypeStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = PresetTypeStruct.init
new_mt.__index.serialize = PresetTypeStruct.serialize

PresetTypeStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(PresetTypeStruct, new_mt)

return PresetTypeStruct
