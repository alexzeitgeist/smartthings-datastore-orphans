...
--- @field public number_of_schedules st.matter.data_types.Uint8
--- @field public schedule_type_features st.matter.generated.zap_clusters.Thermostat.types.ScheduleTypeFeaturesBitmap
local ScheduleTypeStruct = {}
local new_mt = StructureABC.new_mt({NAME = "ScheduleTypeStruct", ID = data_types.name_to_id_map["Structure"]})

ScheduleTypeStruct.field_defs = {
  {
    name = "system_mode",
    field_id = 0,
    is_nullable = false,
  ...
  {
    name = "schedule_type_features",
    field_id = 2,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.Thermostat.types.ScheduleTypeFeaturesBitmap",
  },
}

ScheduleTypeStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
ScheduleTypeStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = ScheduleTypeStruct.init
new_mt.__index.serialize = ScheduleTypeStruct.serialize

ScheduleTypeStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(ScheduleTypeStruct, new_mt)

return ScheduleTypeStruct
