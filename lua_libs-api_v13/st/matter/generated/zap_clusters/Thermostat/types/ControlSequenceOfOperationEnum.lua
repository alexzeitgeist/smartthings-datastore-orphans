...
--- @alias ControlSequenceOfOperationEnum
---
...
local ControlSequenceOfOperationEnum = {}
local new_mt = UintABC.new_mt({NAME = "ControlSequenceOfOperationEnum", ID = data_types.name_to_id_map["Uint8"]}, 1)
...
ControlSequenceOfOperationEnum.COOLING_ONLY  = 0x00
ControlSequenceOfOperationEnum.COOLING_WITH_REHEAT  = 0x01
ControlSequenceOfOperationEnum.HEATING_ONLY  = 0x02
ControlSequenceOfOperationEnum.HEATING_WITH_REHEAT  = 0x03
ControlSequenceOfOperationEnum.COOLING_AND_HEATING  = 0x04
ControlSequenceOfOperationEnum.COOLING_AND_HEATING_WITH_REHEAT  = 0x05

ControlSequenceOfOperationEnum.augment_type = function(cls, val)
  setmetatable(val, new_mt)
end

setmetatable(ControlSequenceOfOperationEnum, new_mt)

local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.Thermostat.types.ControlSequenceOfOperationEnum")
if has_aliases then
  aliases:add_to_class(ControlSequenceOfOperationEnum)
end

return ControlSequenceOfOperationEnum
