...
-----------------------------------------------------------
-- Thermostat command AtomicResponse
-----------------------------------------------------------

--- @class st.matter.clusters.Thermostat.AtomicResponse
--- @alias AtomicResponse
---
--- @field public ID number 0x00FD the ID of this command
--- @field public NAME string "AtomicResponse" the name of this command
--- @field public status_code st.matter.data_types.Uint8
--- @field public attribute_status st.matter.data_types.Array
--- @field public timeout st.matter.data_types.Uint16
local AtomicResponse = {}

AtomicResponse.NAME = "AtomicResponse"
AtomicResponse.ID = 0x00FD
AtomicResponse.field_defs = {
  {
    name = "status_code",
    field_id = 0,
    is_nullable = false,
  ...
  },
  {
    ...
    element_type = require "st.matter.generated.zap_clusters.Global.types.AtomicAttributeStatusStruct",
  },
  {
    name = "timeout",
    field_id = 2,
...
function AtomicResponse:augment_type(base_type_obj)
  local elems = {}
...
--- @param status_code st.matter.data_types.Uint8
--- @param attribute_status st.matter.data_types.Array
...
function AtomicResponse:build_test_command_response(device, endpoint_id, status_code, attribute_status, timeout, interaction_status)
  local function init(self, device, endpoint_id, status_code, attribute_status, timeout)
    local out = {}
    local args = {status_code, attribute_status, timeout}
    ...
    setmetatable(out, {
      __index = AtomicResponse,
      __tostring = AtomicResponse.pretty_print
    })
  ...
  local self_request =  init(self, device, endpoint_id, status_code, attribute_status, timeout)
...
---
--- @return nil
function AtomicResponse:init()
  return nil
end

function AtomicResponse:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

function AtomicResponse:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(AtomicResponse, {__call = AtomicResponse.init})
