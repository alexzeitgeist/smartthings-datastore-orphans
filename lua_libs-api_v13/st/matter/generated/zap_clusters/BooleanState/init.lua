...
do
  local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.BooleanState.server.attributes")
  if has_aliases then
    for alias, _ in pairs(aliases) do
      BooleanState.attribute_direction_map[alias] = "server"
    end
  end
end
...
do
  local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.BooleanState.server.commands")
  if has_aliases then
    for alias, _ in pairs(aliases) do
      BooleanState.command_direction_map[alias] = "server"
    end
  end
end

do
  local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.BooleanState.client.commands")
  if has_aliases then
    for alias, _ in pairs(aliases) do
      BooleanState.command_direction_map[alias] = "client"
    end
  end
end
