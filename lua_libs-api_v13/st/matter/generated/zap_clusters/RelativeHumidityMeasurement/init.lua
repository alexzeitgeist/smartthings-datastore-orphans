...
do
  local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.RelativeHumidityMeasurement.server.attributes")
  if has_aliases then
    for alias, _ in pairs(aliases) do
      RelativeHumidityMeasurement.attribute_direction_map[alias] = "server"
    end
  end
end
...
do
  local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.RelativeHumidityMeasurement.server.commands")
  if has_aliases then
    for alias, _ in pairs(aliases) do
      RelativeHumidityMeasurement.command_direction_map[alias] = "server"
    end
  end
end

do
  local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.RelativeHumidityMeasurement.client.commands")
  if has_aliases then
    for alias, _ in pairs(aliases) do
      RelativeHumidityMeasurement.command_direction_map[alias] = "client"
    end
  end
end
