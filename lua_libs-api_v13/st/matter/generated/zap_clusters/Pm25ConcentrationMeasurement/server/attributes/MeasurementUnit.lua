...
--- @class st.matter.clusters.Pm25ConcentrationMeasurement.MeasurementUnit
...
--- @field public data_type st.matter.generated.zap_clusters.Pm25ConcentrationMeasurement.types.MeasurementUnitEnum the data type of this attribute

local MeasurementUnit = {
  ID = 0x0008,
  NAME = "MeasurementUnit",
  base_type = require "st.matter.generated.zap_clusters.Pm25ConcentrationMeasurement.types.MeasurementUnitEnum",
}
...
--- @return st.matter.generated.zap_clusters.Pm25ConcentrationMeasurement.types.MeasurementUnitEnum
