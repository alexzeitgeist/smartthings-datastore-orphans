...
-----------------------------------------------------------
-- AudioOutput command RenameOutput
-----------------------------------------------------------

--- @class st.matter.clusters.AudioOutput.RenameOutput
--- @alias RenameOutput
---
--- @field public ID number 0x0001 the ID of this command
--- @field public NAME string "RenameOutput" the name of this command
--- @field public index st.matter.data_types.Uint8
--- @field public name st.matter.data_types.UTF8String1
local RenameOutput = {}

RenameOutput.NAME = "RenameOutput"
RenameOutput.ID = 0x0001
RenameOutput.field_defs = {
  {
    name = "index",
    field_id = 0,
    is_nullable = false,
...
--- Builds an RenameOutput test command reponse for the driver integration testing framework
---
...
function RenameOutput:build_test_command_response(device, endpoint_id, status)
...
--- Initialize the RenameOutput command
---
--- @param self RenameOutput the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param index st.matter.data_types.Uint8
--- @param name st.matter.data_types.UTF8String1

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function RenameOutput:init(device, endpoint_id, index, name)
  local out = {}
  local args = {index, name}
  ...
  setmetatable(out, {
    __index = RenameOutput,
    __tostring = RenameOutput.pretty_print
  })
...
function RenameOutput:set_parent_cluster(cluster)
...
function RenameOutput:augment_type(base_type_obj)
  local elems = {}
...
function RenameOutput:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(RenameOutput, {__call = RenameOutput.init})
