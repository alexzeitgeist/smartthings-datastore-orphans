...
-----------------------------------------------------------
-- AudioOutput command SelectOutput
-----------------------------------------------------------

--- @class st.matter.clusters.AudioOutput.SelectOutput
--- @alias SelectOutput
---
--- @field public ID number 0x0000 the ID of this command
--- @field public NAME string "SelectOutput" the name of this command
--- @field public index st.matter.data_types.Uint8
local SelectOutput = {}

SelectOutput.NAME = "SelectOutput"
SelectOutput.ID = 0x0000
SelectOutput.field_defs = {
  {
    name = "index",
    field_id = 0,
    is_nullable = false,
...
--- Builds an SelectOutput test command reponse for the driver integration testing framework
---
...
function SelectOutput:build_test_command_response(device, endpoint_id, status)
...
--- Initialize the SelectOutput command
---
--- @param self SelectOutput the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param index st.matter.data_types.Uint8

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function SelectOutput:init(device, endpoint_id, index)
  local out = {}
  local args = {index}
  ...
  setmetatable(out, {
    __index = SelectOutput,
    __tostring = SelectOutput.pretty_print
  })
...
function SelectOutput:set_parent_cluster(cluster)
...
function SelectOutput:augment_type(base_type_obj)
  local elems = {}
...
function SelectOutput:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(SelectOutput, {__call = SelectOutput.init})
