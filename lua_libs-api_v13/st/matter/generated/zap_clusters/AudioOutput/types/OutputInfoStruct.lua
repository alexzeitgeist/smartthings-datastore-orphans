...
--- @alias OutputInfoStruct
--- @class st.matter.clusters.AudioOutput.types.OutputInfoStruct: st.matter.data_types.Structure
---
--- @field public index st.matter.data_types.Uint8
--- @field public output_type st.matter.generated.zap_clusters.AudioOutput.types.OutputTypeEnum
--- @field public name st.matter.data_types.UTF8String1
local OutputInfoStruct = {}
local new_mt = StructureABC.new_mt({NAME = "OutputInfoStruct", ID = data_types.name_to_id_map["Structure"]})

OutputInfoStruct.field_defs = {
  {
    name = "index",
    field_id = 0,
    is_nullable = false,
  ...
  },
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.AudioOutput.types.OutputTypeEnum",
  },
  {
    name = "name",
    field_id = 2,
...
OutputInfoStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
OutputInfoStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = OutputInfoStruct.init
new_mt.__index.serialize = OutputInfoStruct.serialize

OutputInfoStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(OutputInfoStruct, new_mt)

return OutputInfoStruct
