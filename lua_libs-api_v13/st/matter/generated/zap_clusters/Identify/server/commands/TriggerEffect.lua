...
--- @class st.matter.clusters.Identify.TriggerEffect
--- @alias TriggerEffect
---
--- @field public ID number 0x0040 the ID of this command
--- @field public NAME string "TriggerEffect" the name of this command
--- @field public effect_identifier st.matter.generated.zap_clusters.Identify.types.EffectIdentifierEnum
--- @field public effect_variant st.matter.generated.zap_clusters.Identify.types.EffectVariantEnum
local TriggerEffect = {}

TriggerEffect.NAME = "TriggerEffect"
TriggerEffect.ID = 0x0040
TriggerEffect.field_defs = {
  {
    name = "effect_identifier",
    field_id = 0,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.Identify.types.EffectIdentifierEnum",
  },
  {
    name = "effect_variant",
    field_id = 1,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.Identify.types.EffectVariantEnum",
  },
}

--- Builds an TriggerEffect test command reponse for the driver integration testing framework
---
...
function TriggerEffect:build_test_command_response(device, endpoint_id, status)
...
--- @param device st.matter.Device the device to build this message to
--- @param effect_identifier st.matter.generated.zap_clusters.Identify.types.EffectIdentifierEnum
--- @param effect_variant st.matter.generated.zap_clusters.Identify.types.EffectVariantEnum

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function TriggerEffect:init(device, endpoint_id, effect_identifier, effect_variant)
  local out = {}
...
function TriggerEffect:augment_type(base_type_obj)
  local elems = {}
...
function TriggerEffect:deserialize(tlv_buf)
