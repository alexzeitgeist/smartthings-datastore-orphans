...
--- Builds an Identify test command reponse for the driver integration testing framework
---
...
function Identify:build_test_command_response(device, endpoint_id, status)
...
--- @param device st.matter.Device the device to build this message to
--- @param identify_time st.matter.data_types.Uint16

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function Identify:init(device, endpoint_id, identify_time)
  local out = {}
...
function Identify:augment_type(base_type_obj)
  local elems = {}
...
function Identify:deserialize(tlv_buf)
