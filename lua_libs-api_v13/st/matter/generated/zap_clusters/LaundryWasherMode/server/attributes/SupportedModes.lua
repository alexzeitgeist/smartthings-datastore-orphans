...
--- @class st.matter.clusters.LaundryWasherMode.SupportedModes
...
local SupportedModes = {
  ...
  element_type = require "st.matter.generated.zap_clusters.LaundryWasherMode.types.ModeOptionStruct",
}
