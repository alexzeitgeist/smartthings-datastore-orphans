...
--- @class st.matter.clusters.MicrowaveOvenControl.types.Feature
--- @alias Feature
---
--- @field public POWER_AS_NUMBER number 1
--- @field public POWER_IN_WATTS number 2
--- @field public POWER_NUMBER_LIMITS number 4
...
--- @function Feature:is_power_as_number_set
--- @return boolean True if the value of POWER_AS_NUMBER is non-zero
Feature.is_power_as_number_set = function(self)
  return (self.value & self.POWER_AS_NUMBER) ~= 0
end

--- @function Feature:set_power_as_number
--- Set the value of the bit in the POWER_AS_NUMBER field to 1
...
--- @function Feature:unset_power_as_number
--- Set the value of the bits in the POWER_AS_NUMBER field to 0
Feature.unset_power_as_number = function(self)
  self.value = self.value & (~self.POWER_AS_NUMBER & self.BASE_MASK)
end
--- @function Feature:is_power_in_watts_set
--- @return boolean True if the value of POWER_IN_WATTS is non-zero
Feature.is_power_in_watts_set = function(self)
  return (self.value & self.POWER_IN_WATTS) ~= 0
end

--- @function Feature:set_power_in_watts
--- Set the value of the bit in the POWER_IN_WATTS field to 1
...
--- @function Feature:unset_power_in_watts
--- Set the value of the bits in the POWER_IN_WATTS field to 0
Feature.unset_power_in_watts = function(self)
  self.value = self.value & (~self.POWER_IN_WATTS & self.BASE_MASK)
end
--- @function Feature:is_power_number_limits_set
--- @return boolean True if the value of POWER_NUMBER_LIMITS is non-zero
Feature.is_power_number_limits_set = function(self)
  return (self.value & self.POWER_NUMBER_LIMITS) ~= 0
end

--- @function Feature:set_power_number_limits
--- Set the value of the bit in the POWER_NUMBER_LIMITS field to 1
...
--- @function Feature:unset_power_number_limits
--- Set the value of the bits in the POWER_NUMBER_LIMITS field to 0
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.MicrowaveOvenControl.types.Feature")
if has_aliases then
