...
-----------------------------------------------------------
-- MicrowaveOvenControl command AddMoreTime
-----------------------------------------------------------

--- @class st.matter.clusters.MicrowaveOvenControl.AddMoreTime
--- @alias AddMoreTime
---
--- @field public ID number 0x0001 the ID of this command
--- @field public NAME string "AddMoreTime" the name of this command
--- @field public time_to_add st.matter.data_types.Uint32
local AddMoreTime = {}
...
--- Builds an AddMoreTime test command reponse for the driver integration testing framework
---
...
--- Initialize the AddMoreTime command
---
--- @param self AddMoreTime the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param time_to_add st.matter.data_types.Uint32
