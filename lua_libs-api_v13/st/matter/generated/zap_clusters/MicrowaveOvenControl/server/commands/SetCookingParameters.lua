...
-----------------------------------------------------------
-- MicrowaveOvenControl command SetCookingParameters
-----------------------------------------------------------

--- @class st.matter.clusters.MicrowaveOvenControl.SetCookingParameters
--- @alias SetCookingParameters
---
--- @field public ID number 0x0000 the ID of this command
--- @field public NAME string "SetCookingParameters" the name of this command
--- @field public cook_mode st.matter.data_types.Uint8
--- @field public cook_time st.matter.data_types.Uint32
--- @field public power_setting st.matter.data_types.Uint8
--- @field public watt_setting_index st.matter.data_types.Uint8
--- @field public start_after_setting st.matter.data_types.Boolean
...
--- Builds an SetCookingParameters test command reponse for the driver integration testing framework
---
...
--- Initialize the SetCookingParameters command
---
--- @param self SetCookingParameters the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param cook_mode st.matter.data_types.Uint8
--- @param cook_time st.matter.data_types.Uint32
--- @param power_setting st.matter.data_types.Uint8
--- @param watt_setting_index st.matter.data_types.Uint8
--- @param start_after_setting st.matter.data_types.Boolean
