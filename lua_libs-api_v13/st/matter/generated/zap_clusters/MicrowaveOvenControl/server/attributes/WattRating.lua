...
--- @class st.matter.clusters.MicrowaveOvenControl.WattRating
--- @alias WattRating
---
--- @field public ID number 0x0008 the ID of this attribute
--- @field public NAME string "WattRating" the name of this attribute
...
--- This is also usable with the WattRating(...) syntax
---
...
--- Reporting policy: WattRating => true => mandatory
...
--- Builds an WattRating test attribute reponse for the driver integration testing framework
---
...
setmetatable(WattRating, {__call = WattRating.new_value, __index = WattRating.base_type})
return WattRating
