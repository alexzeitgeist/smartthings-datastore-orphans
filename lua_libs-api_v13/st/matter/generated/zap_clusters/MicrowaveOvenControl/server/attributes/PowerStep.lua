...
--- @class st.matter.clusters.MicrowaveOvenControl.PowerStep
--- @alias PowerStep
---
--- @field public ID number 0x0005 the ID of this attribute
--- @field public NAME string "PowerStep" the name of this attribute
...
--- This is also usable with the PowerStep(...) syntax
---
...
--- Reporting policy: PowerStep => true => mandatory
...
--- Builds an PowerStep test attribute reponse for the driver integration testing framework
---
...
setmetatable(PowerStep, {__call = PowerStep.new_value, __index = PowerStep.base_type})
return PowerStep
