...
--- @class st.matter.clusters.MicrowaveOvenControl.MinPower
--- @alias MinPower
---
--- @field public ID number 0x0003 the ID of this attribute
--- @field public NAME string "MinPower" the name of this attribute
...
--- This is also usable with the MinPower(...) syntax
---
...
--- Reporting policy: MinPower => true => mandatory
...
--- Builds an MinPower test attribute reponse for the driver integration testing framework
---
...
setmetatable(MinPower, {__call = MinPower.new_value, __index = MinPower.base_type})
return MinPower
