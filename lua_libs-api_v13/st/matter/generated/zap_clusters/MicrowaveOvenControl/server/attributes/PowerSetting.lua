...
--- @class st.matter.clusters.MicrowaveOvenControl.PowerSetting
--- @alias PowerSetting
---
--- @field public ID number 0x0002 the ID of this attribute
--- @field public NAME string "PowerSetting" the name of this attribute
...
--- This is also usable with the PowerSetting(...) syntax
---
...
--- Reporting policy: PowerSetting => true => mandatory
...
--- Builds an PowerSetting test attribute reponse for the driver integration testing framework
---
...
setmetatable(PowerSetting, {__call = PowerSetting.new_value, __index = PowerSetting.base_type})
return PowerSetting
