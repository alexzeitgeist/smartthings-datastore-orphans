...
--- @class st.matter.clusters.MicrowaveOvenControl.SelectedWattIndex
--- @alias SelectedWattIndex
---
--- @field public ID number 0x0007 the ID of this attribute
--- @field public NAME string "SelectedWattIndex" the name of this attribute
...
--- This is also usable with the SelectedWattIndex(...) syntax
---
...
--- Reporting policy: SelectedWattIndex => true => mandatory
...
--- Builds an SelectedWattIndex test attribute reponse for the driver integration testing framework
---
...
setmetatable(SelectedWattIndex, {__call = SelectedWattIndex.new_value, __index = SelectedWattIndex.base_type})
