...
--- @class st.matter.clusters.MicrowaveOvenControl.MaxPower
--- @alias MaxPower
---
--- @field public ID number 0x0004 the ID of this attribute
--- @field public NAME string "MaxPower" the name of this attribute
...
--- This is also usable with the MaxPower(...) syntax
---
...
--- Reporting policy: MaxPower => true => mandatory
...
--- Builds an MaxPower test attribute reponse for the driver integration testing framework
---
...
setmetatable(MaxPower, {__call = MaxPower.new_value, __index = MaxPower.base_type})
return MaxPower
