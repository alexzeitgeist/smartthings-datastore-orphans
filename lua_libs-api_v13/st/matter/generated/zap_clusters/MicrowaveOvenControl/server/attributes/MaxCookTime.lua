...
--- @class st.matter.clusters.MicrowaveOvenControl.MaxCookTime
--- @alias MaxCookTime
---
--- @field public ID number 0x0001 the ID of this attribute
--- @field public NAME string "MaxCookTime" the name of this attribute
...
--- This is also usable with the MaxCookTime(...) syntax
---
...
--- Reporting policy: MaxCookTime => true => mandatory
...
--- Builds an MaxCookTime test attribute reponse for the driver integration testing framework
---
