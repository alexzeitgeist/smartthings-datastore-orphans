...
--- @class st.matter.clusters.AccountLogin.LoggedOut
--- @alias LoggedOut
---
--- @field public ID number 0x0000 the ID of this event
--- @field public NAME string "LoggedOut" the name of this event
...
function LoggedOut:augment_type(base_type_obj)
  local elems = {}
...
function LoggedOut:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function LoggedOut:subscribe(device, endpoint_id)
...
--- Builds an LoggedOut test event report reponse to be used by
...
function LoggedOut:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "LoggedOutEventData", ID = 0x15}))
...
function LoggedOut:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function LoggedOut:set_parent_cluster(cluster)
