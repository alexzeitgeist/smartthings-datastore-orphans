...
-----------------------------------------------------------
-- AccountLogin command Logout
-----------------------------------------------------------

--- @class st.matter.clusters.AccountLogin.Logout
--- @alias Logout
---
--- @field public ID number 0x0003 the ID of this command
--- @field public NAME string "Logout" the name of this command
...
--- Builds an Logout test command reponse for the driver integration testing framework
---
...
function Logout:build_test_command_response(device, endpoint_id, status)
...
function Logout:init(device, endpoint_id, node)
  ...
  setmetatable(out, {
    __index = Logout,
    __tostring = Logout.pretty_print
  })
...
function Logout:set_parent_cluster(cluster)
...
function Logout:augment_type(base_type_obj)
  local elems = {}
...
function Logout:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(Logout, {__call = Logout.init})
