...
-----------------------------------------------------------
-- AccountLogin command GetSetupPIN
-----------------------------------------------------------

--- @class st.matter.clusters.AccountLogin.GetSetupPIN
--- @alias GetSetupPIN
---
--- @field public ID number 0x0000 the ID of this command
--- @field public NAME string "GetSetupPIN" the name of this command
--- @field public temp_account_identifier st.matter.data_types.UTF8String1
local GetSetupPIN = {}

GetSetupPIN.NAME = "GetSetupPIN"
GetSetupPIN.ID = 0x0000
GetSetupPIN.field_defs = {
  {
...
--- Refer to GetSetupPINResponse:build_test_command_response for
--- building a test command reponse for the driver integration testing framework

--- Initialize the GetSetupPIN command
---
--- @param self GetSetupPIN the template class for this command
...
function GetSetupPIN:init(device, endpoint_id, temp_account_identifier)
  local out = {}
  local args = {temp_account_identifier}
  ...
  setmetatable(out, {
    __index = GetSetupPIN,
    __tostring = GetSetupPIN.pretty_print
  })
...
function GetSetupPIN:set_parent_cluster(cluster)
...
function GetSetupPIN:augment_type(base_type_obj)
  local elems = {}
...
function GetSetupPIN:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(GetSetupPIN, {__call = GetSetupPIN.init})
