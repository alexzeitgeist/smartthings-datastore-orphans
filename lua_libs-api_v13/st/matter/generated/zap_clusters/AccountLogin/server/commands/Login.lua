...
-----------------------------------------------------------
-- AccountLogin command Login
-----------------------------------------------------------

--- @class st.matter.clusters.AccountLogin.Login
--- @alias Login
---
--- @field public ID number 0x0002 the ID of this command
--- @field public NAME string "Login" the name of this command
--- @field public temp_account_identifier st.matter.data_types.UTF8String1
--- @field public setuppin st.matter.data_types.UTF8String1
--- @field public node st.matter.data_types.Uint64
local Login = {}
...
--- Builds an Login test command reponse for the driver integration testing framework
---
...
function Login:build_test_command_response(device, endpoint_id, status)
...
---
--- @param self Login the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param temp_account_identifier st.matter.data_types.UTF8String1
--- @param setuppin st.matter.data_types.UTF8String1
--- @param node st.matter.data_types.Uint64

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function Login:init(device, endpoint_id, temp_account_identifier, setuppin, node)
  local out = {}
  local args = {temp_account_identifier, setuppin, node}
...
function Login:set_parent_cluster(cluster)
...
function Login:augment_type(base_type_obj)
  local elems = {}
...
function Login:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(Login, {__call = Login.init})
