...
-----------------------------------------------------------
-- AccountLogin command GetSetupPINResponse
-----------------------------------------------------------

--- @class st.matter.clusters.AccountLogin.GetSetupPINResponse
--- @alias GetSetupPINResponse
---
--- @field public ID number 0x0001 the ID of this command
--- @field public NAME string "GetSetupPINResponse" the name of this command
--- @field public setuppin st.matter.data_types.UTF8String1
local GetSetupPINResponse = {}

GetSetupPINResponse.NAME = "GetSetupPINResponse"
GetSetupPINResponse.ID = 0x0001
GetSetupPINResponse.field_defs = {
  {
    name = "setuppin",
    field_id = 0,
    is_nullable = false,
...
function GetSetupPINResponse:augment_type(base_type_obj)
  local elems = {}
...
--- Builds an GetSetupPINResponse test command reponse for the driver integration testing framework
---
--- @param device st.matter.Device the device to build this message to
--- @param endpoint_id number|nil
--- @param setuppin st.matter.data_types.UTF8String1
--- @return st.matter.st.matter.interaction_model.InteractionResponse of type COMMAND_RESPONSE
function GetSetupPINResponse:build_test_command_response(device, endpoint_id, setuppin, interaction_status)
  local function init(self, device, endpoint_id, setuppin)
    local out = {}
    local args = {setuppin}
    ...
    setmetatable(out, {
      __index = GetSetupPINResponse,
      __tostring = GetSetupPINResponse.pretty_print
    })
  ...
  local self_request =  init(self, device, endpoint_id, setuppin)
...
--- Initialize the GetSetupPINResponse command
---
--- @return nil
function GetSetupPINResponse:init()
  return nil
end

function GetSetupPINResponse:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

function GetSetupPINResponse:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(GetSetupPINResponse, {__call = GetSetupPINResponse.init})
