...
-----------------------------------------------------------
-- ThreadBorderRouterManagement command SetActiveDatasetRequest
-----------------------------------------------------------

--- @class st.matter.clusters.ThreadBorderRouterManagement.SetActiveDatasetRequest
--- @alias SetActiveDatasetRequest
---
--- @field public ID number 0x0003 the ID of this command
--- @field public NAME string "SetActiveDatasetRequest" the name of this command
--- @field public active_dataset st.matter.data_types.OctetString1
--- @field public breadcrumb st.matter.data_types.Uint64
local SetActiveDatasetRequest = {}

SetActiveDatasetRequest.NAME = "SetActiveDatasetRequest"
SetActiveDatasetRequest.ID = 0x0003
SetActiveDatasetRequest.field_defs = {
  {
    name = "active_dataset",
    field_id = 0,
    is_nullable = false,
...
--- Builds an SetActiveDatasetRequest test command reponse for the driver integration testing framework
---
...
function SetActiveDatasetRequest:build_test_command_response(device, endpoint_id, status)
...
--- Initialize the SetActiveDatasetRequest command
---
--- @param self SetActiveDatasetRequest the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param active_dataset st.matter.data_types.OctetString1
--- @param breadcrumb st.matter.data_types.Uint64

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function SetActiveDatasetRequest:init(device, endpoint_id, active_dataset, breadcrumb)
  local out = {}
  local args = {active_dataset, breadcrumb}
  ...
  setmetatable(out, {
    __index = SetActiveDatasetRequest,
    __tostring = SetActiveDatasetRequest.pretty_print
  })
...
function SetActiveDatasetRequest:set_parent_cluster(cluster)
...
function SetActiveDatasetRequest:augment_type(base_type_obj)
  local elems = {}
...
function SetActiveDatasetRequest:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(SetActiveDatasetRequest, {__call = SetActiveDatasetRequest.init})
