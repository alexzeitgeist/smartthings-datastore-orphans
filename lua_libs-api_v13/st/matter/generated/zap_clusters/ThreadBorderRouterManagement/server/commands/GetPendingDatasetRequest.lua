...
-----------------------------------------------------------
-- ThreadBorderRouterManagement command GetPendingDatasetRequest
-----------------------------------------------------------

--- @class st.matter.clusters.ThreadBorderRouterManagement.GetPendingDatasetRequest
--- @alias GetPendingDatasetRequest
---
--- @field public ID number 0x0001 the ID of this command
--- @field public NAME string "GetPendingDatasetRequest" the name of this command
local GetPendingDatasetRequest = {}

GetPendingDatasetRequest.NAME = "GetPendingDatasetRequest"
GetPendingDatasetRequest.ID = 0x0001
GetPendingDatasetRequest.field_defs = {
}

--- Refer to DatasetResponse:build_test_command_response for
--- building a test command reponse for the driver integration testing framework

--- Initialize the GetPendingDatasetRequest command
---
--- @param self GetPendingDatasetRequest the template class for this command
...
function GetPendingDatasetRequest:init(device, endpoint_id)
  local out = {}
  local args = {}
  ...
  setmetatable(out, {
    __index = GetPendingDatasetRequest,
    __tostring = GetPendingDatasetRequest.pretty_print
  })
...
function GetPendingDatasetRequest:set_parent_cluster(cluster)
...
function GetPendingDatasetRequest:augment_type(base_type_obj)
  local elems = {}
...
function GetPendingDatasetRequest:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(GetPendingDatasetRequest, {__call = GetPendingDatasetRequest.init})
