...
-----------------------------------------------------------
-- ThreadBorderRouterManagement command GetActiveDatasetRequest
-----------------------------------------------------------

--- @class st.matter.clusters.ThreadBorderRouterManagement.GetActiveDatasetRequest
--- @alias GetActiveDatasetRequest
---
--- @field public ID number 0x0000 the ID of this command
--- @field public NAME string "GetActiveDatasetRequest" the name of this command
...
--- Initialize the GetActiveDatasetRequest command
---
--- @param self GetActiveDatasetRequest the template class for this command
