...
-----------------------------------------------------------
-- ThreadBorderRouterManagement command DatasetResponse
-----------------------------------------------------------

--- @class st.matter.clusters.ThreadBorderRouterManagement.DatasetResponse
--- @alias DatasetResponse
---
--- @field public ID number 0x0002 the ID of this command
--- @field public NAME string "DatasetResponse" the name of this command
--- @field public dataset st.matter.data_types.OctetString1
...
--- Builds an DatasetResponse test command reponse for the driver integration testing framework
---
--- @param device st.matter.Device the device to build this message to
--- @param endpoint_id number|nil
--- @param dataset st.matter.data_types.OctetString1
...
--- Initialize the DatasetResponse command
---
--- @return nil
