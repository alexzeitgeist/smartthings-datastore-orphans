...
types_mt.__index = function(self, key)
  if types_mt.__types_cache[key] == nil then
    types_mt.__types_cache[key] = require("st.matter.generated.zap_clusters.ThreadBorderRouterManagement.types." .. key)
  end
  return types_mt.__types_cache[key]
end

--- @class st.matter.generated.zap_clusters.ThreadBorderRouterManagementTypes
---

--- @field public Feature st.matter.generated.zap_clusters.ThreadBorderRouterManagement.types.Feature
