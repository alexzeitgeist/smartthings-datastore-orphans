...
--- @field public color_temperature_mireds st.matter.data_types.Uint16
...
--- @param device st.matter.Device the device to build this message to
--- @param color_temperature_mireds st.matter.data_types.Uint16
...
function MoveToColorTemperature:init(device, endpoint_id, color_temperature_mireds, transition_time, options_mask, options_override)
  local out = {}
