...
--- @field public update_flags st.matter.generated.zap_clusters.ColorControl.types.UpdateFlagsBitmap
--- @field public action st.matter.generated.zap_clusters.ColorControl.types.ColorLoopActionEnum
--- @field public direction st.matter.generated.zap_clusters.ColorControl.types.ColorLoopDirectionEnum
--- @field public time st.matter.data_types.Uint16
--- @field public start_hue st.matter.data_types.Uint16
--- @field public options_mask st.matter.generated.zap_clusters.ColorControl.types.OptionsBitmap
--- @field public options_override st.matter.generated.zap_clusters.ColorControl.types.OptionsBitmap
local ColorLoopSet = {}
...
ColorLoopSet.field_defs = {
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.ColorControl.types.UpdateFlagsBitmap",
  },
  {
    name = "action",
    field_id = 1,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.ColorControl.types.ColorLoopActionEnum",
  },
  {
    name = "direction",
    field_id = 2,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.ColorControl.types.ColorLoopDirectionEnum",
  },
  {
    name = "time",
    field_id = 3,
  ...
  },
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.ColorControl.types.OptionsBitmap",
  },
  {
...
--- @param device st.matter.Device the device to build this message to
--- @param update_flags st.matter.generated.zap_clusters.ColorControl.types.UpdateFlagsBitmap
--- @param action st.matter.generated.zap_clusters.ColorControl.types.ColorLoopActionEnum
--- @param direction st.matter.generated.zap_clusters.ColorControl.types.ColorLoopDirectionEnum
--- @param time st.matter.data_types.Uint16
--- @param start_hue st.matter.data_types.Uint16
--- @param options_mask st.matter.generated.zap_clusters.ColorControl.types.OptionsBitmap
--- @param options_override st.matter.generated.zap_clusters.ColorControl.types.OptionsBitmap
