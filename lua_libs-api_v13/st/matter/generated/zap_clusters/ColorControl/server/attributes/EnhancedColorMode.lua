...
--- @field public data_type st.matter.generated.zap_clusters.ColorControl.types.EnhancedColorModeEnum the data type of this attribute

local EnhancedColorMode = {
  ID = 0x4001,
  NAME = "EnhancedColorMode",
  base_type = require "st.matter.generated.zap_clusters.ColorControl.types.EnhancedColorModeEnum",
}
...
---
--- @vararg vararg the values needed to construct a EnhancedColorModeEnum
--- @return st.matter.generated.zap_clusters.ColorControl.types.EnhancedColorModeEnum
...
setmetatable(EnhancedColorMode, {__call = EnhancedColorMode.new_value, __index = EnhancedColorMode.base_type})
