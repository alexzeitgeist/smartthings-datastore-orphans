...
--- @field public data_type st.matter.generated.zap_clusters.ColorControl.types.ColorModeEnum the data type of this attribute

local ColorMode = {
  ID = 0x0008,
  NAME = "ColorMode",
  base_type = require "st.matter.generated.zap_clusters.ColorControl.types.ColorModeEnum",
}
...
---
--- @vararg vararg the values needed to construct a ColorModeEnum
--- @return st.matter.generated.zap_clusters.ColorControl.types.ColorModeEnum
...
setmetatable(ColorMode, {__call = ColorMode.new_value, __index = ColorMode.base_type})
return ColorMode
