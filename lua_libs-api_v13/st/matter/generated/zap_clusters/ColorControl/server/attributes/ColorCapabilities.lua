...
--- @field public data_type st.matter.generated.zap_clusters.ColorControl.types.ColorCapabilitiesBitmap the data type of this attribute

local ColorCapabilities = {
  ID = 0x400A,
  NAME = "ColorCapabilities",
  base_type = require "st.matter.generated.zap_clusters.ColorControl.types.ColorCapabilitiesBitmap",
}
...
---
--- @vararg vararg the values needed to construct a ColorCapabilitiesBitmap
--- @return st.matter.generated.zap_clusters.ColorControl.types.ColorCapabilitiesBitmap
...
setmetatable(ColorCapabilities, {__call = ColorCapabilities.new_value, __index = ColorCapabilities.base_type})
