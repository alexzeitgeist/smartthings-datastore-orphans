...
do
  local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.ColorControl.server.attributes")
  if has_aliases then
    for alias, _ in pairs(aliases) do
      ColorControl.attribute_direction_map[alias] = "server"
    end
  end
end
...
do
  local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.ColorControl.server.commands")
  if has_aliases then
    for alias, _ in pairs(aliases) do
      ColorControl.command_direction_map[alias] = "server"
    end
  end
end

do
  local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.ColorControl.client.commands")
  if has_aliases then
    for alias, _ in pairs(aliases) do
      ColorControl.command_direction_map[alias] = "client"
    end
  end
end

ColorControl.FeatureMap = ColorControl.types.Feature
