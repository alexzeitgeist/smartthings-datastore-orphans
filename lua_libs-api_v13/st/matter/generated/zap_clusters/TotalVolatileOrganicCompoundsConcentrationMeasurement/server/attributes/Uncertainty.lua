...
--- @class st.matter.clusters.TotalVolatileOrganicCompoundsConcentrationMeasurement.Uncertainty
--- @alias Uncertainty
---
--- @field public ID number 0x0007 the ID of this attribute
--- @field public NAME string "Uncertainty" the name of this attribute
...
function Uncertainty:new_value(...)
...
function Uncertainty:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Uncertainty:subscribe(device, endpoint_id)
...
function Uncertainty:set_parent_cluster(cluster)
...
function Uncertainty:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Uncertainty:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(Uncertainty, {__call = Uncertainty.new_value, __index = Uncertainty.base_type})
return Uncertainty
