...
--- @class st.matter.clusters.TotalVolatileOrganicCompoundsConcentrationMeasurement.PeakMeasuredValue
--- @alias PeakMeasuredValue
---
--- @field public ID number 0x0003 the ID of this attribute
--- @field public NAME string "PeakMeasuredValue" the name of this attribute
--- @field public data_type st.matter.data_types.SinglePrecisionFloat the data type of this attribute

local PeakMeasuredValue = {
  ID = 0x0003,
...
function PeakMeasuredValue:new_value(...)
...
function PeakMeasuredValue:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function PeakMeasuredValue:subscribe(device, endpoint_id)
...
function PeakMeasuredValue:set_parent_cluster(cluster)
...
function PeakMeasuredValue:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function PeakMeasuredValue:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(PeakMeasuredValue, {__call = PeakMeasuredValue.new_value, __index = PeakMeasuredValue.base_type})
