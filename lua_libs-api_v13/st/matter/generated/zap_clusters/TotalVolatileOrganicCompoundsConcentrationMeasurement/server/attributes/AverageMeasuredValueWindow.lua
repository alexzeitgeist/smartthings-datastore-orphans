...
--- @class st.matter.clusters.TotalVolatileOrganicCompoundsConcentrationMeasurement.AverageMeasuredValueWindow
--- @alias AverageMeasuredValueWindow
---
--- @field public ID number 0x0006 the ID of this attribute
--- @field public NAME string "AverageMeasuredValueWindow" the name of this attribute
--- @field public data_type st.matter.data_types.Uint32 the data type of this attribute

local AverageMeasuredValueWindow = {
  ID = 0x0006,
...
function AverageMeasuredValueWindow:new_value(...)
...
function AverageMeasuredValueWindow:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function AverageMeasuredValueWindow:subscribe(device, endpoint_id)
...
function AverageMeasuredValueWindow:set_parent_cluster(cluster)
...
function AverageMeasuredValueWindow:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function AverageMeasuredValueWindow:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(AverageMeasuredValueWindow, {__call = AverageMeasuredValueWindow.new_value, __index = AverageMeasuredValueWindow.base_type})
