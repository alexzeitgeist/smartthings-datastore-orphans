...
--- @class st.matter.clusters.TotalVolatileOrganicCompoundsConcentrationMeasurement.LevelValue
--- @alias LevelValue
---
--- @field public ID number 0x000A the ID of this attribute
--- @field public NAME string "LevelValue" the name of this attribute
--- @field public data_type st.matter.generated.zap_clusters.TotalVolatileOrganicCompoundsConcentrationMeasurement.types.LevelValueEnum the data type of this attribute

local LevelValue = {
  ID = 0x000A,
  NAME = "LevelValue",
  base_type = require "st.matter.generated.zap_clusters.TotalVolatileOrganicCompoundsConcentrationMeasurement.types.LevelValueEnum",
}
...
---
--- @vararg vararg the values needed to construct a LevelValueEnum
--- @return st.matter.generated.zap_clusters.TotalVolatileOrganicCompoundsConcentrationMeasurement.types.LevelValueEnum
