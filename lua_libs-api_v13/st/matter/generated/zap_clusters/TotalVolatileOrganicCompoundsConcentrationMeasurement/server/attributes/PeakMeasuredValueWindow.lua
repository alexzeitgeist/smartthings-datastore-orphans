...
--- @class st.matter.clusters.TotalVolatileOrganicCompoundsConcentrationMeasurement.PeakMeasuredValueWindow
--- @alias PeakMeasuredValueWindow
---
--- @field public ID number 0x0004 the ID of this attribute
--- @field public NAME string "PeakMeasuredValueWindow" the name of this attribute
--- @field public data_type st.matter.data_types.Uint32 the data type of this attribute

local PeakMeasuredValueWindow = {
  ID = 0x0004,
...
function PeakMeasuredValueWindow:new_value(...)
...
function PeakMeasuredValueWindow:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function PeakMeasuredValueWindow:subscribe(device, endpoint_id)
...
function PeakMeasuredValueWindow:set_parent_cluster(cluster)
...
function PeakMeasuredValueWindow:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function PeakMeasuredValueWindow:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(PeakMeasuredValueWindow, {__call = PeakMeasuredValueWindow.new_value, __index = PeakMeasuredValueWindow.base_type})
