...
--- @class st.matter.clusters.TotalVolatileOrganicCompoundsConcentrationMeasurement.AverageMeasuredValue
--- @alias AverageMeasuredValue
---
--- @field public ID number 0x0005 the ID of this attribute
--- @field public NAME string "AverageMeasuredValue" the name of this attribute
--- @field public data_type st.matter.data_types.SinglePrecisionFloat the data type of this attribute

local AverageMeasuredValue = {
  ID = 0x0005,
...
function AverageMeasuredValue:new_value(...)
...
function AverageMeasuredValue:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function AverageMeasuredValue:subscribe(device, endpoint_id)
...
function AverageMeasuredValue:set_parent_cluster(cluster)
...
function AverageMeasuredValue:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function AverageMeasuredValue:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(AverageMeasuredValue, {__call = AverageMeasuredValue.new_value, __index = AverageMeasuredValue.base_type})
