...
--- @class st.matter.clusters.TotalVolatileOrganicCompoundsConcentrationMeasurement.types.Feature
--- @alias Feature
---
--- @field public NUMERIC_MEASUREMENT number 1
--- @field public LEVEL_INDICATION number 2
--- @field public MEDIUM_LEVEL number 4
--- @field public CRITICAL_LEVEL number 8
--- @field public PEAK_MEASUREMENT number 16
--- @field public AVERAGE_MEASUREMENT number 32
...
--- @function Feature:is_numeric_measurement_set
--- @return boolean True if the value of NUMERIC_MEASUREMENT is non-zero
Feature.is_numeric_measurement_set = function(self)
  return (self.value & self.NUMERIC_MEASUREMENT) ~= 0
end

--- @function Feature:set_numeric_measurement
...
--- @function Feature:unset_numeric_measurement
...
--- @function Feature:is_level_indication_set
--- @return boolean True if the value of LEVEL_INDICATION is non-zero
Feature.is_level_indication_set = function(self)
  return (self.value & self.LEVEL_INDICATION) ~= 0
end

--- @function Feature:set_level_indication
...
--- @function Feature:unset_level_indication
...
--- @function Feature:is_medium_level_set
--- @return boolean True if the value of MEDIUM_LEVEL is non-zero
Feature.is_medium_level_set = function(self)
  return (self.value & self.MEDIUM_LEVEL) ~= 0
end

--- @function Feature:set_medium_level
...
--- @function Feature:unset_medium_level
...
--- @function Feature:is_critical_level_set
--- @return boolean True if the value of CRITICAL_LEVEL is non-zero
Feature.is_critical_level_set = function(self)
  return (self.value & self.CRITICAL_LEVEL) ~= 0
end

--- @function Feature:set_critical_level
...
--- @function Feature:unset_critical_level
...
--- @function Feature:is_peak_measurement_set
--- @return boolean True if the value of PEAK_MEASUREMENT is non-zero
Feature.is_peak_measurement_set = function(self)
  return (self.value & self.PEAK_MEASUREMENT) ~= 0
end

--- @function Feature:set_peak_measurement
...
--- @function Feature:unset_peak_measurement
...
--- @function Feature:is_average_measurement_set
--- @return boolean True if the value of AVERAGE_MEASUREMENT is non-zero
Feature.is_average_measurement_set = function(self)
  return (self.value & self.AVERAGE_MEASUREMENT) ~= 0
end

--- @function Feature:set_average_measurement
...
--- @function Feature:unset_average_measurement
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.TotalVolatileOrganicCompoundsConcentrationMeasurement.types.Feature")
if has_aliases then
