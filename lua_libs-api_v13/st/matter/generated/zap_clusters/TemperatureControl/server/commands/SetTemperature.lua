...
-----------------------------------------------------------
-- TemperatureControl command SetTemperature
-----------------------------------------------------------

--- @class st.matter.clusters.TemperatureControl.SetTemperature
--- @alias SetTemperature
---
--- @field public ID number 0x0000 the ID of this command
--- @field public NAME string "SetTemperature" the name of this command
--- @field public target_temperature st.matter.data_types.Int16
--- @field public target_temperature_level st.matter.data_types.Uint8
...
--- Builds an SetTemperature test command reponse for the driver integration testing framework
---
...
--- Initialize the SetTemperature command
---
--- @param self SetTemperature the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param target_temperature st.matter.data_types.Int16
--- @param target_temperature_level st.matter.data_types.Uint8
