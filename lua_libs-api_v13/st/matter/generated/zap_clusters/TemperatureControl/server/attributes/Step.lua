...
--- @class st.matter.clusters.TemperatureControl.Step
--- @alias Step
---
--- @field public ID number 0x0003 the ID of this attribute
--- @field public NAME string "Step" the name of this attribute
...
--- This is also usable with the Step(...) syntax
---
...
--- Reporting policy: Step => true => mandatory
...
--- Builds an Step test attribute reponse for the driver integration testing framework
---
