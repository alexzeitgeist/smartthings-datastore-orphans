...
--- @class st.matter.clusters.TemperatureControl.MaxTemperature
--- @alias MaxTemperature
---
--- @field public ID number 0x0002 the ID of this attribute
--- @field public NAME string "MaxTemperature" the name of this attribute
...
--- This is also usable with the MaxTemperature(...) syntax
---
...
--- Reporting policy: MaxTemperature => true => mandatory
...
--- Builds an MaxTemperature test attribute reponse for the driver integration testing framework
---
