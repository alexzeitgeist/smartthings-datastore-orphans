...
-----------------------------------------------------------
-- RvcOperationalState command GoHome
-----------------------------------------------------------

--- @class st.matter.clusters.RvcOperationalState.GoHome
--- @alias GoHome
---
--- @field public ID number 0x0080 the ID of this command
--- @field public NAME string "GoHome" the name of this command
local GoHome = {}
...
--- Initialize the GoHome command
---
--- @param self GoHome the template class for this command
