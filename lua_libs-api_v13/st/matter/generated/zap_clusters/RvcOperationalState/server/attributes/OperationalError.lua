...
--- @class st.matter.clusters.RvcOperationalState.OperationalError
...
--- @field public data_type st.matter.generated.zap_clusters.RvcOperationalState.types.ErrorStateStruct the data type of this attribute

local OperationalError = {
  ID = 0x0005,
  NAME = "OperationalError",
  base_type = require "st.matter.generated.zap_clusters.RvcOperationalState.types.ErrorStateStruct",
}
...
--- @return st.matter.generated.zap_clusters.RvcOperationalState.types.ErrorStateStruct
