...
--- @class st.matter.clusters.RvcOperationalState.OperationalStateList
...
local OperationalStateList = {
  ...
  element_type = require "st.matter.generated.zap_clusters.RvcOperationalState.types.OperationalStateStruct",
}
