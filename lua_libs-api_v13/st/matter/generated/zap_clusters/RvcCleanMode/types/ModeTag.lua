...
--- @class st.matter.clusters.RvcCleanMode.types.ModeTag: st.matter.data_types.Uint16
--- @alias ModeTag
---
...
--- @field public DEEP_CLEAN number 16384
--- @field public VACUUM number 16385
--- @field public MOP number 16386
