...
command_mt.__index = function(self, key)
  if command_mt.__command_cache[key] == nil then
    local req_loc = string.format("st.matter.generated.zap_clusters.RvcCleanMode.client.commands.%s", key)
...
--- @class st.matter.generated.zap_clusters.RvcCleanModeClientCommands
---
--- @field public ChangeToModeResponse st.matter.generated.zap_clusters.RvcCleanMode.ChangeToModeResponse
