...
--- @class st.matter.clusters.OzoneConcentrationMeasurement.types.Feature
--- @alias Feature
---
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.OzoneConcentrationMeasurement.types.Feature")
if has_aliases then
