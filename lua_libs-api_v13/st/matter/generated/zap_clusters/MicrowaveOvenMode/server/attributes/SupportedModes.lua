...
--- @class st.matter.clusters.MicrowaveOvenMode.SupportedModes
...
local SupportedModes = {
  ...
  element_type = require "st.matter.generated.zap_clusters.MicrowaveOvenMode.types.ModeOptionStruct",
}
