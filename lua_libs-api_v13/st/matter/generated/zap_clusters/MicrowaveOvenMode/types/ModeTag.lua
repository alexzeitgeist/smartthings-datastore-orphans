...
--- @class st.matter.clusters.MicrowaveOvenMode.types.ModeTag: st.matter.data_types.Uint16
--- @alias ModeTag
---
...
--- @field public DEFROST number 16385
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.MicrowaveOvenMode.types.ModeTag")
if has_aliases then
