...
--- @class st.matter.clusters.MicrowaveOvenMode.types.Feature
--- @alias Feature
---
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.MicrowaveOvenMode.types.Feature")
if has_aliases then
