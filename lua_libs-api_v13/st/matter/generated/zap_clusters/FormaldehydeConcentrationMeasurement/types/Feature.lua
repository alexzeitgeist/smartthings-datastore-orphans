...
--- @class st.matter.clusters.FormaldehydeConcentrationMeasurement.types.Feature
--- @alias Feature
---
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.FormaldehydeConcentrationMeasurement.types.Feature")
if has_aliases then
