...
--- @field public status st.matter.generated.zap_clusters.KeypadInput.types.StatusEnum
...
SendKeyResponse.field_defs = {
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.KeypadInput.types.StatusEnum",
  },
}
...
--- @param status st.matter.generated.zap_clusters.KeypadInput.types.StatusEnum
