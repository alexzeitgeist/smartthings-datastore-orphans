...
--- @class st.matter.clusters.KeypadInput.types.StatusEnum: st.matter.data_types.Uint8
--- @alias StatusEnum
---
...
StatusEnum.UNSUPPORTED_KEY  = 0x01
StatusEnum.INVALID_KEY_IN_CURRENT_STATE  = 0x02
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.KeypadInput.types.StatusEnum")
if has_aliases then
