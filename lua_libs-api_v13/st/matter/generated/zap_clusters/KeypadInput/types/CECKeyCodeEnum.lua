...
--- @class st.matter.clusters.KeypadInput.types.CECKeyCodeEnum: st.matter.data_types.Uint8
--- @alias CECKeyCodeEnum
---
...
local CECKeyCodeEnum = {}
local new_mt = UintABC.new_mt({NAME = "CECKeyCodeEnum", ID = data_types.name_to_id_map["Uint8"]}, 1)
...
CECKeyCodeEnum.SELECT  = 0x00
CECKeyCodeEnum.UP  = 0x01
CECKeyCodeEnum.DOWN  = 0x02
CECKeyCodeEnum.LEFT  = 0x03
CECKeyCodeEnum.RIGHT  = 0x04
CECKeyCodeEnum.RIGHT_UP  = 0x05
CECKeyCodeEnum.RIGHT_DOWN  = 0x06
CECKeyCodeEnum.LEFT_UP  = 0x07
CECKeyCodeEnum.LEFT_DOWN  = 0x08
CECKeyCodeEnum.ROOT_MENU  = 0x09
CECKeyCodeEnum.SETUP_MENU  = 0x0A
CECKeyCodeEnum.CONTENTS_MENU  = 0x0B
CECKeyCodeEnum.FAVORITE_MENU  = 0x0C
CECKeyCodeEnum.EXIT  = 0x0D
CECKeyCodeEnum.MEDIA_TOP_MENU  = 0x10
CECKeyCodeEnum.MEDIA_CONTEXT_SENSITIVE_MENU  = 0x11
CECKeyCodeEnum.NUMBER_ENTRY_MODE  = 0x1D
CECKeyCodeEnum.NUMBER11  = 0x1E
CECKeyCodeEnum.NUMBER12  = 0x1F
CECKeyCodeEnum.NUMBER0_OR_NUMBER10  = 0x20
CECKeyCodeEnum.NUMBERS1  = 0x21
CECKeyCodeEnum.NUMBERS2  = 0x22
CECKeyCodeEnum.NUMBERS3  = 0x23
CECKeyCodeEnum.NUMBERS4  = 0x24
CECKeyCodeEnum.NUMBERS5  = 0x25
CECKeyCodeEnum.NUMBERS6  = 0x26
CECKeyCodeEnum.NUMBERS7  = 0x27
CECKeyCodeEnum.NUMBERS8  = 0x28
CECKeyCodeEnum.NUMBERS9  = 0x29
CECKeyCodeEnum.DOT  = 0x2A
CECKeyCodeEnum.ENTER  = 0x2B
CECKeyCodeEnum.CLEAR  = 0x2C
CECKeyCodeEnum.NEXT_FAVORITE  = 0x2F
CECKeyCodeEnum.CHANNEL_UP  = 0x30
CECKeyCodeEnum.CHANNEL_DOWN  = 0x31
CECKeyCodeEnum.PREVIOUS_CHANNEL  = 0x32
CECKeyCodeEnum.SOUND_SELECT  = 0x33
CECKeyCodeEnum.INPUT_SELECT  = 0x34
CECKeyCodeEnum.DISPLAY_INFORMATION  = 0x35
CECKeyCodeEnum.HELP  = 0x36
CECKeyCodeEnum.PAGE_UP  = 0x37
CECKeyCodeEnum.PAGE_DOWN  = 0x38
CECKeyCodeEnum.POWER  = 0x40
CECKeyCodeEnum.VOLUME_UP  = 0x41
CECKeyCodeEnum.VOLUME_DOWN  = 0x42
CECKeyCodeEnum.MUTE  = 0x43
CECKeyCodeEnum.PLAY  = 0x44
CECKeyCodeEnum.STOP  = 0x45
CECKeyCodeEnum.PAUSE  = 0x46
CECKeyCodeEnum.RECORD  = 0x47
CECKeyCodeEnum.REWIND  = 0x48
CECKeyCodeEnum.FAST_FORWARD  = 0x49
CECKeyCodeEnum.EJECT  = 0x4A
CECKeyCodeEnum.FORWARD  = 0x4B
CECKeyCodeEnum.BACKWARD  = 0x4C
CECKeyCodeEnum.STOP_RECORD  = 0x4D
CECKeyCodeEnum.PAUSE_RECORD  = 0x4E
CECKeyCodeEnum.RESERVED  = 0x4F
CECKeyCodeEnum.ANGLE  = 0x50
CECKeyCodeEnum.SUB_PICTURE  = 0x51
CECKeyCodeEnum.VIDEO_ON_DEMAND  = 0x52
CECKeyCodeEnum.ELECTRONIC_PROGRAM_GUIDE  = 0x53
CECKeyCodeEnum.TIMER_PROGRAMMING  = 0x54
CECKeyCodeEnum.INITIAL_CONFIGURATION  = 0x55
CECKeyCodeEnum.SELECT_BROADCAST_TYPE  = 0x56
CECKeyCodeEnum.SELECT_SOUND_PRESENTATION  = 0x57
CECKeyCodeEnum.PLAY_FUNCTION  = 0x60
CECKeyCodeEnum.PAUSE_PLAY_FUNCTION  = 0x61
CECKeyCodeEnum.RECORD_FUNCTION  = 0x62
CECKeyCodeEnum.PAUSE_RECORD_FUNCTION  = 0x63
CECKeyCodeEnum.STOP_FUNCTION  = 0x64
CECKeyCodeEnum.MUTE_FUNCTION  = 0x65
CECKeyCodeEnum.RESTORE_VOLUME_FUNCTION  = 0x66
CECKeyCodeEnum.TUNE_FUNCTION  = 0x67
CECKeyCodeEnum.SELECT_MEDIA_FUNCTION  = 0x68
CECKeyCodeEnum.SELECT_AV_INPUT_FUNCTION  = 0x69
CECKeyCodeEnum.SELECT_AUDIO_INPUT_FUNCTION  = 0x6A
CECKeyCodeEnum.POWER_TOGGLE_FUNCTION  = 0x6B
CECKeyCodeEnum.POWER_OFF_FUNCTION  = 0x6C
CECKeyCodeEnum.POWER_ON_FUNCTION  = 0x6D
CECKeyCodeEnum.F1_BLUE  = 0x71
CECKeyCodeEnum.F2_RED  = 0x72
CECKeyCodeEnum.F3_GREEN  = 0x73
CECKeyCodeEnum.F4_YELLOW  = 0x74
CECKeyCodeEnum.F5  = 0x75
CECKeyCodeEnum.DATA  = 0x76

CECKeyCodeEnum.augment_type = function(cls, val)
  setmetatable(val, new_mt)
end

setmetatable(CECKeyCodeEnum, new_mt)

local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.KeypadInput.types.CECKeyCodeEnum")
if has_aliases then
  aliases:add_to_class(CECKeyCodeEnum)
end

return CECKeyCodeEnum
