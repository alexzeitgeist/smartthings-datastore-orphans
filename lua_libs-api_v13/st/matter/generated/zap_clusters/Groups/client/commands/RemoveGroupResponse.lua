...
RemoveGroupResponse.ID = 0x0003
RemoveGroupResponse.field_defs = {
  {
    name = "status",
    field_id = 0,
    is_nullable = false,
...
function RemoveGroupResponse:augment_type(base_type_obj)
  local elems = {}
...
function RemoveGroupResponse:build_test_command_response(device, endpoint_id, status, groupid, interaction_status)
...
---
--- @return nil
function RemoveGroupResponse:init()
  return nil
end
...
function RemoveGroupResponse:deserialize(tlv_buf)
