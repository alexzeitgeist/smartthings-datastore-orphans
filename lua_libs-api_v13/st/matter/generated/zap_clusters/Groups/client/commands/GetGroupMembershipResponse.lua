...
--- @field public group_list st.matter.data_types.Array
local GetGroupMembershipResponse = {}

GetGroupMembershipResponse.NAME = "GetGroupMembershipResponse"
GetGroupMembershipResponse.ID = 0x0002
GetGroupMembershipResponse.field_defs = {
  {
    name = "capacity",
    field_id = 0,
    is_nullable = true,
...
function GetGroupMembershipResponse:augment_type(base_type_obj)
  local elems = {}
...
--- @param group_list st.matter.data_types.Array
--- @return st.matter.st.matter.interaction_model.InteractionResponse of type COMMAND_RESPONSE
function GetGroupMembershipResponse:build_test_command_response(device, endpoint_id, capacity, group_list, interaction_status)
  local function init(self, device, endpoint_id, capacity, group_list)
    local out = {}
  ...
  local self_request =  init(self, device, endpoint_id, capacity, group_list)
...
---
--- @return nil
function GetGroupMembershipResponse:init()
  return nil
end
...
function GetGroupMembershipResponse:deserialize(tlv_buf)
