...
AddGroupResponse.ID = 0x0000
AddGroupResponse.field_defs = {
  {
    name = "status",
    field_id = 0,
    is_nullable = false,
...
function AddGroupResponse:augment_type(base_type_obj)
  local elems = {}
...
function AddGroupResponse:build_test_command_response(device, endpoint_id, status, groupid, interaction_status)
...
---
--- @return nil
function AddGroupResponse:init()
  return nil
end
...
function AddGroupResponse:deserialize(tlv_buf)
