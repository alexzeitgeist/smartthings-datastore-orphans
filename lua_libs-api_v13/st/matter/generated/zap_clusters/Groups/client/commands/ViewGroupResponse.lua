...
--- @field public group_name st.matter.data_types.UTF8String1
local ViewGroupResponse = {}

ViewGroupResponse.NAME = "ViewGroupResponse"
ViewGroupResponse.ID = 0x0001
ViewGroupResponse.field_defs = {
  {
    name = "status",
    field_id = 0,
    is_nullable = false,
...
function ViewGroupResponse:augment_type(base_type_obj)
  local elems = {}
...
--- @param group_name st.matter.data_types.UTF8String1
--- @return st.matter.st.matter.interaction_model.InteractionResponse of type COMMAND_RESPONSE
function ViewGroupResponse:build_test_command_response(device, endpoint_id, status, groupid, group_name, interaction_status)
  local function init(self, device, endpoint_id, status, groupid, group_name)
    local out = {}
    local args = {status, groupid, group_name}
  ...
  local self_request =  init(self, device, endpoint_id, status, groupid, group_name)
...
---
--- @return nil
function ViewGroupResponse:init()
  return nil
end
...
function ViewGroupResponse:deserialize(tlv_buf)
