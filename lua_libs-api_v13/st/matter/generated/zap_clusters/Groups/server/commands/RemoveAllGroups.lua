...
RemoveAllGroups.ID = 0x0004
RemoveAllGroups.field_defs = {
}
...
function RemoveAllGroups:build_test_command_response(device, endpoint_id, status)
...
function RemoveAllGroups:init(device, endpoint_id)
  local out = {}
  local args = {}
...
function RemoveAllGroups:augment_type(base_type_obj)
  local elems = {}
...
function RemoveAllGroups:deserialize(tlv_buf)
