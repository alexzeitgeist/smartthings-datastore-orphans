...
function ViewGroup:init(device, endpoint_id, groupid)
  local out = {}
  local args = {groupid}
...
function ViewGroup:augment_type(base_type_obj)
  local elems = {}
...
function ViewGroup:deserialize(tlv_buf)
