...
AddGroupIfIdentifying.ID = 0x0005
AddGroupIfIdentifying.field_defs = {
  {
    name = "groupid",
    field_id = 0,
    is_nullable = false,
...
function AddGroupIfIdentifying:build_test_command_response(device, endpoint_id, status)
...
function AddGroupIfIdentifying:init(device, endpoint_id, groupid, group_name)
  local out = {}
  local args = {groupid, group_name}
...
function AddGroupIfIdentifying:augment_type(base_type_obj)
  local elems = {}
...
function AddGroupIfIdentifying:deserialize(tlv_buf)
