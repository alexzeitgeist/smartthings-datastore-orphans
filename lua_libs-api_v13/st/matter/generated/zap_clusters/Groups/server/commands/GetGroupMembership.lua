...
GetGroupMembership.ID = 0x0002
GetGroupMembership.field_defs = {
  {
    name = "group_list",
    field_id = 0,
    is_nullable = false,
...
function GetGroupMembership:init(device, endpoint_id, group_list)
  local out = {}
...
function GetGroupMembership:augment_type(base_type_obj)
  local elems = {}
...
function GetGroupMembership:deserialize(tlv_buf)
