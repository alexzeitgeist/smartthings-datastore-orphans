...
RemoveGroup.ID = 0x0003
RemoveGroup.field_defs = {
  {
    name = "groupid",
    field_id = 0,
    is_nullable = false,
...
function RemoveGroup:init(device, endpoint_id, groupid)
  local out = {}
  local args = {groupid}
...
function RemoveGroup:augment_type(base_type_obj)
  local elems = {}
...
function RemoveGroup:deserialize(tlv_buf)
