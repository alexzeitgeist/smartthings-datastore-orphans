...
--- @field public data_type st.matter.generated.zap_clusters.Groups.types.NameSupportBitmap the data type of this attribute

local NameSupport = {
  ID = 0x0000,
  NAME = "NameSupport",
  base_type = require "st.matter.generated.zap_clusters.Groups.types.NameSupportBitmap",
}
...
---
--- @vararg vararg the values needed to construct a NameSupportBitmap
--- @return st.matter.generated.zap_clusters.Groups.types.NameSupportBitmap
...
function NameSupport:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function NameSupport:subscribe(device, endpoint_id)
...
function NameSupport:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function NameSupport:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(NameSupport, {__call = NameSupport.new_value, __index = NameSupport.base_type})
return NameSupport
