...
--- @class st.matter.clusters.NitrogenDioxideConcentrationMeasurement.types.Feature
--- @alias Feature
---
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.NitrogenDioxideConcentrationMeasurement.types.Feature")
if has_aliases then
