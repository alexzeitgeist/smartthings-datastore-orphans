...
-----------------------------------------------------------
-- ScenesManagement command GetSceneMembership
-----------------------------------------------------------
...
GetSceneMembership.ID = 0x0006
GetSceneMembership.field_defs = {
  {
    name = "groupid",
    field_id = 0,
    is_nullable = false,
...
function GetSceneMembership:init(device, endpoint_id, groupid)
  local out = {}
  local args = {groupid}
...
function GetSceneMembership:augment_type(base_type_obj)
  local elems = {}
...
function GetSceneMembership:deserialize(tlv_buf)
