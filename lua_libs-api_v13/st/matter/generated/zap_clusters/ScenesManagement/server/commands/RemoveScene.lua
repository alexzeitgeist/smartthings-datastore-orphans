...
-----------------------------------------------------------
-- ScenesManagement command RemoveScene
-----------------------------------------------------------
...
RemoveScene.ID = 0x0002
RemoveScene.field_defs = {
  {
    name = "groupid",
    field_id = 0,
    is_nullable = false,
...
function RemoveScene:init(device, endpoint_id, groupid, sceneid)
  local out = {}
  local args = {groupid, sceneid}
...
function RemoveScene:augment_type(base_type_obj)
  local elems = {}
...
function RemoveScene:deserialize(tlv_buf)
