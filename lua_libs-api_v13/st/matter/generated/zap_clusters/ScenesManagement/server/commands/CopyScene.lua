...
-----------------------------------------------------------
-- ScenesManagement command CopyScene
-----------------------------------------------------------
...
--- @field public mode st.matter.generated.zap_clusters.ScenesManagement.types.CopyModeBitmap
...
--- @field public group_identifier_to st.matter.data_types.Uint16
--- @field public scene_identifier_to st.matter.data_types.Uint8
local CopyScene = {}

CopyScene.NAME = "CopyScene"
CopyScene.ID = 0x0040
CopyScene.field_defs = {
  {
    name = "mode",
    field_id = 0,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.ScenesManagement.types.CopyModeBitmap",
  },
  {
...
--- @param mode st.matter.generated.zap_clusters.ScenesManagement.types.CopyModeBitmap
--- @param group_identifier_from st.matter.data_types.Uint16
--- @param scene_identifier_from st.matter.data_types.Uint8
--- @param group_identifier_to st.matter.data_types.Uint16
--- @param scene_identifier_to st.matter.data_types.Uint8

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function CopyScene:init(device, endpoint_id, mode, group_identifier_from, scene_identifier_from, group_identifier_to, scene_identifier_to)
  local out = {}
...
function CopyScene:augment_type(base_type_obj)
  local elems = {}
...
function CopyScene:deserialize(tlv_buf)
