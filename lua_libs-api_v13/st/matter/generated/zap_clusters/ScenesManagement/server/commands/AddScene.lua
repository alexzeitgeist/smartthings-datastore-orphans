...
-----------------------------------------------------------
-- ScenesManagement command AddScene
-----------------------------------------------------------
...
function AddScene:init(device, endpoint_id, groupid, sceneid, transition_time, scene_name, extension_field_sets)
  local out = {}
  local args = {groupid, sceneid, transition_time, scene_name, extension_field_sets}
...
function AddScene:augment_type(base_type_obj)
  local elems = {}
...
function AddScene:deserialize(tlv_buf)
