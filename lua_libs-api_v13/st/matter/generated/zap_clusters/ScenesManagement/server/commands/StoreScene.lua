...
-----------------------------------------------------------
-- ScenesManagement command StoreScene
-----------------------------------------------------------
...
StoreScene.ID = 0x0004
StoreScene.field_defs = {
  {
    name = "groupid",
    field_id = 0,
    is_nullable = false,
...
function StoreScene:init(device, endpoint_id, groupid, sceneid)
  local out = {}
...
function StoreScene:augment_type(base_type_obj)
  local elems = {}
...
function StoreScene:deserialize(tlv_buf)
