...
-----------------------------------------------------------
-- ScenesManagement command RecallScene
-----------------------------------------------------------
...
RecallScene.ID = 0x0005
RecallScene.field_defs = {
  {
    name = "groupid",
    field_id = 0,
    is_nullable = false,
...
function RecallScene:build_test_command_response(device, endpoint_id, status)
...
function RecallScene:init(device, endpoint_id, groupid, sceneid, transition_time)
  local out = {}
  local args = {groupid, sceneid, transition_time}
...
function RecallScene:augment_type(base_type_obj)
  local elems = {}
...
function RecallScene:deserialize(tlv_buf)
