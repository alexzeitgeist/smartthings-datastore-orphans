...
-----------------------------------------------------------
-- ScenesManagement command RemoveAllScenes
-----------------------------------------------------------
...
RemoveAllScenes.ID = 0x0003
RemoveAllScenes.field_defs = {
  {
    name = "groupid",
    field_id = 0,
    is_nullable = false,
...
function RemoveAllScenes:init(device, endpoint_id, groupid)
  local out = {}
  local args = {groupid}
...
function RemoveAllScenes:augment_type(base_type_obj)
  local elems = {}
...
function RemoveAllScenes:deserialize(tlv_buf)
