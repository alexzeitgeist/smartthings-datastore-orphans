...
-----------------------------------------------------------
-- ScenesManagement command ViewScene
-----------------------------------------------------------
...
function ViewScene:init(device, endpoint_id, groupid, sceneid)
  local out = {}
...
function ViewScene:augment_type(base_type_obj)
  local elems = {}
...
function ViewScene:deserialize(tlv_buf)
