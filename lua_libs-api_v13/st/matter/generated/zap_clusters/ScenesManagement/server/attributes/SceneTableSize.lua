...
function SceneTableSize:new_value(...)
...
function SceneTableSize:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function SceneTableSize:subscribe(device, endpoint_id)
...
function SceneTableSize:set_parent_cluster(cluster)
...
function SceneTableSize:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function SceneTableSize:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(SceneTableSize, {__call = SceneTableSize.new_value, __index = SceneTableSize.base_type})
