...
function FabricSceneInfo:new_value(...)
...
function FabricSceneInfo:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function FabricSceneInfo:subscribe(device, endpoint_id)
...
function FabricSceneInfo:set_parent_cluster(cluster)
...
function FabricSceneInfo:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function FabricSceneInfo:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(FabricSceneInfo, {__call = FabricSceneInfo.new_value, __index = FabricSceneInfo.base_type})
