...
function LastConfiguredBy:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function LastConfiguredBy:subscribe(device, endpoint_id)
...
function LastConfiguredBy:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function LastConfiguredBy:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(LastConfiguredBy, {__call = LastConfiguredBy.new_value, __index = LastConfiguredBy.base_type})
