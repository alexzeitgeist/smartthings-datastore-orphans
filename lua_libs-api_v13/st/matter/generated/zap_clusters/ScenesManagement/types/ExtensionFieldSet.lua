...
--- @alias ExtensionFieldSet
--- @class st.matter.clusters.ScenesManagement.types.ExtensionFieldSet: st.matter.data_types.Structure
---
--- @field public cluster_id st.matter.data_types.Uint32
--- @field public attribute_value_list st.matter.data_types.Array
local ExtensionFieldSet = {}
local new_mt = StructureABC.new_mt({NAME = "ExtensionFieldSet", ID = data_types.name_to_id_map["Structure"]})

ExtensionFieldSet.field_defs = {
  {
    name = "cluster_id",
    field_id = 0,
    is_nullable = false,
  ...
  },
  {
    ...
    element_type = require "st.matter.generated.zap_clusters.ScenesManagement.types.AttributeValuePairStruct",
  },
}

ExtensionFieldSet.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
ExtensionFieldSet.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = ExtensionFieldSet.init
new_mt.__index.serialize = ExtensionFieldSet.serialize

ExtensionFieldSet.augment_type = function(self, val)
  local elems = {}
...
setmetatable(ExtensionFieldSet, new_mt)
