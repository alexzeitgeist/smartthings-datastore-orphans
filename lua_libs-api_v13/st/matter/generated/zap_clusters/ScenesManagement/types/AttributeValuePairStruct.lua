...
--- @alias AttributeValuePairStruct
--- @class st.matter.clusters.ScenesManagement.types.AttributeValuePairStruct: st.matter.data_types.Structure
---
--- @field public attribute_id st.matter.data_types.Uint32
--- @field public value_unsigned8 st.matter.data_types.Uint8
--- @field public value_signed8 st.matter.data_types.Int8
--- @field public value_unsigned16 st.matter.data_types.Uint16
--- @field public value_signed16 st.matter.data_types.Int16
--- @field public value_unsigned32 st.matter.data_types.Uint32
--- @field public value_signed32 st.matter.data_types.Int32
--- @field public value_unsigned64 st.matter.data_types.Uint64
--- @field public value_signed64 st.matter.data_types.Int64
local AttributeValuePairStruct = {}
local new_mt = StructureABC.new_mt({NAME = "AttributeValuePairStruct", ID = data_types.name_to_id_map["Structure"]})

AttributeValuePairStruct.field_defs = {
  {
    name = "attribute_id",
    field_id = 0,
    is_nullable = false,
  ...
  },
  {
    ...
    is_nullable = false,
    is_optional = true,
    data_type = require "st.matter.data_types.Int8",
  },
  {
    name = "value_unsigned16",
    field_id = 3,
    is_nullable = false,
    is_optional = true,
  ...
  },
  {
    ...
    is_nullable = false,
    is_optional = true,
    data_type = require "st.matter.data_types.Int32",
  },
  {
    name = "value_unsigned64",
    field_id = 7,
    is_nullable = false,
    is_optional = true,
...
AttributeValuePairStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
AttributeValuePairStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = AttributeValuePairStruct.init
new_mt.__index.serialize = AttributeValuePairStruct.serialize

AttributeValuePairStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(AttributeValuePairStruct, new_mt)

return AttributeValuePairStruct
