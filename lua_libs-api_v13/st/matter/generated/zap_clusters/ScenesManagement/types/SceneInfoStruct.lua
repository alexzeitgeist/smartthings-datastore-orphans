...
--- @alias SceneInfoStruct
--- @class st.matter.clusters.ScenesManagement.types.SceneInfoStruct: st.matter.data_types.Structure
---
--- @field public scene_count st.matter.data_types.Uint8
--- @field public current_scene st.matter.data_types.Uint8
--- @field public current_group st.matter.data_types.Uint16
--- @field public scene_valid st.matter.data_types.Boolean
--- @field public remaining_capacity st.matter.data_types.Uint8
--- @field public fabric_index st.matter.data_types.Uint8
local SceneInfoStruct = {}
local new_mt = StructureABC.new_mt({NAME = "SceneInfoStruct", ID = data_types.name_to_id_map["Structure"]})

SceneInfoStruct.field_defs = {
  {
    name = "scene_count",
    field_id = 0,
    is_nullable = false,
...
SceneInfoStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
SceneInfoStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = SceneInfoStruct.init
new_mt.__index.serialize = SceneInfoStruct.serialize

SceneInfoStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(SceneInfoStruct, new_mt)
