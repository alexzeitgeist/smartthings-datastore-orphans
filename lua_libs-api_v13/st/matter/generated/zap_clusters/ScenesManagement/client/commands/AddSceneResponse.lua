...
-----------------------------------------------------------
-- ScenesManagement command AddSceneResponse
-----------------------------------------------------------
...
AddSceneResponse.ID = 0x0000
AddSceneResponse.field_defs = {
  {
    name = "status",
    field_id = 0,
    is_nullable = false,
...
function AddSceneResponse:augment_type(base_type_obj)
  local elems = {}
...
function AddSceneResponse:build_test_command_response(device, endpoint_id, status, groupid, sceneid, interaction_status)
...
---
--- @return nil
function AddSceneResponse:init()
  return nil
end
...
function AddSceneResponse:deserialize(tlv_buf)
