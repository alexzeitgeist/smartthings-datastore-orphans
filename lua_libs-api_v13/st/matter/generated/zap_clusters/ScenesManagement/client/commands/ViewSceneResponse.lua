...
-----------------------------------------------------------
-- ScenesManagement command ViewSceneResponse
-----------------------------------------------------------
...
--- @field public transition_time st.matter.data_types.Uint32
--- @field public scene_name st.matter.data_types.UTF8String1
--- @field public extension_field_sets st.matter.data_types.Array
local ViewSceneResponse = {}

ViewSceneResponse.NAME = "ViewSceneResponse"
ViewSceneResponse.ID = 0x0001
ViewSceneResponse.field_defs = {
  {
    name = "status",
    field_id = 0,
    is_nullable = false,
  ...
  },
  {
    ...
    element_type = require "st.matter.generated.zap_clusters.ScenesManagement.types.ExtensionFieldSet",
  },
}
...
function ViewSceneResponse:augment_type(base_type_obj)
  local elems = {}
...
--- @param transition_time st.matter.data_types.Uint32
--- @param scene_name st.matter.data_types.UTF8String1
--- @param extension_field_sets st.matter.data_types.Array
--- @return st.matter.st.matter.interaction_model.InteractionResponse of type COMMAND_RESPONSE
function ViewSceneResponse:build_test_command_response(device, endpoint_id, status, groupid, sceneid, transition_time, scene_name, extension_field_sets, interaction_status)
  local function init(self, device, endpoint_id, status, groupid, sceneid, transition_time, scene_name, extension_field_sets)
    local out = {}
    local args = {status, groupid, sceneid, transition_time, scene_name, extension_field_sets}
  ...
  local self_request =  init(self, device, endpoint_id, status, groupid, sceneid, transition_time, scene_name, extension_field_sets)
...
---
--- @return nil
function ViewSceneResponse:init()
  return nil
end
...
function ViewSceneResponse:deserialize(tlv_buf)
