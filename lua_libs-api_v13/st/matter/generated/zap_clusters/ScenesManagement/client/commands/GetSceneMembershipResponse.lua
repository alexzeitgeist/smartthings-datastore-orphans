...
-----------------------------------------------------------
-- ScenesManagement command GetSceneMembershipResponse
-----------------------------------------------------------
...
--- @field public capacity st.matter.data_types.Uint8
--- @field public groupid st.matter.data_types.Uint16
--- @field public scene_list st.matter.data_types.Array
local GetSceneMembershipResponse = {}

GetSceneMembershipResponse.NAME = "GetSceneMembershipResponse"
GetSceneMembershipResponse.ID = 0x0006
GetSceneMembershipResponse.field_defs = {
  {
    name = "status",
    field_id = 0,
    is_nullable = false,
  ...
  },
  {
    ...
    element_type = require "st.matter.data_types.Uint8",
  },
}
...
function GetSceneMembershipResponse:augment_type(base_type_obj)
  local elems = {}
...
--- @param capacity st.matter.data_types.Uint8
--- @param groupid st.matter.data_types.Uint16
--- @param scene_list st.matter.data_types.Array
--- @return st.matter.st.matter.interaction_model.InteractionResponse of type COMMAND_RESPONSE
function GetSceneMembershipResponse:build_test_command_response(device, endpoint_id, status, capacity, groupid, scene_list, interaction_status)
  local function init(self, device, endpoint_id, status, capacity, groupid, scene_list)
    local out = {}
    local args = {status, capacity, groupid, scene_list}
  ...
  local self_request =  init(self, device, endpoint_id, status, capacity, groupid, scene_list)
...
---
--- @return nil
function GetSceneMembershipResponse:init()
  return nil
end
...
function GetSceneMembershipResponse:deserialize(tlv_buf)
