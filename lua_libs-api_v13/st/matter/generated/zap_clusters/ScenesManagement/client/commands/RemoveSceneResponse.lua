...
-----------------------------------------------------------
-- ScenesManagement command RemoveSceneResponse
-----------------------------------------------------------
...
RemoveSceneResponse.ID = 0x0002
RemoveSceneResponse.field_defs = {
  {
    name = "status",
    field_id = 0,
    is_nullable = false,
...
function RemoveSceneResponse:augment_type(base_type_obj)
  local elems = {}
...
function RemoveSceneResponse:build_test_command_response(device, endpoint_id, status, groupid, sceneid, interaction_status)
...
---
--- @return nil
function RemoveSceneResponse:init()
  return nil
end
...
function RemoveSceneResponse:deserialize(tlv_buf)
