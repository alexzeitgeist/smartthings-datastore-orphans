...
-----------------------------------------------------------
-- ScenesManagement command RemoveAllScenesResponse
-----------------------------------------------------------
...
RemoveAllScenesResponse.ID = 0x0003
RemoveAllScenesResponse.field_defs = {
  {
    name = "status",
    field_id = 0,
    is_nullable = false,
...
function RemoveAllScenesResponse:augment_type(base_type_obj)
  local elems = {}
...
function RemoveAllScenesResponse:build_test_command_response(device, endpoint_id, status, groupid, interaction_status)
  local function init(self, device, endpoint_id, status, groupid)
    local out = {}
    local args = {status, groupid}
  ...
  local self_request =  init(self, device, endpoint_id, status, groupid)
...
---
--- @return nil
function RemoveAllScenesResponse:init()
  return nil
end
...
function RemoveAllScenesResponse:deserialize(tlv_buf)
