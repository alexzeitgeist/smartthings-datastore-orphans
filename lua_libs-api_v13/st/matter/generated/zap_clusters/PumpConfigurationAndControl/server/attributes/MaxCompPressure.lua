...
--- @class st.matter.clusters.PumpConfigurationAndControl.MaxCompPressure
...
function MaxCompPressure:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function MaxCompPressure:subscribe(device, endpoint_id)
...
function MaxCompPressure:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MaxCompPressure:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(MaxCompPressure, {__call = MaxCompPressure.new_value, __index = MaxCompPressure.base_type})
