...
--- @class st.matter.clusters.PumpConfigurationAndControl.MaxFlow
--- @alias MaxFlow
---
...
function MaxFlow:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function MaxFlow:subscribe(device, endpoint_id)
...
function MaxFlow:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MaxFlow:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(MaxFlow, {__call = MaxFlow.new_value, __index = MaxFlow.base_type})
return MaxFlow
