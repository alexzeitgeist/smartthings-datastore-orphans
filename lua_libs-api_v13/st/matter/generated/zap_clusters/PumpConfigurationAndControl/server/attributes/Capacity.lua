...
--- @class st.matter.clusters.PumpConfigurationAndControl.Capacity
--- @alias Capacity
---
...
function Capacity:read(device, endpoint_id)
...
--- Reporting policy: Capacity => true => suggested
...
--- @param endpoint_id number|nil
--- @return any
function Capacity:subscribe(device, endpoint_id)
...
function Capacity:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Capacity:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(Capacity, {__call = Capacity.new_value, __index = Capacity.base_type})
return Capacity
