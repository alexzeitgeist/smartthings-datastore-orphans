...
--- @class st.matter.clusters.PumpConfigurationAndControl.MinConstFlow
--- @alias MinConstFlow
---
...
function MinConstFlow:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function MinConstFlow:subscribe(device, endpoint_id)
...
function MinConstFlow:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MinConstFlow:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(MinConstFlow, {__call = MinConstFlow.new_value, __index = MinConstFlow.base_type})
return MinConstFlow
