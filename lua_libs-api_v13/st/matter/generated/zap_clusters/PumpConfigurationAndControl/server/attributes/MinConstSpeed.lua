...
--- @class st.matter.clusters.PumpConfigurationAndControl.MinConstSpeed
--- @alias MinConstSpeed
---
...
function MinConstSpeed:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function MinConstSpeed:subscribe(device, endpoint_id)
...
function MinConstSpeed:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MinConstSpeed:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(MinConstSpeed, {__call = MinConstSpeed.new_value, __index = MinConstSpeed.base_type})
