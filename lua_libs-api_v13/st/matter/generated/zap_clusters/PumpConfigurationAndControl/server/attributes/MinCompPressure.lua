...
--- @class st.matter.clusters.PumpConfigurationAndControl.MinCompPressure
...
function MinCompPressure:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function MinCompPressure:subscribe(device, endpoint_id)
...
function MinCompPressure:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MinCompPressure:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(MinCompPressure, {__call = MinCompPressure.new_value, __index = MinCompPressure.base_type})
