...
--- @class st.matter.clusters.PumpConfigurationAndControl.LifetimeRunningHours
...
function LifetimeRunningHours:read(device, endpoint_id)
...
function LifetimeRunningHours:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function LifetimeRunningHours:subscribe(device, endpoint_id)
...
function LifetimeRunningHours:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function LifetimeRunningHours:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(LifetimeRunningHours, {__call = LifetimeRunningHours.new_value, __index = LifetimeRunningHours.base_type})
