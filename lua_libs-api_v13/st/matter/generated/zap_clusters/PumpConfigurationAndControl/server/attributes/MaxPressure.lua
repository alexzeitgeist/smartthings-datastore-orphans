...
--- @class st.matter.clusters.PumpConfigurationAndControl.MaxPressure
--- @alias MaxPressure
---
...
function MaxPressure:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function MaxPressure:subscribe(device, endpoint_id)
...
function MaxPressure:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MaxPressure:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(MaxPressure, {__call = MaxPressure.new_value, __index = MaxPressure.base_type})
return MaxPressure
