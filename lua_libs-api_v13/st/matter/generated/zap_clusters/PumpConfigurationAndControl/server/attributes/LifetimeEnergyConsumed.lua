...
--- @class st.matter.clusters.PumpConfigurationAndControl.LifetimeEnergyConsumed
...
function LifetimeEnergyConsumed:read(device, endpoint_id)
...
function LifetimeEnergyConsumed:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function LifetimeEnergyConsumed:subscribe(device, endpoint_id)
...
function LifetimeEnergyConsumed:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function LifetimeEnergyConsumed:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(LifetimeEnergyConsumed, {__call = LifetimeEnergyConsumed.new_value, __index = LifetimeEnergyConsumed.base_type})
