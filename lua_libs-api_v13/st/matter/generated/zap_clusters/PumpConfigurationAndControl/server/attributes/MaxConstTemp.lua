...
--- @class st.matter.clusters.PumpConfigurationAndControl.MaxConstTemp
--- @alias MaxConstTemp
---
...
function MaxConstTemp:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function MaxConstTemp:subscribe(device, endpoint_id)
...
function MaxConstTemp:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MaxConstTemp:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(MaxConstTemp, {__call = MaxConstTemp.new_value, __index = MaxConstTemp.base_type})
return MaxConstTemp
