...
--- @class st.matter.clusters.PumpConfigurationAndControl.MaxSpeed
--- @alias MaxSpeed
---
...
function MaxSpeed:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function MaxSpeed:subscribe(device, endpoint_id)
...
function MaxSpeed:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MaxSpeed:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(MaxSpeed, {__call = MaxSpeed.new_value, __index = MaxSpeed.base_type})
return MaxSpeed
