...
--- @class st.matter.clusters.PumpConfigurationAndControl.MaxConstPressure
...
function MaxConstPressure:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function MaxConstPressure:subscribe(device, endpoint_id)
...
function MaxConstPressure:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MaxConstPressure:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(MaxConstPressure, {__call = MaxConstPressure.new_value, __index = MaxConstPressure.base_type})
