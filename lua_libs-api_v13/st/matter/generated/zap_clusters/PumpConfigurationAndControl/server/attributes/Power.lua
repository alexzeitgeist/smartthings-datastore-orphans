...
--- @class st.matter.clusters.PumpConfigurationAndControl.Power
--- @alias Power
---
...
function Power:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Power:subscribe(device, endpoint_id)
...
function Power:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Power:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(Power, {__call = Power.new_value, __index = Power.base_type})
return Power
