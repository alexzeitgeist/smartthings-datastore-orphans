...
--- @class st.matter.clusters.PumpConfigurationAndControl.ControlMode
--- @alias ControlMode
---
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.generated.zap_clusters.PumpConfigurationAndControl.types.ControlModeEnum the value to write
