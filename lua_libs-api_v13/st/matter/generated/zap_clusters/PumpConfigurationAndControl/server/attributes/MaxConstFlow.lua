...
--- @class st.matter.clusters.PumpConfigurationAndControl.MaxConstFlow
--- @alias MaxConstFlow
---
...
function MaxConstFlow:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function MaxConstFlow:subscribe(device, endpoint_id)
...
function MaxConstFlow:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MaxConstFlow:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(MaxConstFlow, {__call = MaxConstFlow.new_value, __index = MaxConstFlow.base_type})
return MaxConstFlow
