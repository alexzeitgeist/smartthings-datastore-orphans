...
--- @class st.matter.clusters.PumpConfigurationAndControl.PumpStatus
--- @alias PumpStatus
---
--- @field public ID number 0x0010 the ID of this attribute
--- @field public NAME string "PumpStatus" the name of this attribute
--- @field public data_type st.matter.generated.zap_clusters.PumpConfigurationAndControl.types.PumpStatusBitmap the data type of this attribute

local PumpStatus = {
  ID = 0x0010,
  NAME = "PumpStatus",
  base_type = require "st.matter.generated.zap_clusters.PumpConfigurationAndControl.types.PumpStatusBitmap",
}
...
---
--- @vararg vararg the values needed to construct a PumpStatusBitmap
--- @return st.matter.generated.zap_clusters.PumpConfigurationAndControl.types.PumpStatusBitmap
...
--- Reporting policy: PumpStatus => true => suggested
