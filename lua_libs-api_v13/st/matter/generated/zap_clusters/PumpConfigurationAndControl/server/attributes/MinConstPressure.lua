...
--- @class st.matter.clusters.PumpConfigurationAndControl.MinConstPressure
...
function MinConstPressure:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function MinConstPressure:subscribe(device, endpoint_id)
...
function MinConstPressure:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MinConstPressure:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(MinConstPressure, {__call = MinConstPressure.new_value, __index = MinConstPressure.base_type})
