...
--- @class st.matter.clusters.PumpConfigurationAndControl.MinConstTemp
--- @alias MinConstTemp
---
...
function MinConstTemp:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function MinConstTemp:subscribe(device, endpoint_id)
...
function MinConstTemp:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MinConstTemp:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(MinConstTemp, {__call = MinConstTemp.new_value, __index = MinConstTemp.base_type})
return MinConstTemp
