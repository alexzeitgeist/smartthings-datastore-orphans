...
--- @class st.matter.clusters.PumpConfigurationAndControl.MaxConstSpeed
--- @alias MaxConstSpeed
---
...
function MaxConstSpeed:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function MaxConstSpeed:subscribe(device, endpoint_id)
...
function MaxConstSpeed:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MaxConstSpeed:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(MaxConstSpeed, {__call = MaxConstSpeed.new_value, __index = MaxConstSpeed.base_type})
