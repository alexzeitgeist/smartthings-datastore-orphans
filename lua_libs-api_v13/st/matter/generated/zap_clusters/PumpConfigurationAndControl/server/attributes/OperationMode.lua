...
--- @class st.matter.clusters.PumpConfigurationAndControl.OperationMode
--- @alias OperationMode
---
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.generated.zap_clusters.PumpConfigurationAndControl.types.OperationModeEnum the value to write
