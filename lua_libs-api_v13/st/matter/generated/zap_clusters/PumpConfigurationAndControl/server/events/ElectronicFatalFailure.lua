...
--- @class st.matter.clusters.PumpConfigurationAndControl.ElectronicFatalFailure
--- @alias ElectronicFatalFailure
---
--- @field public ID number 0x000C the ID of this event
--- @field public NAME string "ElectronicFatalFailure" the name of this event
local ElectronicFatalFailure = {
  ID = 0x000C,
  NAME = "ElectronicFatalFailure",
  base_type = data_types.Structure,
}

ElectronicFatalFailure.field_defs = {
}
--- Add field names to each event field
---
--- @param base_type_obj st.matter.data_types.Structure
function ElectronicFatalFailure:augment_type(base_type_obj)
  local elems = {}
...
function ElectronicFatalFailure:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function ElectronicFatalFailure:subscribe(device, endpoint_id)
...
function ElectronicFatalFailure:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "ElectronicFatalFailureEventData", ID = 0x15}))
...
function ElectronicFatalFailure:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function ElectronicFatalFailure:set_parent_cluster(cluster)
