...
--- @class st.matter.clusters.PumpConfigurationAndControl.GeneralFault
--- @alias GeneralFault
---
--- @field public ID number 0x000D the ID of this event
--- @field public NAME string "GeneralFault" the name of this event
local GeneralFault = {
  ID = 0x000D,
  NAME = "GeneralFault",
...
function GeneralFault:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function GeneralFault:subscribe(device, endpoint_id)
...
function GeneralFault:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "GeneralFaultEventData", ID = 0x15}))
...
function GeneralFault:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function GeneralFault:set_parent_cluster(cluster)
