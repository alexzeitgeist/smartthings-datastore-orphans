...
--- @class st.matter.clusters.PumpConfigurationAndControl.SystemPressureHigh
--- @alias SystemPressureHigh
---
--- @field public ID number 0x0004 the ID of this event
--- @field public NAME string "SystemPressureHigh" the name of this event
local SystemPressureHigh = {
  ID = 0x0004,
  NAME = "SystemPressureHigh",
  base_type = data_types.Structure,
}

SystemPressureHigh.field_defs = {
}
--- Add field names to each event field
---
--- @param base_type_obj st.matter.data_types.Structure
function SystemPressureHigh:augment_type(base_type_obj)
  local elems = {}
...
function SystemPressureHigh:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function SystemPressureHigh:subscribe(device, endpoint_id)
...
function SystemPressureHigh:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "SystemPressureHighEventData", ID = 0x15}))
...
function SystemPressureHigh:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function SystemPressureHigh:set_parent_cluster(cluster)
