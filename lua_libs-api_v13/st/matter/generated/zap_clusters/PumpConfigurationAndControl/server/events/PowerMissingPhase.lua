...
--- @class st.matter.clusters.PumpConfigurationAndControl.PowerMissingPhase
--- @alias PowerMissingPhase
---
--- @field public ID number 0x0002 the ID of this event
--- @field public NAME string "PowerMissingPhase" the name of this event
local PowerMissingPhase = {
  ID = 0x0002,
  NAME = "PowerMissingPhase",
  base_type = data_types.Structure,
}

PowerMissingPhase.field_defs = {
}
--- Add field names to each event field
---
--- @param base_type_obj st.matter.data_types.Structure
function PowerMissingPhase:augment_type(base_type_obj)
  local elems = {}
...
function PowerMissingPhase:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function PowerMissingPhase:subscribe(device, endpoint_id)
...
function PowerMissingPhase:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "PowerMissingPhaseEventData", ID = 0x15}))
...
function PowerMissingPhase:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function PowerMissingPhase:set_parent_cluster(cluster)
