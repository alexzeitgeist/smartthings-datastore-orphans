...
--- @class st.matter.clusters.PumpConfigurationAndControl.TurbineOperation
--- @alias TurbineOperation
---
--- @field public ID number 0x0010 the ID of this event
--- @field public NAME string "TurbineOperation" the name of this event
local TurbineOperation = {
  ID = 0x0010,
  NAME = "TurbineOperation",
  base_type = data_types.Structure,
}

TurbineOperation.field_defs = {
}
--- Add field names to each event field
---
--- @param base_type_obj st.matter.data_types.Structure
function TurbineOperation:augment_type(base_type_obj)
  local elems = {}
...
function TurbineOperation:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function TurbineOperation:subscribe(device, endpoint_id)
...
function TurbineOperation:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "TurbineOperationEventData", ID = 0x15}))
...
function TurbineOperation:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function TurbineOperation:set_parent_cluster(cluster)
