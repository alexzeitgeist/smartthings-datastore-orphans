...
--- @class st.matter.clusters.PumpConfigurationAndControl.Leakage
--- @alias Leakage
---
--- @field public ID number 0x000E the ID of this event
--- @field public NAME string "Leakage" the name of this event
local Leakage = {
  ID = 0x000E,
  NAME = "Leakage",
...
function Leakage:augment_type(base_type_obj)
  local elems = {}
...
function Leakage:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function Leakage:subscribe(device, endpoint_id)
...
function Leakage:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "LeakageEventData", ID = 0x15}))
...
function Leakage:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function Leakage:set_parent_cluster(cluster)
