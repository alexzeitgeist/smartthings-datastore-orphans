...
--- @class st.matter.clusters.PumpConfigurationAndControl.PumpMotorFatalFailure
--- @alias PumpMotorFatalFailure
---
--- @field public ID number 0x0007 the ID of this event
--- @field public NAME string "PumpMotorFatalFailure" the name of this event
local PumpMotorFatalFailure = {
  ID = 0x0007,
  NAME = "PumpMotorFatalFailure",
  base_type = data_types.Structure,
}

PumpMotorFatalFailure.field_defs = {
}
--- Add field names to each event field
---
--- @param base_type_obj st.matter.data_types.Structure
function PumpMotorFatalFailure:augment_type(base_type_obj)
  local elems = {}
...
function PumpMotorFatalFailure:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function PumpMotorFatalFailure:subscribe(device, endpoint_id)
...
function PumpMotorFatalFailure:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "PumpMotorFatalFailureEventData", ID = 0x15}))
...
function PumpMotorFatalFailure:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function PumpMotorFatalFailure:set_parent_cluster(cluster)
