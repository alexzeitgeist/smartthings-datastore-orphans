...
--- @class st.matter.clusters.PumpConfigurationAndControl.DryRunning
--- @alias DryRunning
---
--- @field public ID number 0x0005 the ID of this event
--- @field public NAME string "DryRunning" the name of this event
local DryRunning = {
  ID = 0x0005,
  NAME = "DryRunning",
...
function DryRunning:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function DryRunning:subscribe(device, endpoint_id)
...
function DryRunning:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "DryRunningEventData", ID = 0x15}))
...
function DryRunning:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function DryRunning:set_parent_cluster(cluster)
