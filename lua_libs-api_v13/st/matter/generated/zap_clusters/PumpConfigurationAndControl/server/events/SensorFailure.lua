...
--- @class st.matter.clusters.PumpConfigurationAndControl.SensorFailure
--- @alias SensorFailure
---
--- @field public ID number 0x000A the ID of this event
--- @field public NAME string "SensorFailure" the name of this event
local SensorFailure = {
  ID = 0x000A,
  NAME = "SensorFailure",
...
function SensorFailure:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function SensorFailure:subscribe(device, endpoint_id)
...
function SensorFailure:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "SensorFailureEventData", ID = 0x15}))
...
function SensorFailure:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function SensorFailure:set_parent_cluster(cluster)
