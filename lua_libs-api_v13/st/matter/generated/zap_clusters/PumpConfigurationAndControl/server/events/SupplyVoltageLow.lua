...
--- @class st.matter.clusters.PumpConfigurationAndControl.SupplyVoltageLow
--- @alias SupplyVoltageLow
---
--- @field public ID number 0x0000 the ID of this event
--- @field public NAME string "SupplyVoltageLow" the name of this event
local SupplyVoltageLow = {
  ID = 0x0000,
  NAME = "SupplyVoltageLow",
  base_type = data_types.Structure,
}

SupplyVoltageLow.field_defs = {
}
--- Add field names to each event field
---
--- @param base_type_obj st.matter.data_types.Structure
function SupplyVoltageLow:augment_type(base_type_obj)
  local elems = {}
...
function SupplyVoltageLow:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function SupplyVoltageLow:subscribe(device, endpoint_id)
...
function SupplyVoltageLow:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "SupplyVoltageLowEventData", ID = 0x15}))
...
function SupplyVoltageLow:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function SupplyVoltageLow:set_parent_cluster(cluster)
