...
--- @class st.matter.clusters.PumpConfigurationAndControl.PumpBlocked
--- @alias PumpBlocked
---
--- @field public ID number 0x0009 the ID of this event
--- @field public NAME string "PumpBlocked" the name of this event
local PumpBlocked = {
  ID = 0x0009,
  NAME = "PumpBlocked",
...
function PumpBlocked:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function PumpBlocked:subscribe(device, endpoint_id)
...
function PumpBlocked:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "PumpBlockedEventData", ID = 0x15}))
...
function PumpBlocked:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function PumpBlocked:set_parent_cluster(cluster)
