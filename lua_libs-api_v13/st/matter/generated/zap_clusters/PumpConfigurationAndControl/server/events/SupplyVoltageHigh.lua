...
--- @class st.matter.clusters.PumpConfigurationAndControl.SupplyVoltageHigh
--- @alias SupplyVoltageHigh
---
--- @field public ID number 0x0001 the ID of this event
--- @field public NAME string "SupplyVoltageHigh" the name of this event
local SupplyVoltageHigh = {
  ID = 0x0001,
  NAME = "SupplyVoltageHigh",
  base_type = data_types.Structure,
}

SupplyVoltageHigh.field_defs = {
}
--- Add field names to each event field
---
--- @param base_type_obj st.matter.data_types.Structure
function SupplyVoltageHigh:augment_type(base_type_obj)
  local elems = {}
...
function SupplyVoltageHigh:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function SupplyVoltageHigh:subscribe(device, endpoint_id)
...
function SupplyVoltageHigh:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "SupplyVoltageHighEventData", ID = 0x15}))
...
function SupplyVoltageHigh:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function SupplyVoltageHigh:set_parent_cluster(cluster)
