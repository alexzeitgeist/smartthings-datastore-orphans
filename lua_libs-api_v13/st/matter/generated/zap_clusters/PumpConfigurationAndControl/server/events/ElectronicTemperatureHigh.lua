...
--- @class st.matter.clusters.PumpConfigurationAndControl.ElectronicTemperatureHigh
--- @alias ElectronicTemperatureHigh
---
--- @field public ID number 0x0008 the ID of this event
--- @field public NAME string "ElectronicTemperatureHigh" the name of this event
local ElectronicTemperatureHigh = {
  ID = 0x0008,
  NAME = "ElectronicTemperatureHigh",
  base_type = data_types.Structure,
}

ElectronicTemperatureHigh.field_defs = {
}
--- Add field names to each event field
---
--- @param base_type_obj st.matter.data_types.Structure
function ElectronicTemperatureHigh:augment_type(base_type_obj)
  local elems = {}
...
function ElectronicTemperatureHigh:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function ElectronicTemperatureHigh:subscribe(device, endpoint_id)
...
function ElectronicTemperatureHigh:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "ElectronicTemperatureHighEventData", ID = 0x15}))
...
function ElectronicTemperatureHigh:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function ElectronicTemperatureHigh:set_parent_cluster(cluster)
