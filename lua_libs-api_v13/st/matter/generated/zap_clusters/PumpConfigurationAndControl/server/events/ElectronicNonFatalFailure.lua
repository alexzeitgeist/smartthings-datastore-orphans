...
--- @class st.matter.clusters.PumpConfigurationAndControl.ElectronicNonFatalFailure
--- @alias ElectronicNonFatalFailure
---
--- @field public ID number 0x000B the ID of this event
--- @field public NAME string "ElectronicNonFatalFailure" the name of this event
local ElectronicNonFatalFailure = {
  ID = 0x000B,
  NAME = "ElectronicNonFatalFailure",
  base_type = data_types.Structure,
}

ElectronicNonFatalFailure.field_defs = {
}
--- Add field names to each event field
---
--- @param base_type_obj st.matter.data_types.Structure
function ElectronicNonFatalFailure:augment_type(base_type_obj)
  local elems = {}
...
function ElectronicNonFatalFailure:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function ElectronicNonFatalFailure:subscribe(device, endpoint_id)
...
function ElectronicNonFatalFailure:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "ElectronicNonFatalFailureEventData", ID = 0x15}))
...
function ElectronicNonFatalFailure:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function ElectronicNonFatalFailure:set_parent_cluster(cluster)
