...
--- @class st.matter.clusters.PumpConfigurationAndControl.AirDetection
--- @alias AirDetection
---
--- @field public ID number 0x000F the ID of this event
--- @field public NAME string "AirDetection" the name of this event
local AirDetection = {
  ID = 0x000F,
  NAME = "AirDetection",
...
function AirDetection:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function AirDetection:subscribe(device, endpoint_id)
...
function AirDetection:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "AirDetectionEventData", ID = 0x15}))
...
function AirDetection:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function AirDetection:set_parent_cluster(cluster)
