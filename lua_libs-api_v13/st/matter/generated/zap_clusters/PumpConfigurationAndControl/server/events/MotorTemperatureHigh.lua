...
--- @class st.matter.clusters.PumpConfigurationAndControl.MotorTemperatureHigh
--- @alias MotorTemperatureHigh
---
--- @field public ID number 0x0006 the ID of this event
--- @field public NAME string "MotorTemperatureHigh" the name of this event
local MotorTemperatureHigh = {
  ID = 0x0006,
  NAME = "MotorTemperatureHigh",
  base_type = data_types.Structure,
}

MotorTemperatureHigh.field_defs = {
}
--- Add field names to each event field
---
--- @param base_type_obj st.matter.data_types.Structure
function MotorTemperatureHigh:augment_type(base_type_obj)
  local elems = {}
...
function MotorTemperatureHigh:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function MotorTemperatureHigh:subscribe(device, endpoint_id)
...
function MotorTemperatureHigh:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "MotorTemperatureHighEventData", ID = 0x15}))
...
function MotorTemperatureHigh:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function MotorTemperatureHigh:set_parent_cluster(cluster)
