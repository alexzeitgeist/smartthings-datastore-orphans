...
--- @field public data_type st.matter.generated.zap_clusters.ThermostatUserInterfaceConfiguration.types.TemperatureDisplayModeEnum the data type of this attribute

local TemperatureDisplayMode = {
  ID = 0x0000,
  NAME = "TemperatureDisplayMode",
  base_type = require "st.matter.generated.zap_clusters.ThermostatUserInterfaceConfiguration.types.TemperatureDisplayModeEnum",
}
...
---
--- @vararg vararg the values needed to construct a TemperatureDisplayModeEnum
--- @return st.matter.generated.zap_clusters.ThermostatUserInterfaceConfiguration.types.TemperatureDisplayModeEnum
...
function TemperatureDisplayMode:read(device, endpoint_id)
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.generated.zap_clusters.ThermostatUserInterfaceConfiguration.types.TemperatureDisplayModeEnum the value to write
--- @return st.matter.interaction_model.InteractionRequest
function TemperatureDisplayMode:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function TemperatureDisplayMode:subscribe(device, endpoint_id)
...
function TemperatureDisplayMode:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function TemperatureDisplayMode:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(TemperatureDisplayMode, {__call = TemperatureDisplayMode.new_value, __index = TemperatureDisplayMode.base_type})
