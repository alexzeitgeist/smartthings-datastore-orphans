...
--- @field public data_type st.matter.generated.zap_clusters.PowerSource.types.WiredCurrentTypeEnum the data type of this attribute

local WiredCurrentType = {
  ID = 0x0005,
  NAME = "WiredCurrentType",
  base_type = require "st.matter.generated.zap_clusters.PowerSource.types.WiredCurrentTypeEnum",
}
...
---
--- @vararg vararg the values needed to construct a WiredCurrentTypeEnum
--- @return st.matter.generated.zap_clusters.PowerSource.types.WiredCurrentTypeEnum
...
setmetatable(WiredCurrentType, {__call = WiredCurrentType.new_value, __index = WiredCurrentType.base_type})
