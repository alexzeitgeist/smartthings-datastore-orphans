...
function ActiveBatFaults:augment_type(data_type_obj)
  for i, v in ipairs(data_type_obj.elements) do
    data_type_obj.elements[i] = data_types.validate_or_build_type(v, ActiveBatFaults.element_type)
  end
end
...
setmetatable(ActiveBatFaults, {__call = ActiveBatFaults.new_value, __index = ActiveBatFaults.base_type})
