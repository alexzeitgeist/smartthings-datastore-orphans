...
function ActiveWiredFaults:augment_type(data_type_obj)
  for i, v in ipairs(data_type_obj.elements) do
    data_type_obj.elements[i] = data_types.validate_or_build_type(v, ActiveWiredFaults.element_type)
  end
end
...
setmetatable(ActiveWiredFaults, {__call = ActiveWiredFaults.new_value, __index = ActiveWiredFaults.base_type})
