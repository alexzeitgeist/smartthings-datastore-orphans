...
function ActiveBatChargeFaults:augment_type(data_type_obj)
  for i, v in ipairs(data_type_obj.elements) do
    data_type_obj.elements[i] = data_types.validate_or_build_type(v, ActiveBatChargeFaults.element_type)
  end
end
...
setmetatable(ActiveBatChargeFaults, {__call = ActiveBatChargeFaults.new_value, __index = ActiveBatChargeFaults.base_type})
