...
--- @field public data_type st.matter.generated.zap_clusters.PowerSource.types.PowerSourceStatusEnum the data type of this attribute

local Status = {
  ID = 0x0000,
  NAME = "Status",
  base_type = require "st.matter.generated.zap_clusters.PowerSource.types.PowerSourceStatusEnum",
}
...
---
--- @vararg vararg the values needed to construct a PowerSourceStatusEnum
--- @return st.matter.generated.zap_clusters.PowerSource.types.PowerSourceStatusEnum
