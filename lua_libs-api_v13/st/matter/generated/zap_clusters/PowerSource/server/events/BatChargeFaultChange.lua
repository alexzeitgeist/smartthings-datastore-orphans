...
--- @class st.matter.clusters.PowerSource.BatChargeFaultChange
--- @alias BatChargeFaultChange
---
--- @field public ID number 0x0002 the ID of this event
--- @field public NAME string "BatChargeFaultChange" the name of this event
--- @field public current st.matter.data_types.Array
--- @field public previous st.matter.data_types.Array
local BatChargeFaultChange = {
  ID = 0x0002,
  NAME = "BatChargeFaultChange",
  base_type = data_types.Structure,
}

BatChargeFaultChange.field_defs = {
  {
    name = "current",
    field_id = 0,
    is_nullable = false,
    ...
    element_type = require "st.matter.generated.zap_clusters.PowerSource.types.BatChargeFaultEnum",
  },
  {
    name = "previous",
    field_id = 1,
...
function BatChargeFaultChange:augment_type(base_type_obj)
  local elems = {}
...
function BatChargeFaultChange:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function BatChargeFaultChange:subscribe(device, endpoint_id)
...
function BatChargeFaultChange:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "BatChargeFaultChangeEventData", ID = 0x15}))
...
function BatChargeFaultChange:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function BatChargeFaultChange:set_parent_cluster(cluster)
