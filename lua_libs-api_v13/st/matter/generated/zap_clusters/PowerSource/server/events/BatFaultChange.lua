...
--- @class st.matter.clusters.PowerSource.BatFaultChange
--- @alias BatFaultChange
---
--- @field public ID number 0x0001 the ID of this event
--- @field public NAME string "BatFaultChange" the name of this event
--- @field public current st.matter.data_types.Array
--- @field public previous st.matter.data_types.Array
local BatFaultChange = {
  ID = 0x0001,
  NAME = "BatFaultChange",
  base_type = data_types.Structure,
}

BatFaultChange.field_defs = {
  {
    name = "current",
    field_id = 0,
    is_nullable = false,
    ...
    element_type = require "st.matter.generated.zap_clusters.PowerSource.types.BatFaultEnum",
  },
  {
    name = "previous",
    field_id = 1,
...
function BatFaultChange:augment_type(base_type_obj)
  local elems = {}
...
function BatFaultChange:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function BatFaultChange:subscribe(device, endpoint_id)
...
function BatFaultChange:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "BatFaultChangeEventData", ID = 0x15}))
...
function BatFaultChange:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function BatFaultChange:set_parent_cluster(cluster)
