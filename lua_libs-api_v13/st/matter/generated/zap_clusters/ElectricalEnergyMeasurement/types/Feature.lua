...
--- @alias Feature
---
--- @field public IMPORTED_ENERGY number 1
--- @field public EXPORTED_ENERGY number 2
--- @field public CUMULATIVE_ENERGY number 4
--- @field public PERIODIC_ENERGY number 8
...
--- @function Feature:is_imported_energy_set
--- @return boolean True if the value of IMPORTED_ENERGY is non-zero
Feature.is_imported_energy_set = function(self)
  return (self.value & self.IMPORTED_ENERGY) ~= 0
end

--- @function Feature:set_imported_energy
...
--- @function Feature:unset_imported_energy
...
--- @function Feature:is_exported_energy_set
--- @return boolean True if the value of EXPORTED_ENERGY is non-zero
Feature.is_exported_energy_set = function(self)
  return (self.value & self.EXPORTED_ENERGY) ~= 0
end

--- @function Feature:set_exported_energy
...
--- @function Feature:unset_exported_energy
...
--- @function Feature:is_cumulative_energy_set
--- @return boolean True if the value of CUMULATIVE_ENERGY is non-zero
Feature.is_cumulative_energy_set = function(self)
  return (self.value & self.CUMULATIVE_ENERGY) ~= 0
end

--- @function Feature:set_cumulative_energy
...
--- @function Feature:unset_cumulative_energy
...
--- @function Feature:is_periodic_energy_set
--- @return boolean True if the value of PERIODIC_ENERGY is non-zero
Feature.is_periodic_energy_set = function(self)
  return (self.value & self.PERIODIC_ENERGY) ~= 0
end

--- @function Feature:set_periodic_energy
...
--- @function Feature:unset_periodic_energy
