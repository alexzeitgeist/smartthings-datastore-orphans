...
--- @alias CumulativeEnergyResetStruct
--- @class st.matter.clusters.ElectricalEnergyMeasurement.types.CumulativeEnergyResetStruct: st.matter.data_types.Structure
---
--- @field public imported_reset_timestamp st.matter.data_types.Uint32
--- @field public exported_reset_timestamp st.matter.data_types.Uint32
--- @field public imported_reset_systime st.matter.data_types.Uint64
--- @field public exported_reset_systime st.matter.data_types.Uint64
local CumulativeEnergyResetStruct = {}
local new_mt = StructureABC.new_mt({NAME = "CumulativeEnergyResetStruct", ID = data_types.name_to_id_map["Structure"]})

CumulativeEnergyResetStruct.field_defs = {
  {
    name = "imported_reset_timestamp",
    field_id = 0,
    is_nullable = true,
    is_optional = true,
...
CumulativeEnergyResetStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
CumulativeEnergyResetStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = CumulativeEnergyResetStruct.init
new_mt.__index.serialize = CumulativeEnergyResetStruct.serialize

CumulativeEnergyResetStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(CumulativeEnergyResetStruct, new_mt)

return CumulativeEnergyResetStruct
