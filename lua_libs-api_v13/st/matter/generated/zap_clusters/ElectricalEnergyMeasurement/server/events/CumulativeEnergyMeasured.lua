...
--- @alias CumulativeEnergyMeasured
---
--- @field public ID number 0x0000 the ID of this event
--- @field public NAME string "CumulativeEnergyMeasured" the name of this event
--- @field public energy_imported st.matter.generated.zap_clusters.ElectricalEnergyMeasurement.types.EnergyMeasurementStruct
--- @field public energy_exported st.matter.generated.zap_clusters.ElectricalEnergyMeasurement.types.EnergyMeasurementStruct
...
CumulativeEnergyMeasured.field_defs = {
  {
    ...
    is_nullable = false,
    is_optional = true,
    data_type = require "st.matter.generated.zap_clusters.ElectricalEnergyMeasurement.types.EnergyMeasurementStruct",
  },
  {
