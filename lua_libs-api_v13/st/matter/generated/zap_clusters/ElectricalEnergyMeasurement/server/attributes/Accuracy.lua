...
--- @field public NAME string "Accuracy" the name of this attribute
--- @field public data_type st.matter.generated.zap_clusters.ElectricalEnergyMeasurement.types.MeasurementAccuracyStruct the data type of this attribute

local Accuracy = {
  ID = 0x0000,
  NAME = "Accuracy",
  base_type = require "st.matter.generated.zap_clusters.ElectricalEnergyMeasurement.types.MeasurementAccuracyStruct",
}
...
--- @return st.matter.generated.zap_clusters.ElectricalEnergyMeasurement.types.MeasurementAccuracyStruct
...
setmetatable(Accuracy, {__call = Accuracy.new_value, __index = Accuracy.base_type})
return Accuracy
