...
--- @alias CumulativeEnergyReset
---
--- @field public ID number 0x0005 the ID of this attribute
--- @field public NAME string "CumulativeEnergyReset" the name of this attribute
--- @field public data_type st.matter.generated.zap_clusters.ElectricalEnergyMeasurement.types.CumulativeEnergyResetStruct the data type of this attribute

local CumulativeEnergyReset = {
  ID = 0x0005,
  NAME = "CumulativeEnergyReset",
  base_type = require "st.matter.generated.zap_clusters.ElectricalEnergyMeasurement.types.CumulativeEnergyResetStruct",
}
...
--- @return st.matter.generated.zap_clusters.ElectricalEnergyMeasurement.types.CumulativeEnergyResetStruct
function CumulativeEnergyReset:new_value(...)
...
function CumulativeEnergyReset:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function CumulativeEnergyReset:subscribe(device, endpoint_id)
...
function CumulativeEnergyReset:set_parent_cluster(cluster)
...
function CumulativeEnergyReset:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function CumulativeEnergyReset:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(CumulativeEnergyReset, {__call = CumulativeEnergyReset.new_value, __index = CumulativeEnergyReset.base_type})
