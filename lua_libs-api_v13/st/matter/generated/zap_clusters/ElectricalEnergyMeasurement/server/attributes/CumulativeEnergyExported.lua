...
--- @alias CumulativeEnergyExported
---
--- @field public ID number 0x0002 the ID of this attribute
--- @field public NAME string "CumulativeEnergyExported" the name of this attribute
--- @field public data_type st.matter.generated.zap_clusters.ElectricalEnergyMeasurement.types.EnergyMeasurementStruct the data type of this attribute
...
--- @return st.matter.generated.zap_clusters.ElectricalEnergyMeasurement.types.EnergyMeasurementStruct
