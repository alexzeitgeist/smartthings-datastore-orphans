...
function PhysicalMinLevel:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function PhysicalMinLevel:subscribe(device, endpoint_id)
...
function PhysicalMinLevel:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function PhysicalMinLevel:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(PhysicalMinLevel, {__call = PhysicalMinLevel.new_value, __index = PhysicalMinLevel.base_type})
