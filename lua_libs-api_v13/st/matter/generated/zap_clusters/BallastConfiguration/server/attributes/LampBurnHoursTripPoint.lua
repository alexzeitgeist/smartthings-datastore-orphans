...
function LampBurnHoursTripPoint:read(device, endpoint_id)
...
function LampBurnHoursTripPoint:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function LampBurnHoursTripPoint:subscribe(device, endpoint_id)
...
function LampBurnHoursTripPoint:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function LampBurnHoursTripPoint:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(LampBurnHoursTripPoint, {__call = LampBurnHoursTripPoint.new_value, __index = LampBurnHoursTripPoint.base_type})
