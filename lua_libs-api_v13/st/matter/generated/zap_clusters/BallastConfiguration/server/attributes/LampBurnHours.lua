...
function LampBurnHours:read(device, endpoint_id)
...
function LampBurnHours:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function LampBurnHours:subscribe(device, endpoint_id)
...
function LampBurnHours:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function LampBurnHours:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(LampBurnHours, {__call = LampBurnHours.new_value, __index = LampBurnHours.base_type})
