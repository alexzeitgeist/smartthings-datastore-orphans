...
function BallastFactorAdjustment:read(device, endpoint_id)
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.data_types.Uint8 the value to write
--- @return st.matter.interaction_model.InteractionRequest
function BallastFactorAdjustment:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function BallastFactorAdjustment:subscribe(device, endpoint_id)
...
function BallastFactorAdjustment:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function BallastFactorAdjustment:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(BallastFactorAdjustment, {__call = BallastFactorAdjustment.new_value, __index = BallastFactorAdjustment.base_type})
