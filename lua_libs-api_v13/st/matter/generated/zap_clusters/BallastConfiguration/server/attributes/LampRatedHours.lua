...
function LampRatedHours:read(device, endpoint_id)
...
function LampRatedHours:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function LampRatedHours:subscribe(device, endpoint_id)
...
function LampRatedHours:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function LampRatedHours:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(LampRatedHours, {__call = LampRatedHours.new_value, __index = LampRatedHours.base_type})
