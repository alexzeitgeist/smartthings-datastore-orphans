...
function LampType:read(device, endpoint_id)
...
function LampType:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function LampType:subscribe(device, endpoint_id)
...
function LampType:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function LampType:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(LampType, {__call = LampType.new_value, __index = LampType.base_type})
return LampType
