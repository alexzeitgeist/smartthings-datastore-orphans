...
function LampQuantity:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function LampQuantity:subscribe(device, endpoint_id)
...
function LampQuantity:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function LampQuantity:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(LampQuantity, {__call = LampQuantity.new_value, __index = LampQuantity.base_type})
return LampQuantity
