...
function IntrinsicBallastFactor:read(device, endpoint_id)
...
function IntrinsicBallastFactor:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function IntrinsicBallastFactor:subscribe(device, endpoint_id)
...
function IntrinsicBallastFactor:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function IntrinsicBallastFactor:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(IntrinsicBallastFactor, {__call = IntrinsicBallastFactor.new_value, __index = IntrinsicBallastFactor.base_type})
