...
function PhysicalMaxLevel:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function PhysicalMaxLevel:subscribe(device, endpoint_id)
...
function PhysicalMaxLevel:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function PhysicalMaxLevel:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(PhysicalMaxLevel, {__call = PhysicalMaxLevel.new_value, __index = PhysicalMaxLevel.base_type})
