...
function LampManufacturer:read(device, endpoint_id)
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.data_types.UTF8String1 the value to write
--- @return st.matter.interaction_model.InteractionRequest
function LampManufacturer:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function LampManufacturer:subscribe(device, endpoint_id)
...
function LampManufacturer:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function LampManufacturer:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(LampManufacturer, {__call = LampManufacturer.new_value, __index = LampManufacturer.base_type})
