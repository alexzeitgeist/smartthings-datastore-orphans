...
--- @class st.matter.clusters.SmokeCoAlarm.HardwareFaultAlert
--- @alias HardwareFaultAlert
---
--- @field public ID number 0x0006 the ID of this attribute
--- @field public NAME string "HardwareFaultAlert" the name of this attribute
