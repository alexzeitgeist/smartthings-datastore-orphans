...
--- @class st.matter.clusters.SmokeCoAlarm.ExpiryDate
--- @alias ExpiryDate
---
--- @field public ID number 0x000C the ID of this attribute
--- @field public NAME string "ExpiryDate" the name of this attribute
...
function ExpiryDate:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ExpiryDate:subscribe(device, endpoint_id)
...
function ExpiryDate:set_parent_cluster(cluster)
...
function ExpiryDate:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ExpiryDate:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(ExpiryDate, {__call = ExpiryDate.new_value, __index = ExpiryDate.base_type})
return ExpiryDate
