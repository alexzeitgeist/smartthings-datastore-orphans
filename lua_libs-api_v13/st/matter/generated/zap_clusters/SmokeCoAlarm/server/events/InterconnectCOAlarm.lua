...
---
--- @field public ID number 0x0009 the ID of this event
--- @field public NAME string "InterconnectCOAlarm" the name of this event
...
InterconnectCOAlarm.field_defs = {
  {
...
function InterconnectCOAlarm:augment_type(base_type_obj)
  local elems = {}
...
function InterconnectCOAlarm:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "InterconnectCOAlarmEventData", ID = 0x15}))
