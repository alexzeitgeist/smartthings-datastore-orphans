...
--- @class st.matter.clusters.SmokeCoAlarm.SmokeAlarm
--- @alias SmokeAlarm
---
--- @field public ID number 0x0000 the ID of this event
--- @field public NAME string "SmokeAlarm" the name of this event
...
function SmokeAlarm:augment_type(base_type_obj)
  local elems = {}
...
function SmokeAlarm:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function SmokeAlarm:subscribe(device, endpoint_id)
...
function SmokeAlarm:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "SmokeAlarmEventData", ID = 0x15}))
...
function SmokeAlarm:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function SmokeAlarm:set_parent_cluster(cluster)
