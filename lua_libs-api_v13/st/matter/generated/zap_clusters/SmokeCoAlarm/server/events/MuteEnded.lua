...
--- @class st.matter.clusters.SmokeCoAlarm.MuteEnded
--- @alias MuteEnded
---
--- @field public ID number 0x0007 the ID of this event
--- @field public NAME string "MuteEnded" the name of this event
local MuteEnded = {
  ID = 0x0007,
  NAME = "MuteEnded",
...
function MuteEnded:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function MuteEnded:subscribe(device, endpoint_id)
...
function MuteEnded:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "MuteEndedEventData", ID = 0x15}))
...
function MuteEnded:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function MuteEnded:set_parent_cluster(cluster)
