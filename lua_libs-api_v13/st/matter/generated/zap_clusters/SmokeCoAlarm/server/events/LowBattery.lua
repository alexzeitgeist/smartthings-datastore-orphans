...
--- @class st.matter.clusters.SmokeCoAlarm.LowBattery
--- @alias LowBattery
---
--- @field public ID number 0x0002 the ID of this event
--- @field public NAME string "LowBattery" the name of this event
...
function LowBattery:augment_type(base_type_obj)
  local elems = {}
...
function LowBattery:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function LowBattery:subscribe(device, endpoint_id)
...
function LowBattery:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "LowBatteryEventData", ID = 0x15}))
...
function LowBattery:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function LowBattery:set_parent_cluster(cluster)
