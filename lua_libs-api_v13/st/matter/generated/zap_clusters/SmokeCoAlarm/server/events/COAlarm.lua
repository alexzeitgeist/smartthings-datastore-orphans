...
--- @class st.matter.clusters.SmokeCoAlarm.COAlarm
--- @alias COAlarm
---
--- @field public ID number 0x0001 the ID of this event
--- @field public NAME string "COAlarm" the name of this event
...
function COAlarm:augment_type(base_type_obj)
  local elems = {}
...
function COAlarm:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function COAlarm:subscribe(device, endpoint_id)
...
function COAlarm:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "COAlarmEventData", ID = 0x15}))
...
function COAlarm:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function COAlarm:set_parent_cluster(cluster)
