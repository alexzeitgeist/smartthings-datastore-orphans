...
--- @class st.matter.clusters.SmokeCoAlarm.EndOfService
--- @alias EndOfService
---
--- @field public ID number 0x0004 the ID of this event
--- @field public NAME string "EndOfService" the name of this event
local EndOfService = {
  ID = 0x0004,
  NAME = "EndOfService",
...
function EndOfService:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function EndOfService:subscribe(device, endpoint_id)
...
function EndOfService:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "EndOfServiceEventData", ID = 0x15}))
...
function EndOfService:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function EndOfService:set_parent_cluster(cluster)
