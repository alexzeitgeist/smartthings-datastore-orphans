...
--- @class st.matter.clusters.SmokeCoAlarm.AllClear
--- @alias AllClear
---
--- @field public ID number 0x000A the ID of this event
--- @field public NAME string "AllClear" the name of this event
local AllClear = {
  ID = 0x000A,
  NAME = "AllClear",
...
function AllClear:augment_type(base_type_obj)
  local elems = {}
...
function AllClear:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function AllClear:subscribe(device, endpoint_id)
...
function AllClear:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "AllClearEventData", ID = 0x15}))
...
function AllClear:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function AllClear:set_parent_cluster(cluster)
