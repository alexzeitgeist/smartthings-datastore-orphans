...
---
--- @field public ID number 0x0008 the ID of this event
--- @field public NAME string "InterconnectSmokeAlarm" the name of this event
--- @field public alarm_severity_level st.matter.generated.zap_clusters.SmokeCoAlarm.types.AlarmStateEnum
...
InterconnectSmokeAlarm.field_defs = {
  {
    name = "alarm_severity_level",
    field_id = 0,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.SmokeCoAlarm.types.AlarmStateEnum",
  },
}
--- Add field names to each event field
---
--- @param base_type_obj st.matter.data_types.Structure
function InterconnectSmokeAlarm:augment_type(base_type_obj)
  local elems = {}
...
function InterconnectSmokeAlarm:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "InterconnectSmokeAlarmEventData", ID = 0x15}))
