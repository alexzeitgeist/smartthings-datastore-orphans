...
--- @class st.matter.clusters.SmokeCoAlarm.AlarmMuted
--- @alias AlarmMuted
---
--- @field public ID number 0x0006 the ID of this event
--- @field public NAME string "AlarmMuted" the name of this event
local AlarmMuted = {
  ID = 0x0006,
  NAME = "AlarmMuted",
...
function AlarmMuted:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function AlarmMuted:subscribe(device, endpoint_id)
...
function AlarmMuted:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "AlarmMutedEventData", ID = 0x15}))
...
function AlarmMuted:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function AlarmMuted:set_parent_cluster(cluster)
