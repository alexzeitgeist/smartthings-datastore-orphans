...
-----------------------------------------------------------
-- SmokeCoAlarm command SelfTestRequest
-----------------------------------------------------------

--- @class st.matter.clusters.SmokeCoAlarm.SelfTestRequest
--- @alias SelfTestRequest
---
--- @field public ID number 0x0000 the ID of this command
--- @field public NAME string "SelfTestRequest" the name of this command
...
---
--- @param self SelfTestRequest the template class for this command
--- @param device st.matter.Device the device to build this message to
