...
--- @field public status st.matter.generated.zap_clusters.MediaPlayback.types.StatusEnum
...
PlaybackResponse.field_defs = {
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.MediaPlayback.types.StatusEnum",
  },
  {
    name = "data",
    field_id = 1,
...
--- @param status st.matter.generated.zap_clusters.MediaPlayback.types.StatusEnum
