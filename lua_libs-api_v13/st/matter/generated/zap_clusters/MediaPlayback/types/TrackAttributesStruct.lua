...
--- @alias TrackAttributesStruct
--- @class st.matter.clusters.MediaPlayback.types.TrackAttributesStruct: st.matter.data_types.Structure
---
--- @field public language_code st.matter.data_types.UTF8String1
--- @field public display_name st.matter.data_types.UTF8String1
local TrackAttributesStruct = {}
local new_mt = StructureABC.new_mt({NAME = "TrackAttributesStruct", ID = data_types.name_to_id_map["Structure"]})

TrackAttributesStruct.field_defs = {
  {
    name = "language_code",
    field_id = 0,
    is_nullable = false,
...
TrackAttributesStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
TrackAttributesStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = TrackAttributesStruct.init
new_mt.__index.serialize = TrackAttributesStruct.serialize

TrackAttributesStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(TrackAttributesStruct, new_mt)

return TrackAttributesStruct
