...
--- @alias PlaybackPositionStruct
--- @class st.matter.clusters.MediaPlayback.types.PlaybackPositionStruct: st.matter.data_types.Structure
---
--- @field public updated_at st.matter.data_types.Uint64
--- @field public position st.matter.data_types.Uint64
local PlaybackPositionStruct = {}
local new_mt = StructureABC.new_mt({NAME = "PlaybackPositionStruct", ID = data_types.name_to_id_map["Structure"]})

PlaybackPositionStruct.field_defs = {
  {
    name = "updated_at",
    field_id = 0,
    is_nullable = false,
...
PlaybackPositionStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
PlaybackPositionStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = PlaybackPositionStruct.init
new_mt.__index.serialize = PlaybackPositionStruct.serialize

PlaybackPositionStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(PlaybackPositionStruct, new_mt)

return PlaybackPositionStruct
