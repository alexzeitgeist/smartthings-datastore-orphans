...
--- @class st.matter.clusters.MediaPlayback.types.CharacteristicEnum: st.matter.data_types.Uint8
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.MediaPlayback.types.CharacteristicEnum")
if has_aliases then
