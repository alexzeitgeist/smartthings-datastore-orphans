...
--- @alias TrackStruct
--- @class st.matter.clusters.MediaPlayback.types.TrackStruct: st.matter.data_types.Structure
---
--- @field public id st.matter.data_types.UTF8String1
--- @field public track_attributes st.matter.generated.zap_clusters.MediaPlayback.types.TrackAttributesStruct
local TrackStruct = {}
local new_mt = StructureABC.new_mt({NAME = "TrackStruct", ID = data_types.name_to_id_map["Structure"]})

TrackStruct.field_defs = {
  {
    name = "id",
    field_id = 0,
    is_nullable = false,
  ...
  },
  {
    ...
    is_nullable = true,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.MediaPlayback.types.TrackAttributesStruct",
  },
}

TrackStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
TrackStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = TrackStruct.init
new_mt.__index.serialize = TrackStruct.serialize

TrackStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(TrackStruct, new_mt)
