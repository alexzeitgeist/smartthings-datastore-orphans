...
-----------------------------------------------------------
-- MediaPlayback command DeactivateTextTrack
-----------------------------------------------------------

--- @class st.matter.clusters.MediaPlayback.DeactivateTextTrack
--- @alias DeactivateTextTrack
---
--- @field public ID number 0x000E the ID of this command
--- @field public NAME string "DeactivateTextTrack" the name of this command
local DeactivateTextTrack = {}

DeactivateTextTrack.NAME = "DeactivateTextTrack"
DeactivateTextTrack.ID = 0x000E
DeactivateTextTrack.field_defs = {
}
...
function DeactivateTextTrack:build_test_command_response(device, endpoint_id, status)
...
---
--- @param self DeactivateTextTrack the template class for this command
--- @param device st.matter.Device the device to build this message to

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function DeactivateTextTrack:init(device, endpoint_id)
  local out = {}
  local args = {}
  ...
  setmetatable(out, {
    __index = DeactivateTextTrack,
    __tostring = DeactivateTextTrack.pretty_print
  })
...
function DeactivateTextTrack:set_parent_cluster(cluster)
...
function DeactivateTextTrack:augment_type(base_type_obj)
  local elems = {}
...
function DeactivateTextTrack:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(DeactivateTextTrack, {__call = DeactivateTextTrack.init})
