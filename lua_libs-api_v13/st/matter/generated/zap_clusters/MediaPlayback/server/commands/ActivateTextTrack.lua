...
-----------------------------------------------------------
-- MediaPlayback command ActivateTextTrack
-----------------------------------------------------------

--- @class st.matter.clusters.MediaPlayback.ActivateTextTrack
--- @alias ActivateTextTrack
---
--- @field public ID number 0x000D the ID of this command
--- @field public NAME string "ActivateTextTrack" the name of this command
--- @field public trackid st.matter.data_types.UTF8String1
local ActivateTextTrack = {}

ActivateTextTrack.NAME = "ActivateTextTrack"
ActivateTextTrack.ID = 0x000D
ActivateTextTrack.field_defs = {
  {
    name = "trackid",
    field_id = 0,
    is_nullable = false,
...
function ActivateTextTrack:build_test_command_response(device, endpoint_id, status)
...
---
--- @param self ActivateTextTrack the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param trackid st.matter.data_types.UTF8String1

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function ActivateTextTrack:init(device, endpoint_id, trackid)
  local out = {}
  local args = {trackid}
  ...
  setmetatable(out, {
    __index = ActivateTextTrack,
    __tostring = ActivateTextTrack.pretty_print
  })
...
function ActivateTextTrack:set_parent_cluster(cluster)
...
function ActivateTextTrack:augment_type(base_type_obj)
  local elems = {}
...
function ActivateTextTrack:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(ActivateTextTrack, {__call = ActivateTextTrack.init})
