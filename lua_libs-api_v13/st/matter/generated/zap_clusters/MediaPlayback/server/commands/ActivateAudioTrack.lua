...
-----------------------------------------------------------
-- MediaPlayback command ActivateAudioTrack
-----------------------------------------------------------

--- @class st.matter.clusters.MediaPlayback.ActivateAudioTrack
--- @alias ActivateAudioTrack
---
--- @field public ID number 0x000C the ID of this command
--- @field public NAME string "ActivateAudioTrack" the name of this command
--- @field public trackid st.matter.data_types.UTF8String1
--- @field public audio_output_index st.matter.data_types.Uint8
local ActivateAudioTrack = {}

ActivateAudioTrack.NAME = "ActivateAudioTrack"
ActivateAudioTrack.ID = 0x000C
ActivateAudioTrack.field_defs = {
  {
    name = "trackid",
    field_id = 0,
    is_nullable = false,
...
function ActivateAudioTrack:build_test_command_response(device, endpoint_id, status)
...
---
--- @param self ActivateAudioTrack the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param trackid st.matter.data_types.UTF8String1
--- @param audio_output_index st.matter.data_types.Uint8

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function ActivateAudioTrack:init(device, endpoint_id, trackid, audio_output_index)
  local out = {}
  local args = {trackid, audio_output_index}
  ...
  setmetatable(out, {
    __index = ActivateAudioTrack,
    __tostring = ActivateAudioTrack.pretty_print
  })
...
function ActivateAudioTrack:set_parent_cluster(cluster)
...
function ActivateAudioTrack:augment_type(base_type_obj)
  local elems = {}
...
function ActivateAudioTrack:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(ActivateAudioTrack, {__call = ActivateAudioTrack.init})
