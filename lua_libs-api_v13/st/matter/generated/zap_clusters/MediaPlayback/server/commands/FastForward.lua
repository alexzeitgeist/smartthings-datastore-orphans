...
--- @param audio_advance_unmuted st.matter.data_types.Boolean

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function FastForward:init(device, endpoint_id, audio_advance_unmuted)
  local out = {}
  local args = {audio_advance_unmuted}
