...
--- @class st.matter.clusters.MediaPlayback.AvailableAudioTracks
--- @alias AvailableAudioTracks
---
--- @field public ID number 0x0008 the ID of this attribute
--- @field public NAME string "AvailableAudioTracks" the name of this attribute
--- @field public data_type st.matter.data_types.Array the data type of this attribute

local AvailableAudioTracks = {
  ID = 0x0008,
  NAME = "AvailableAudioTracks",
  base_type = require "st.matter.data_types.Array",
  element_type = require "st.matter.generated.zap_clusters.MediaPlayback.types.TrackStruct",
}

--- Add additional functionality to the base type object
---
--- @param base_type_obj st.matter.data_types.Array the base data type object to add functionality to
function AvailableAudioTracks:augment_type(data_type_obj)
  for i, v in ipairs(data_type_obj.elements) do
    data_type_obj.elements[i] = data_types.validate_or_build_type(v, AvailableAudioTracks.element_type)
  end
end
...
function AvailableAudioTracks:new_value(...)
...
function AvailableAudioTracks:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function AvailableAudioTracks:subscribe(device, endpoint_id)
...
function AvailableAudioTracks:set_parent_cluster(cluster)
...
function AvailableAudioTracks:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function AvailableAudioTracks:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(AvailableAudioTracks, {__call = AvailableAudioTracks.new_value, __index = AvailableAudioTracks.base_type})
