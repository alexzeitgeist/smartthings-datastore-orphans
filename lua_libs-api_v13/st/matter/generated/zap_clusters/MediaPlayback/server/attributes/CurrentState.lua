...
--- @field public data_type st.matter.generated.zap_clusters.MediaPlayback.types.PlaybackStateEnum the data type of this attribute

local CurrentState = {
  ID = 0x0000,
  NAME = "CurrentState",
  base_type = require "st.matter.generated.zap_clusters.MediaPlayback.types.PlaybackStateEnum",
}
...
---
--- @vararg vararg the values needed to construct a PlaybackStateEnum
--- @return st.matter.generated.zap_clusters.MediaPlayback.types.PlaybackStateEnum
