...
--- @class st.matter.clusters.MediaPlayback.StateChanged
--- @alias StateChanged
---
--- @field public ID number 0x0000 the ID of this event
--- @field public NAME string "StateChanged" the name of this event
--- @field public current_state st.matter.generated.zap_clusters.MediaPlayback.types.PlaybackStateEnum
--- @field public start_time st.matter.data_types.Uint64
--- @field public duration st.matter.data_types.Uint64
--- @field public sampled_position st.matter.generated.zap_clusters.MediaPlayback.types.PlaybackPositionStruct
--- @field public playback_speed st.matter.data_types.SinglePrecisionFloat
--- @field public seek_range_end st.matter.data_types.Uint64
--- @field public seek_range_start st.matter.data_types.Uint64
--- @field public data st.matter.data_types.OctetString1
--- @field public audio_advance_unmuted st.matter.data_types.Boolean
local StateChanged = {
  ID = 0x0000,
  NAME = "StateChanged",
...
StateChanged.field_defs = {
  {
    name = "current_state",
    field_id = 0,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.MediaPlayback.types.PlaybackStateEnum",
  },
  {
    name = "start_time",
    field_id = 1,
  ...
  },
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.MediaPlayback.types.PlaybackPositionStruct",
  },
  {
    name = "playback_speed",
    field_id = 4,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.data_types.SinglePrecisionFloat",
  },
  {
    name = "seek_range_end",
    field_id = 5,
...
function StateChanged:augment_type(base_type_obj)
  local elems = {}
...
function StateChanged:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function StateChanged:subscribe(device, endpoint_id)
...
function StateChanged:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "StateChangedEventData", ID = 0x15}))
...
function StateChanged:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function StateChanged:set_parent_cluster(cluster)
