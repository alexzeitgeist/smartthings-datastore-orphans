...
-----------------------------------------------------------
-- Channel command ChangeChannelResponse
-----------------------------------------------------------

--- @class st.matter.clusters.Channel.ChangeChannelResponse
--- @alias ChangeChannelResponse
---
--- @field public ID number 0x0001 the ID of this command
--- @field public NAME string "ChangeChannelResponse" the name of this command
--- @field public status st.matter.generated.zap_clusters.Channel.types.StatusEnum
--- @field public data st.matter.data_types.UTF8String1
local ChangeChannelResponse = {}

ChangeChannelResponse.NAME = "ChangeChannelResponse"
ChangeChannelResponse.ID = 0x0001
ChangeChannelResponse.field_defs = {
  {
    name = "status",
    field_id = 0,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.Channel.types.StatusEnum",
  },
  {
    name = "data",
    field_id = 1,
...
function ChangeChannelResponse:augment_type(base_type_obj)
  local elems = {}
...
--- @param status st.matter.generated.zap_clusters.Channel.types.StatusEnum
...
function ChangeChannelResponse:build_test_command_response(device, endpoint_id, status, data, interaction_status)
  local function init(self, device, endpoint_id, status, data)
    ...
    setmetatable(out, {
      __index = ChangeChannelResponse,
      __tostring = ChangeChannelResponse.pretty_print
    })
...
---
--- @return nil
function ChangeChannelResponse:init()
  return nil
end

function ChangeChannelResponse:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

function ChangeChannelResponse:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(ChangeChannelResponse, {__call = ChangeChannelResponse.init})
