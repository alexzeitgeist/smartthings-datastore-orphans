...
-----------------------------------------------------------
-- Channel command ProgramGuideResponse
-----------------------------------------------------------

--- @class st.matter.clusters.Channel.ProgramGuideResponse
--- @alias ProgramGuideResponse
---
--- @field public ID number 0x0005 the ID of this command
--- @field public NAME string "ProgramGuideResponse" the name of this command
--- @field public paging st.matter.generated.zap_clusters.Channel.types.ChannelPagingStruct
--- @field public program_list st.matter.data_types.Array
local ProgramGuideResponse = {}

ProgramGuideResponse.NAME = "ProgramGuideResponse"
ProgramGuideResponse.ID = 0x0005
ProgramGuideResponse.field_defs = {
  {
    name = "paging",
    field_id = 0,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.Channel.types.ChannelPagingStruct",
  },
  {
    name = "program_list",
    field_id = 1,
    ...
    element_type = require "st.matter.generated.zap_clusters.Channel.types.ProgramStruct",
  },
}
...
function ProgramGuideResponse:augment_type(base_type_obj)
  local elems = {}
...
--- @param paging st.matter.generated.zap_clusters.Channel.types.ChannelPagingStruct
--- @param program_list st.matter.data_types.Array
--- @return st.matter.st.matter.interaction_model.InteractionResponse of type COMMAND_RESPONSE
function ProgramGuideResponse:build_test_command_response(device, endpoint_id, paging, program_list, interaction_status)
  local function init(self, device, endpoint_id, paging, program_list)
    local out = {}
    local args = {paging, program_list}
    ...
    setmetatable(out, {
      __index = ProgramGuideResponse,
      __tostring = ProgramGuideResponse.pretty_print
    })
  ...
  local self_request =  init(self, device, endpoint_id, paging, program_list)
...
---
--- @return nil
function ProgramGuideResponse:init()
  return nil
end

function ProgramGuideResponse:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

function ProgramGuideResponse:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(ProgramGuideResponse, {__call = ProgramGuideResponse.init})
