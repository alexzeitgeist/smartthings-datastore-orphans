...
--- @field public NAME string "ChannelList" the name of this attribute
...
function ChannelList:augment_type(data_type_obj)
  for i, v in ipairs(data_type_obj.elements) do
    data_type_obj.elements[i] = data_types.validate_or_build_type(v, ChannelList.element_type)
  end
end
...
function ChannelList:new_value(...)
...
function ChannelList:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ChannelList:subscribe(device, endpoint_id)
...
function ChannelList:set_parent_cluster(cluster)
...
function ChannelList:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ChannelList:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(ChannelList, {__call = ChannelList.new_value, __index = ChannelList.base_type})
return ChannelList
