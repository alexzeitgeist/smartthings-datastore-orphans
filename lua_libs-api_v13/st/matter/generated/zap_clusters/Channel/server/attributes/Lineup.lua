...
--- @field public NAME string "Lineup" the name of this attribute
--- @field public data_type st.matter.generated.zap_clusters.Channel.types.LineupInfoStruct the data type of this attribute

local Lineup = {
  ID = 0x0001,
  NAME = "Lineup",
  base_type = require "st.matter.generated.zap_clusters.Channel.types.LineupInfoStruct",
}
...
---
--- @vararg vararg the values needed to construct a LineupInfoStruct
--- @return st.matter.generated.zap_clusters.Channel.types.LineupInfoStruct
function Lineup:new_value(...)
...
function Lineup:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Lineup:subscribe(device, endpoint_id)
...
function Lineup:set_parent_cluster(cluster)
...
function Lineup:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Lineup:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(Lineup, {__call = Lineup.new_value, __index = Lineup.base_type})
return Lineup
