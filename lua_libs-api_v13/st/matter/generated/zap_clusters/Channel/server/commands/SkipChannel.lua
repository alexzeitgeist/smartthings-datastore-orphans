...
--- @field public NAME string "SkipChannel" the name of this command
--- @field public count st.matter.data_types.Int16
local SkipChannel = {}

SkipChannel.NAME = "SkipChannel"
SkipChannel.ID = 0x0003
SkipChannel.field_defs = {
  {
    name = "count",
    field_id = 0,
    is_nullable = false,
...
function SkipChannel:build_test_command_response(device, endpoint_id, status)
...
---
--- @param self SkipChannel the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param count st.matter.data_types.Int16

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function SkipChannel:init(device, endpoint_id, count)
  local out = {}
  local args = {count}
  ...
  setmetatable(out, {
    __index = SkipChannel,
    __tostring = SkipChannel.pretty_print
  })
...
function SkipChannel:set_parent_cluster(cluster)
...
function SkipChannel:augment_type(base_type_obj)
  local elems = {}
...
function SkipChannel:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(SkipChannel, {__call = SkipChannel.init})
