...
-----------------------------------------------------------
-- Channel command ChangeChannelByNumber
-----------------------------------------------------------

--- @class st.matter.clusters.Channel.ChangeChannelByNumber
--- @alias ChangeChannelByNumber
---
--- @field public ID number 0x0002 the ID of this command
--- @field public NAME string "ChangeChannelByNumber" the name of this command
--- @field public major_number st.matter.data_types.Uint16
--- @field public minor_number st.matter.data_types.Uint16
local ChangeChannelByNumber = {}

ChangeChannelByNumber.NAME = "ChangeChannelByNumber"
ChangeChannelByNumber.ID = 0x0002
ChangeChannelByNumber.field_defs = {
  {
    name = "major_number",
    field_id = 0,
    is_nullable = false,
...
function ChangeChannelByNumber:build_test_command_response(device, endpoint_id, status)
...
---
--- @param self ChangeChannelByNumber the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param major_number st.matter.data_types.Uint16
--- @param minor_number st.matter.data_types.Uint16

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function ChangeChannelByNumber:init(device, endpoint_id, major_number, minor_number)
  local out = {}
  local args = {major_number, minor_number}
  ...
  setmetatable(out, {
    __index = ChangeChannelByNumber,
    __tostring = ChangeChannelByNumber.pretty_print
  })
...
function ChangeChannelByNumber:set_parent_cluster(cluster)
...
function ChangeChannelByNumber:augment_type(base_type_obj)
  local elems = {}
...
function ChangeChannelByNumber:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(ChangeChannelByNumber, {__call = ChangeChannelByNumber.init})
