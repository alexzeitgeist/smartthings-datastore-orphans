...
--- @field public NAME string "ChangeChannel" the name of this command
--- @field public match st.matter.data_types.UTF8String1
local ChangeChannel = {}

ChangeChannel.NAME = "ChangeChannel"
ChangeChannel.ID = 0x0000
ChangeChannel.field_defs = {
  {
    name = "match",
    field_id = 0,
    is_nullable = false,
...
--- Initialize the ChangeChannel command
---
--- @param self ChangeChannel the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param match st.matter.data_types.UTF8String1

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function ChangeChannel:init(device, endpoint_id, match)
  local out = {}
  local args = {match}
  ...
  setmetatable(out, {
    __index = ChangeChannel,
    __tostring = ChangeChannel.pretty_print
  })
...
function ChangeChannel:set_parent_cluster(cluster)
...
function ChangeChannel:augment_type(base_type_obj)
  local elems = {}
...
function ChangeChannel:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(ChangeChannel, {__call = ChangeChannel.init})
