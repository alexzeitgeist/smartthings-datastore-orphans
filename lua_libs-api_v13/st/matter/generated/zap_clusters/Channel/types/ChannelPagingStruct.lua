...
--- @alias ChannelPagingStruct
--- @class st.matter.clusters.Channel.types.ChannelPagingStruct: st.matter.data_types.Structure
---
--- @field public previous_token st.matter.generated.zap_clusters.Channel.types.PageTokenStruct
--- @field public next_token st.matter.generated.zap_clusters.Channel.types.PageTokenStruct
local ChannelPagingStruct = {}
local new_mt = StructureABC.new_mt({NAME = "ChannelPagingStruct", ID = data_types.name_to_id_map["Structure"]})

ChannelPagingStruct.field_defs = {
  {
    name = "previous_token",
    field_id = 0,
    is_nullable = true,
...
ChannelPagingStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
ChannelPagingStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = ChannelPagingStruct.init
new_mt.__index.serialize = ChannelPagingStruct.serialize

ChannelPagingStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(ChannelPagingStruct, new_mt)

return ChannelPagingStruct
