...
--- @field public call_sign st.matter.data_types.UTF8String1
--- @field public affiliate_call_sign st.matter.data_types.UTF8String1
--- @field public identifier st.matter.data_types.UTF8String1
--- @field public type st.matter.generated.zap_clusters.Channel.types.ChannelTypeEnum
local ChannelInfoStruct = {}
local new_mt = StructureABC.new_mt({NAME = "ChannelInfoStruct", ID = data_types.name_to_id_map["Structure"]})

ChannelInfoStruct.field_defs = {
  {
    name = "major_number",
    field_id = 0,
    is_nullable = false,
  ...
  },
  {
    ...
    is_nullable = false,
    is_optional = true,
    data_type = require "st.matter.generated.zap_clusters.Channel.types.ChannelTypeEnum",
  },
}

ChannelInfoStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
ChannelInfoStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = ChannelInfoStruct.init
new_mt.__index.serialize = ChannelInfoStruct.serialize

ChannelInfoStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(ChannelInfoStruct, new_mt)
