...
--- @field public role st.matter.data_types.UTF8String1
local ProgramCastStruct = {}
local new_mt = StructureABC.new_mt({NAME = "ProgramCastStruct", ID = data_types.name_to_id_map["Structure"]})

ProgramCastStruct.field_defs = {
  {
    name = "name",
    field_id = 0,
    is_nullable = false,
...
ProgramCastStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
ProgramCastStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = ProgramCastStruct.init
new_mt.__index.serialize = ProgramCastStruct.serialize

ProgramCastStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(ProgramCastStruct, new_mt)

return ProgramCastStruct
