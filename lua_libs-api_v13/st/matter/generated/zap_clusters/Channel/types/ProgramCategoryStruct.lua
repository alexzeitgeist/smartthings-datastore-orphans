...
--- @alias ProgramCategoryStruct
--- @class st.matter.clusters.Channel.types.ProgramCategoryStruct: st.matter.data_types.Structure
---
--- @field public category st.matter.data_types.UTF8String1
--- @field public sub_category st.matter.data_types.UTF8String1
local ProgramCategoryStruct = {}
local new_mt = StructureABC.new_mt({NAME = "ProgramCategoryStruct", ID = data_types.name_to_id_map["Structure"]})

ProgramCategoryStruct.field_defs = {
  {
    name = "category",
    field_id = 0,
    is_nullable = false,
...
ProgramCategoryStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
ProgramCategoryStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = ProgramCategoryStruct.init
new_mt.__index.serialize = ProgramCategoryStruct.serialize

ProgramCategoryStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(ProgramCategoryStruct, new_mt)

return ProgramCategoryStruct
