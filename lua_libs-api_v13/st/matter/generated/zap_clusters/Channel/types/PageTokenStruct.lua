...
--- @alias PageTokenStruct
--- @class st.matter.clusters.Channel.types.PageTokenStruct: st.matter.data_types.Structure
---
--- @field public limit st.matter.data_types.Uint16
--- @field public after st.matter.data_types.UTF8String1
--- @field public before st.matter.data_types.UTF8String1
local PageTokenStruct = {}
local new_mt = StructureABC.new_mt({NAME = "PageTokenStruct", ID = data_types.name_to_id_map["Structure"]})

PageTokenStruct.field_defs = {
  {
    name = "limit",
    field_id = 0,
    is_nullable = false,
...
PageTokenStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
PageTokenStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = PageTokenStruct.init
new_mt.__index.serialize = PageTokenStruct.serialize

PageTokenStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(PageTokenStruct, new_mt)

return PageTokenStruct
