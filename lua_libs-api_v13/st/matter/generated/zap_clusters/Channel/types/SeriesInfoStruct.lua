...
--- @alias SeriesInfoStruct
--- @class st.matter.clusters.Channel.types.SeriesInfoStruct: st.matter.data_types.Structure
---
--- @field public season st.matter.data_types.UTF8String1
--- @field public episode st.matter.data_types.UTF8String1
local SeriesInfoStruct = {}
local new_mt = StructureABC.new_mt({NAME = "SeriesInfoStruct", ID = data_types.name_to_id_map["Structure"]})

SeriesInfoStruct.field_defs = {
  {
    name = "season",
    field_id = 0,
    is_nullable = false,
...
SeriesInfoStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
SeriesInfoStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = SeriesInfoStruct.init
new_mt.__index.serialize = SeriesInfoStruct.serialize

SeriesInfoStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(SeriesInfoStruct, new_mt)

return SeriesInfoStruct
