...
--- @alias LineupInfoStruct
--- @class st.matter.clusters.Channel.types.LineupInfoStruct: st.matter.data_types.Structure
---
--- @field public operator_name st.matter.data_types.UTF8String1
--- @field public lineup_name st.matter.data_types.UTF8String1
--- @field public postal_code st.matter.data_types.UTF8String1
--- @field public lineup_info_type st.matter.generated.zap_clusters.Channel.types.LineupInfoTypeEnum
local LineupInfoStruct = {}
local new_mt = StructureABC.new_mt({NAME = "LineupInfoStruct", ID = data_types.name_to_id_map["Structure"]})

LineupInfoStruct.field_defs = {
  {
    name = "operator_name",
    field_id = 0,
    is_nullable = false,
  ...
  {
    name = "lineup_info_type",
    field_id = 3,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.Channel.types.LineupInfoTypeEnum",
  },
}

LineupInfoStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
LineupInfoStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = LineupInfoStruct.init
new_mt.__index.serialize = LineupInfoStruct.serialize

LineupInfoStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(LineupInfoStruct, new_mt)

return LineupInfoStruct
