...
local AdditionalInfoStruct = {}
local new_mt = StructureABC.new_mt({NAME = "AdditionalInfoStruct", ID = data_types.name_to_id_map["Structure"]})

AdditionalInfoStruct.field_defs = {
  {
    name = "name",
    field_id = 0,
    is_nullable = false,
...
AdditionalInfoStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
AdditionalInfoStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = AdditionalInfoStruct.init
new_mt.__index.serialize = AdditionalInfoStruct.serialize

AdditionalInfoStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(AdditionalInfoStruct, new_mt)

return AdditionalInfoStruct
