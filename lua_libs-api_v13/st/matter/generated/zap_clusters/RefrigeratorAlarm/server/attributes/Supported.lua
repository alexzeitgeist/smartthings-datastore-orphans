...
--- @field public data_type st.matter.generated.zap_clusters.RefrigeratorAlarm.types.AlarmBitmap the data type of this attribute

local Supported = {
  ID = 0x0003,
  NAME = "Supported",
  base_type = require "st.matter.generated.zap_clusters.RefrigeratorAlarm.types.AlarmBitmap",
}
...
--- @return st.matter.generated.zap_clusters.RefrigeratorAlarm.types.AlarmBitmap
