...
--- @field public active st.matter.generated.zap_clusters.RefrigeratorAlarm.types.AlarmBitmap
--- @field public inactive st.matter.generated.zap_clusters.RefrigeratorAlarm.types.AlarmBitmap
--- @field public state st.matter.generated.zap_clusters.RefrigeratorAlarm.types.AlarmBitmap
--- @field public mask st.matter.generated.zap_clusters.RefrigeratorAlarm.types.AlarmBitmap
local Notify = {
  ID = 0x0000,
  NAME = "Notify",
...
Notify.field_defs = {
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.RefrigeratorAlarm.types.AlarmBitmap",
  },
  {
    name = "inactive",
    field_id = 1,
