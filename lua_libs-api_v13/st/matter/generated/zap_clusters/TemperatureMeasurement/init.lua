...
do
  local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.TemperatureMeasurement.server.attributes")
  if has_aliases then
    for alias, _ in pairs(aliases) do
      TemperatureMeasurement.attribute_direction_map[alias] = "server"
    end
  end
end
...
do
  local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.TemperatureMeasurement.server.commands")
  if has_aliases then
    for alias, _ in pairs(aliases) do
      TemperatureMeasurement.command_direction_map[alias] = "server"
    end
  end
end

do
  local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.TemperatureMeasurement.client.commands")
  if has_aliases then
    for alias, _ in pairs(aliases) do
      TemperatureMeasurement.command_direction_map[alias] = "client"
    end
  end
end
