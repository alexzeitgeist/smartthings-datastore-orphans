...
-----------------------------------------------------------
-- ContentLauncher command LaunchURL
-----------------------------------------------------------
...
--- @field public NAME string "LaunchURL" the name of this command
--- @field public contenturl st.matter.data_types.UTF8String1
--- @field public display_string st.matter.data_types.UTF8String1
--- @field public branding_information st.matter.generated.zap_clusters.ContentLauncher.types.BrandingInformationStruct
local LaunchURL = {}

LaunchURL.NAME = "LaunchURL"
LaunchURL.ID = 0x0001
LaunchURL.field_defs = {
  {
    name = "contenturl",
    field_id = 0,
    is_nullable = false,
  ...
  {
    name = "branding_information",
    field_id = 2,
    is_nullable = false,
    is_optional = true,
    data_type = require "st.matter.generated.zap_clusters.ContentLauncher.types.BrandingInformationStruct",
  },
}
...
--- Initialize the LaunchURL command
---
--- @param self LaunchURL the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param contenturl st.matter.data_types.UTF8String1
--- @param display_string st.matter.data_types.UTF8String1
--- @param branding_information st.matter.generated.zap_clusters.ContentLauncher.types.BrandingInformationStruct

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function LaunchURL:init(device, endpoint_id, contenturl, display_string, branding_information)
  local out = {}
  local args = {contenturl, display_string, branding_information}
  ...
  setmetatable(out, {
    __index = LaunchURL,
    __tostring = LaunchURL.pretty_print
  })
...
function LaunchURL:set_parent_cluster(cluster)
...
function LaunchURL:augment_type(base_type_obj)
  local elems = {}
...
function LaunchURL:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(LaunchURL, {__call = LaunchURL.init})
