...
--- @alias SupportedStreamingProtocols
---
--- @field public ID number 0x0001 the ID of this attribute
--- @field public NAME string "SupportedStreamingProtocols" the name of this attribute
--- @field public data_type st.matter.generated.zap_clusters.ContentLauncher.types.SupportedProtocolsBitmap the data type of this attribute

local SupportedStreamingProtocols = {
  ID = 0x0001,
  NAME = "SupportedStreamingProtocols",
  base_type = require "st.matter.generated.zap_clusters.ContentLauncher.types.SupportedProtocolsBitmap",
}
...
--- @return st.matter.generated.zap_clusters.ContentLauncher.types.SupportedProtocolsBitmap
function SupportedStreamingProtocols:new_value(...)
...
function SupportedStreamingProtocols:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function SupportedStreamingProtocols:subscribe(device, endpoint_id)
...
function SupportedStreamingProtocols:set_parent_cluster(cluster)
...
function SupportedStreamingProtocols:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function SupportedStreamingProtocols:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(SupportedStreamingProtocols, {__call = SupportedStreamingProtocols.new_value, __index = SupportedStreamingProtocols.base_type})
