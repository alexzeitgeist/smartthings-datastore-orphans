...
--- @alias ParameterStruct
--- @class st.matter.clusters.ContentLauncher.types.ParameterStruct: st.matter.data_types.Structure
---
--- @field public type st.matter.generated.zap_clusters.ContentLauncher.types.ParameterEnum
--- @field public value st.matter.data_types.UTF8String1
--- @field public external_id_list st.matter.data_types.Array
local ParameterStruct = {}
local new_mt = StructureABC.new_mt({NAME = "ParameterStruct", ID = data_types.name_to_id_map["Structure"]})

ParameterStruct.field_defs = {
  {
    name = "type",
    field_id = 0,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.ContentLauncher.types.ParameterEnum",
  },
  {
    name = "value",
    field_id = 1,
  ...
  },
  {
    ...
    element_type = require "st.matter.generated.zap_clusters.ContentLauncher.types.AdditionalInfoStruct",
  },
}

ParameterStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
ParameterStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = ParameterStruct.init
new_mt.__index.serialize = ParameterStruct.serialize

ParameterStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(ParameterStruct, new_mt)
