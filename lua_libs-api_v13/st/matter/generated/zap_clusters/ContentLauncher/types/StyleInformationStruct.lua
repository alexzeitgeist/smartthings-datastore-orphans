...
--- @alias StyleInformationStruct
--- @class st.matter.clusters.ContentLauncher.types.StyleInformationStruct: st.matter.data_types.Structure
---
--- @field public image_url st.matter.data_types.UTF8String1
--- @field public color st.matter.data_types.UTF8String1
--- @field public size st.matter.generated.zap_clusters.ContentLauncher.types.DimensionStruct
local StyleInformationStruct = {}
local new_mt = StructureABC.new_mt({NAME = "StyleInformationStruct", ID = data_types.name_to_id_map["Structure"]})

StyleInformationStruct.field_defs = {
  {
    name = "image_url",
    field_id = 0,
    is_nullable = false,
  ...
  },
  {
    ...
    is_nullable = false,
    is_optional = true,
    data_type = require "st.matter.generated.zap_clusters.ContentLauncher.types.DimensionStruct",
  },
}

StyleInformationStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
StyleInformationStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = StyleInformationStruct.init
new_mt.__index.serialize = StyleInformationStruct.serialize

StyleInformationStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(StyleInformationStruct, new_mt)

return StyleInformationStruct
