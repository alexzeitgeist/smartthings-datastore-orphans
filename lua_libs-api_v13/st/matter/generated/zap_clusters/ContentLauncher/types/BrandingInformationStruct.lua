...
--- @alias BrandingInformationStruct
--- @class st.matter.clusters.ContentLauncher.types.BrandingInformationStruct: st.matter.data_types.Structure
---
--- @field public provider_name st.matter.data_types.UTF8String1
--- @field public background st.matter.generated.zap_clusters.ContentLauncher.types.StyleInformationStruct
--- @field public logo st.matter.generated.zap_clusters.ContentLauncher.types.StyleInformationStruct
--- @field public progress_bar st.matter.generated.zap_clusters.ContentLauncher.types.StyleInformationStruct
--- @field public splash st.matter.generated.zap_clusters.ContentLauncher.types.StyleInformationStruct
--- @field public water_mark st.matter.generated.zap_clusters.ContentLauncher.types.StyleInformationStruct
local BrandingInformationStruct = {}
local new_mt = StructureABC.new_mt({NAME = "BrandingInformationStruct", ID = data_types.name_to_id_map["Structure"]})

BrandingInformationStruct.field_defs = {
  {
    name = "provider_name",
    field_id = 0,
    is_nullable = false,
  ...
  },
  {
    ...
    is_nullable = false,
    is_optional = true,
    data_type = require "st.matter.generated.zap_clusters.ContentLauncher.types.StyleInformationStruct",
  },
  {
    name = "logo",
    field_id = 2,
...
BrandingInformationStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
BrandingInformationStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = BrandingInformationStruct.init
new_mt.__index.serialize = BrandingInformationStruct.serialize

BrandingInformationStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(BrandingInformationStruct, new_mt)

return BrandingInformationStruct
