...
--- @alias PlaybackPreferencesStruct
--- @class st.matter.clusters.ContentLauncher.types.PlaybackPreferencesStruct: st.matter.data_types.Structure
---
--- @field public playback_position st.matter.data_types.Uint64
--- @field public text_track st.matter.generated.zap_clusters.ContentLauncher.types.TrackPreferenceStruct
--- @field public audio_tracks st.matter.data_types.Array
local PlaybackPreferencesStruct = {}
local new_mt = StructureABC.new_mt({NAME = "PlaybackPreferencesStruct", ID = data_types.name_to_id_map["Structure"]})

PlaybackPreferencesStruct.field_defs = {
  {
  ...
  },
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.ContentLauncher.types.TrackPreferenceStruct",
  },
  {
    name = "audio_tracks",
    field_id = 2,
    ...
    element_type = require "st.matter.generated.zap_clusters.ContentLauncher.types.TrackPreferenceStruct",
  },
}

PlaybackPreferencesStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
PlaybackPreferencesStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = PlaybackPreferencesStruct.init
new_mt.__index.serialize = PlaybackPreferencesStruct.serialize

PlaybackPreferencesStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(PlaybackPreferencesStruct, new_mt)

return PlaybackPreferencesStruct
