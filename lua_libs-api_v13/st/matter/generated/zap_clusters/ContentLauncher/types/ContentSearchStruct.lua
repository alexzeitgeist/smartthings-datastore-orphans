...
--- @alias ContentSearchStruct
--- @class st.matter.clusters.ContentLauncher.types.ContentSearchStruct: st.matter.data_types.Structure
---
--- @field public parameter_list st.matter.data_types.Array
local ContentSearchStruct = {}
local new_mt = StructureABC.new_mt({NAME = "ContentSearchStruct", ID = data_types.name_to_id_map["Structure"]})

ContentSearchStruct.field_defs = {
  {
    name = "parameter_list",
    field_id = 0,
    is_nullable = false,
    ...
    element_type = require "st.matter.generated.zap_clusters.ContentLauncher.types.ParameterStruct",
  },
}

ContentSearchStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
ContentSearchStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = ContentSearchStruct.init
new_mt.__index.serialize = ContentSearchStruct.serialize

ContentSearchStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(ContentSearchStruct, new_mt)

return ContentSearchStruct
