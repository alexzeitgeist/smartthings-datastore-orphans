...
--- @alias DimensionStruct
--- @class st.matter.clusters.ContentLauncher.types.DimensionStruct: st.matter.data_types.Structure
---
--- @field public width st.matter.data_types.DoublePrecisionFloat
--- @field public height st.matter.data_types.DoublePrecisionFloat
--- @field public metric st.matter.generated.zap_clusters.ContentLauncher.types.MetricTypeEnum
local DimensionStruct = {}
local new_mt = StructureABC.new_mt({NAME = "DimensionStruct", ID = data_types.name_to_id_map["Structure"]})

DimensionStruct.field_defs = {
  {
    name = "width",
    field_id = 0,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.data_types.DoublePrecisionFloat",
  },
  {
    name = "height",
    field_id = 1,
  ...
  },
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.ContentLauncher.types.MetricTypeEnum",
  },
}

DimensionStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
DimensionStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = DimensionStruct.init
new_mt.__index.serialize = DimensionStruct.serialize

DimensionStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(DimensionStruct, new_mt)

return DimensionStruct
