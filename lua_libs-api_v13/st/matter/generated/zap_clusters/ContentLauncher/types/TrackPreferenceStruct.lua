...
--- @alias TrackPreferenceStruct
--- @class st.matter.clusters.ContentLauncher.types.TrackPreferenceStruct: st.matter.data_types.Structure
---
--- @field public language_code st.matter.data_types.UTF8String1
--- @field public characteristics st.matter.data_types.Array
--- @field public audio_output_index st.matter.data_types.Uint8
local TrackPreferenceStruct = {}
local new_mt = StructureABC.new_mt({NAME = "TrackPreferenceStruct", ID = data_types.name_to_id_map["Structure"]})

TrackPreferenceStruct.field_defs = {
  {
    name = "language_code",
    field_id = 0,
    is_nullable = false,
  ...
  },
  {
    ...
    element_type = require "st.matter.generated.zap_clusters.ContentLauncher.types.CharacteristicEnum",
  },
  {
...
TrackPreferenceStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
TrackPreferenceStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = TrackPreferenceStruct.init
new_mt.__index.serialize = TrackPreferenceStruct.serialize

TrackPreferenceStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(TrackPreferenceStruct, new_mt)

return TrackPreferenceStruct
