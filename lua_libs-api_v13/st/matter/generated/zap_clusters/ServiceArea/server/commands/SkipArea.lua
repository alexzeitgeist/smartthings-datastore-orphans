...
--- @field public NAME string "SkipArea" the name of this command
--- @field public skipped_area st.matter.data_types.Uint32
local SkipArea = {}

SkipArea.NAME = "SkipArea"
SkipArea.ID = 0x0002
SkipArea.field_defs = {
  {
    name = "skipped_area",
...
--- Initialize the SkipArea command
---
--- @param self SkipArea the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param skipped_area st.matter.data_types.Uint32

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function SkipArea:init(device, endpoint_id, skipped_area)
  local out = {}
  local args = {skipped_area}
  ...
  setmetatable(out, {
    __index = SkipArea,
    __tostring = SkipArea.pretty_print
  })
...
function SkipArea:set_parent_cluster(cluster)
...
function SkipArea:augment_type(base_type_obj)
  local elems = {}
...
function SkipArea:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(SkipArea, {__call = SkipArea.init})
