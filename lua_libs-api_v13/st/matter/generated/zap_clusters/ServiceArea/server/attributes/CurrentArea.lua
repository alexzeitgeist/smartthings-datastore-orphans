...
--- @field public NAME string "CurrentArea" the name of this attribute
...
function CurrentArea:new_value(...)
...
function CurrentArea:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function CurrentArea:subscribe(device, endpoint_id)
...
function CurrentArea:set_parent_cluster(cluster)
...
function CurrentArea:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function CurrentArea:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(CurrentArea, {__call = CurrentArea.new_value, __index = CurrentArea.base_type})
return CurrentArea
