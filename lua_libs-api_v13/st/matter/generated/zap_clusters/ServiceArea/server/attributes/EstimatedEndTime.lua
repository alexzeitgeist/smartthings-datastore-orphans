...
function EstimatedEndTime:new_value(...)
...
function EstimatedEndTime:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function EstimatedEndTime:subscribe(device, endpoint_id)
...
function EstimatedEndTime:set_parent_cluster(cluster)
...
function EstimatedEndTime:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function EstimatedEndTime:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(EstimatedEndTime, {__call = EstimatedEndTime.new_value, __index = EstimatedEndTime.base_type})
