...
--- @field public status st.matter.generated.zap_clusters.ServiceArea.types.SelectAreasStatus
...
SelectAreasResponse.field_defs = {
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.ServiceArea.types.SelectAreasStatus",
  },
  {
    name = "status_text",
    field_id = 1,
...
--- @param status st.matter.generated.zap_clusters.ServiceArea.types.SelectAreasStatus
