...
-----------------------------------------------------------
-- ServiceArea command SkipAreaResponse
-----------------------------------------------------------

--- @class st.matter.clusters.ServiceArea.SkipAreaResponse
--- @alias SkipAreaResponse
---
--- @field public ID number 0x0003 the ID of this command
--- @field public NAME string "SkipAreaResponse" the name of this command
--- @field public status st.matter.generated.zap_clusters.ServiceArea.types.SkipAreaStatus
--- @field public status_text st.matter.data_types.UTF8String1
local SkipAreaResponse = {}

SkipAreaResponse.NAME = "SkipAreaResponse"
SkipAreaResponse.ID = 0x0003
SkipAreaResponse.field_defs = {
  {
    name = "status",
    field_id = 0,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.ServiceArea.types.SkipAreaStatus",
  },
  {
    name = "status_text",
    field_id = 1,
...
function SkipAreaResponse:augment_type(base_type_obj)
  local elems = {}
...
--- @param status st.matter.generated.zap_clusters.ServiceArea.types.SkipAreaStatus
...
function SkipAreaResponse:build_test_command_response(device, endpoint_id, status, status_text, interaction_status)
  local function init(self, device, endpoint_id, status, status_text)
    ...
    setmetatable(out, {
      __index = SkipAreaResponse,
      __tostring = SkipAreaResponse.pretty_print
    })
...
---
--- @return nil
function SkipAreaResponse:init()
  return nil
end

function SkipAreaResponse:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

function SkipAreaResponse:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(SkipAreaResponse, {__call = SkipAreaResponse.init})
