...
--- @field public status st.matter.generated.zap_clusters.ServiceArea.types.OperationalStatusEnum
--- @field public total_operational_time st.matter.data_types.Uint32
--- @field public estimated_time st.matter.data_types.Uint32
local ProgressStruct = {}
local new_mt = StructureABC.new_mt({NAME = "ProgressStruct", ID = data_types.name_to_id_map["Structure"]})

ProgressStruct.field_defs = {
  {
    name = "area_id",
    field_id = 0,
    is_nullable = false,
  ...
  },
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.ServiceArea.types.OperationalStatusEnum",
  },
  {
...
ProgressStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
ProgressStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = ProgressStruct.init
new_mt.__index.serialize = ProgressStruct.serialize

ProgressStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(ProgressStruct, new_mt)
