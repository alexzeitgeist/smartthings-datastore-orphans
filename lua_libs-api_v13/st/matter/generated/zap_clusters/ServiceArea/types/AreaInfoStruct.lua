...
---
--- @field public location_info st.matter.generated.zap_clusters.Global.types.LocationDescriptorStruct
--- @field public landmark_info st.matter.generated.zap_clusters.ServiceArea.types.LandmarkInfoStruct
...
AreaInfoStruct.field_defs = {
  {
    ...
    is_nullable = true,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.Global.types.LocationDescriptorStruct",
  },
  {
    name = "landmark_info",
    field_id = 1,
    is_nullable = true,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.ServiceArea.types.LandmarkInfoStruct",
  },
}
