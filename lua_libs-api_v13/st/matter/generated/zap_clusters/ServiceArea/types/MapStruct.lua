...
local MapStruct = {}
local new_mt = StructureABC.new_mt({NAME = "MapStruct", ID = data_types.name_to_id_map["Structure"]})

MapStruct.field_defs = {
  {
    name = "map_id",
    field_id = 0,
    is_nullable = false,
...
MapStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
MapStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = MapStruct.init
new_mt.__index.serialize = MapStruct.serialize

MapStruct.augment_type = function(self, val)
  local elems = {}
