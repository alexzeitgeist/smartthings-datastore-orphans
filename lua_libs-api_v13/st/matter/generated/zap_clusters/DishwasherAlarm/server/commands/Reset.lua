...
-----------------------------------------------------------
-- DishwasherAlarm command Reset
-----------------------------------------------------------

--- @class st.matter.clusters.DishwasherAlarm.Reset
--- @alias Reset
---
--- @field public ID number 0x0000 the ID of this command
--- @field public NAME string "Reset" the name of this command
--- @field public alarms st.matter.generated.zap_clusters.DishwasherAlarm.types.AlarmBitmap
local Reset = {}
...
function Reset:build_test_command_response(device, endpoint_id, status)
...
---
--- @param self Reset the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param alarms st.matter.generated.zap_clusters.DishwasherAlarm.types.AlarmBitmap

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function Reset:init(device, endpoint_id, alarms)
  local out = {}
  local args = {alarms}
...
function Reset:set_parent_cluster(cluster)
...
function Reset:augment_type(base_type_obj)
  local elems = {}
...
function Reset:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(Reset, {__call = Reset.init})
