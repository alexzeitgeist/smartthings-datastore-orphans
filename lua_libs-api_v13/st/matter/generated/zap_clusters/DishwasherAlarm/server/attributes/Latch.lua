...
--- @class st.matter.clusters.DishwasherAlarm.Latch
--- @alias Latch
---
--- @field public ID number 0x0001 the ID of this attribute
--- @field public NAME string "Latch" the name of this attribute
--- @field public data_type st.matter.generated.zap_clusters.DishwasherAlarm.types.AlarmBitmap the data type of this attribute

local Latch = {
  ID = 0x0001,
  NAME = "Latch",
  base_type = require "st.matter.generated.zap_clusters.DishwasherAlarm.types.AlarmBitmap",
}
...
--- @return st.matter.generated.zap_clusters.DishwasherAlarm.types.AlarmBitmap
function Latch:new_value(...)
...
function Latch:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Latch:subscribe(device, endpoint_id)
...
function Latch:set_parent_cluster(cluster)
...
function Latch:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Latch:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(Latch, {__call = Latch.new_value, __index = Latch.base_type})
return Latch
