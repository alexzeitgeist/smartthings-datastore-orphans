...
--- @class st.matter.clusters.DishwasherAlarm.Notify
--- @alias Notify
---
--- @field public ID number 0x0000 the ID of this event
--- @field public NAME string "Notify" the name of this event
--- @field public active st.matter.generated.zap_clusters.DishwasherAlarm.types.AlarmBitmap
--- @field public inactive st.matter.generated.zap_clusters.DishwasherAlarm.types.AlarmBitmap
--- @field public state st.matter.generated.zap_clusters.DishwasherAlarm.types.AlarmBitmap
--- @field public mask st.matter.generated.zap_clusters.DishwasherAlarm.types.AlarmBitmap
local Notify = {
  ID = 0x0000,
  NAME = "Notify",
...
Notify.field_defs = {
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.DishwasherAlarm.types.AlarmBitmap",
  },
  {
    name = "inactive",
    field_id = 1,
...
function Notify:augment_type(base_type_obj)
  local elems = {}
...
function Notify:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function Notify:subscribe(device, endpoint_id)
...
function Notify:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "NotifyEventData", ID = 0x15}))
...
function Notify:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function Notify:set_parent_cluster(cluster)
