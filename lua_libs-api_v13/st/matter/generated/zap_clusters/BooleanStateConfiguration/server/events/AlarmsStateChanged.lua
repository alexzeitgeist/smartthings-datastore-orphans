...
--- @alias AlarmsStateChanged
---
--- @field public ID number 0x0000 the ID of this event
--- @field public NAME string "AlarmsStateChanged" the name of this event
--- @field public alarms_active st.matter.generated.zap_clusters.BooleanStateConfiguration.types.AlarmModeBitmap
--- @field public alarms_suppressed st.matter.generated.zap_clusters.BooleanStateConfiguration.types.AlarmModeBitmap
local AlarmsStateChanged = {
  ID = 0x0000,
  NAME = "AlarmsStateChanged",
  base_type = data_types.Structure,
}

AlarmsStateChanged.field_defs = {
  {
    name = "alarms_active",
    field_id = 0,
    is_nullable = false,
...
function AlarmsStateChanged:augment_type(base_type_obj)
  local elems = {}
...
function AlarmsStateChanged:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function AlarmsStateChanged:subscribe(device, endpoint_id)
...
function AlarmsStateChanged:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "AlarmsStateChangedEventData", ID = 0x15}))
...
function AlarmsStateChanged:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function AlarmsStateChanged:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

return AlarmsStateChanged
