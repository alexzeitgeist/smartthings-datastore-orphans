...
--- @field public NAME string "SensorFault" the name of this event
--- @field public sensor_fault st.matter.generated.zap_clusters.BooleanStateConfiguration.types.SensorFaultBitmap
local SensorFault = {
  ID = 0x0001,
  NAME = "SensorFault",
...
SensorFault.field_defs = {
  {
    name = "sensor_fault",
    field_id = 0,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.BooleanStateConfiguration.types.SensorFaultBitmap",
  },
}
--- Add field names to each event field
---
--- @param base_type_obj st.matter.data_types.Structure
function SensorFault:augment_type(base_type_obj)
  local elems = {}
...
--- Builds an SensorFault test event report reponse to be used by
...
function SensorFault:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "SensorFaultEventData", ID = 0x15}))
