...
--- @field public NAME string "SensorFault" the name of this attribute
--- @field public data_type st.matter.generated.zap_clusters.BooleanStateConfiguration.types.SensorFaultBitmap the data type of this attribute

local SensorFault = {
  ID = 0x0007,
  NAME = "SensorFault",
  base_type = require "st.matter.generated.zap_clusters.BooleanStateConfiguration.types.SensorFaultBitmap",
}
...
---
--- @vararg vararg the values needed to construct a SensorFaultBitmap
--- @return st.matter.generated.zap_clusters.BooleanStateConfiguration.types.SensorFaultBitmap
