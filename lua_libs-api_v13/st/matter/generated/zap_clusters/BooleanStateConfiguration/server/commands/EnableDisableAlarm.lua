...
-----------------------------------------------------------
-- BooleanStateConfiguration command EnableDisableAlarm
-----------------------------------------------------------

--- @class st.matter.clusters.BooleanStateConfiguration.EnableDisableAlarm
--- @alias EnableDisableAlarm
---
--- @field public ID number 0x0001 the ID of this command
--- @field public NAME string "EnableDisableAlarm" the name of this command
--- @field public alarms_to_enable_disable st.matter.generated.zap_clusters.BooleanStateConfiguration.types.AlarmModeBitmap
local EnableDisableAlarm = {}

EnableDisableAlarm.NAME = "EnableDisableAlarm"
EnableDisableAlarm.ID = 0x0001
EnableDisableAlarm.field_defs = {
  {
    name = "alarms_to_enable_disable",
    field_id = 0,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.BooleanStateConfiguration.types.AlarmModeBitmap",
  },
}
...
function EnableDisableAlarm:build_test_command_response(device, endpoint_id, status)
...
---
--- @param self EnableDisableAlarm the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param alarms_to_enable_disable st.matter.generated.zap_clusters.BooleanStateConfiguration.types.AlarmModeBitmap

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function EnableDisableAlarm:init(device, endpoint_id, alarms_to_enable_disable)
  local out = {}
  local args = {alarms_to_enable_disable}
  ...
  setmetatable(out, {
    __index = EnableDisableAlarm,
    __tostring = EnableDisableAlarm.pretty_print
  })
...
function EnableDisableAlarm:set_parent_cluster(cluster)
...
function EnableDisableAlarm:augment_type(base_type_obj)
  local elems = {}
...
function EnableDisableAlarm:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(EnableDisableAlarm, {__call = EnableDisableAlarm.init})
