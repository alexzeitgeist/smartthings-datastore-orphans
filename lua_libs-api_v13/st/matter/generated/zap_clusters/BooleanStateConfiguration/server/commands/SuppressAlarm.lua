...
-----------------------------------------------------------
-- BooleanStateConfiguration command SuppressAlarm
-----------------------------------------------------------
...
--- @field public NAME string "SuppressAlarm" the name of this command
--- @field public alarms_to_suppress st.matter.generated.zap_clusters.BooleanStateConfiguration.types.AlarmModeBitmap
local SuppressAlarm = {}

SuppressAlarm.NAME = "SuppressAlarm"
SuppressAlarm.ID = 0x0000
SuppressAlarm.field_defs = {
  {
    name = "alarms_to_suppress",
    field_id = 0,
    is_nullable = false,
    is_optional = false,
...
function SuppressAlarm:build_test_command_response(device, endpoint_id, status)
...
---
--- @param self SuppressAlarm the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param alarms_to_suppress st.matter.generated.zap_clusters.BooleanStateConfiguration.types.AlarmModeBitmap

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function SuppressAlarm:init(device, endpoint_id, alarms_to_suppress)
  local out = {}
  local args = {alarms_to_suppress}
  ...
  setmetatable(out, {
    __index = SuppressAlarm,
    __tostring = SuppressAlarm.pretty_print
  })
...
function SuppressAlarm:set_parent_cluster(cluster)
...
function SuppressAlarm:augment_type(base_type_obj)
  local elems = {}
...
function SuppressAlarm:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(SuppressAlarm, {__call = SuppressAlarm.init})
