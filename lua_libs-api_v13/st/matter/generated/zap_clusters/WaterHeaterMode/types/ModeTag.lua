...
--- @class st.matter.clusters.WaterHeaterMode.types.ModeTag: st.matter.data_types.Uint16
--- @alias ModeTag
---
...
--- @field public OFF number 16384
--- @field public MANUAL number 16385
--- @field public TIMED number 16386
...
new_mt.__index.OFF  = 0x4000
new_mt.__index.MANUAL  = 0x4001
new_mt.__index.TIMED  = 0x4002
...
ModeTag.DAY  = 0x09
ModeTag.OFF  = 0x4000
ModeTag.MANUAL  = 0x4001
ModeTag.TIMED  = 0x4002
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.WaterHeaterMode.types.ModeTag")
if has_aliases then
