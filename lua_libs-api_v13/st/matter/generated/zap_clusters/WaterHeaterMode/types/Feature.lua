...
--- @class st.matter.clusters.WaterHeaterMode.types.Feature
--- @alias Feature
---
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.WaterHeaterMode.types.Feature")
if has_aliases then
