...
--- @class st.matter.clusters.EnergyEvse.EVNotDetected
--- @alias EVNotDetected
---
--- @field public ID number 0x0001 the ID of this event
--- @field public NAME string "EVNotDetected" the name of this event
...
--- @field public session_duration st.matter.data_types.Uint32
--- @field public session_energy_charged st.matter.data_types.Int64
--- @field public session_energy_discharged st.matter.data_types.Int64
local EVNotDetected = {
  ID = 0x0001,
  NAME = "EVNotDetected",
