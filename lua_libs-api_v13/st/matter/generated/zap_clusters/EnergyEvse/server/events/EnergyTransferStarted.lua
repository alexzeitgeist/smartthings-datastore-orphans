...
--- @class st.matter.clusters.EnergyEvse.EnergyTransferStarted
--- @alias EnergyTransferStarted
---
--- @field public ID number 0x0002 the ID of this event
--- @field public NAME string "EnergyTransferStarted" the name of this event
...
--- @field public maximum_current st.matter.data_types.Int64
