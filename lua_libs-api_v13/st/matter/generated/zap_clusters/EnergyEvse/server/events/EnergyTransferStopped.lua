...
--- @class st.matter.clusters.EnergyEvse.EnergyTransferStopped
--- @alias EnergyTransferStopped
---
--- @field public ID number 0x0003 the ID of this event
--- @field public NAME string "EnergyTransferStopped" the name of this event
--- @field public sessionid st.matter.data_types.Uint32
--- @field public state st.matter.generated.zap_clusters.EnergyEvse.types.StateEnum
--- @field public reason st.matter.generated.zap_clusters.EnergyEvse.types.EnergyTransferStoppedReasonEnum
--- @field public energy_transferred st.matter.data_types.Int64
--- @field public energy_discharged st.matter.data_types.Int64
...
EnergyTransferStopped.field_defs = {
  ...
  },
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.EnergyEvse.types.StateEnum",
  },
  {
    name = "reason",
    field_id = 2,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.EnergyEvse.types.EnergyTransferStoppedReasonEnum",
  },
  {
