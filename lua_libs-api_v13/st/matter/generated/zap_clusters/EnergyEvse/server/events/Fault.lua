...
--- @class st.matter.clusters.EnergyEvse.Fault
--- @alias Fault
---
--- @field public ID number 0x0004 the ID of this event
--- @field public NAME string "Fault" the name of this event
...
--- @field public fault_state_previous_state st.matter.generated.zap_clusters.EnergyEvse.types.FaultStateEnum
--- @field public fault_state_current_state st.matter.generated.zap_clusters.EnergyEvse.types.FaultStateEnum
local Fault = {
  ID = 0x0004,
  NAME = "Fault",
...
Fault.field_defs = {
  ...
  },
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.EnergyEvse.types.FaultStateEnum",
  },
  {
