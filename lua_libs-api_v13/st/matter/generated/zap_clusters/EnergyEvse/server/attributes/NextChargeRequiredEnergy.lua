...
--- @class st.matter.clusters.EnergyEvse.NextChargeRequiredEnergy
--- @alias NextChargeRequiredEnergy
---
--- @field public ID number 0x0025 the ID of this attribute
--- @field public NAME string "NextChargeRequiredEnergy" the name of this attribute
...
setmetatable(NextChargeRequiredEnergy, {__call = NextChargeRequiredEnergy.new_value, __index = NextChargeRequiredEnergy.base_type})
