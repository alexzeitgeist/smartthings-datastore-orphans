...
--- @class st.matter.clusters.EnergyEvse.FaultState
--- @alias FaultState
---
--- @field public ID number 0x0002 the ID of this attribute
--- @field public NAME string "FaultState" the name of this attribute
--- @field public data_type st.matter.generated.zap_clusters.EnergyEvse.types.FaultStateEnum the data type of this attribute

local FaultState = {
  ID = 0x0002,
  NAME = "FaultState",
  base_type = require "st.matter.generated.zap_clusters.EnergyEvse.types.FaultStateEnum",
}
...
---
--- @vararg vararg the values needed to construct a FaultStateEnum
--- @return st.matter.generated.zap_clusters.EnergyEvse.types.FaultStateEnum
...
setmetatable(FaultState, {__call = FaultState.new_value, __index = FaultState.base_type})
return FaultState
