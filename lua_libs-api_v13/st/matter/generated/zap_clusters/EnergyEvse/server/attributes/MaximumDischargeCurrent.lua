...
--- @class st.matter.clusters.EnergyEvse.MaximumDischargeCurrent
--- @alias MaximumDischargeCurrent
---
--- @field public ID number 0x0008 the ID of this attribute
--- @field public NAME string "MaximumDischargeCurrent" the name of this attribute
...
setmetatable(MaximumDischargeCurrent, {__call = MaximumDischargeCurrent.new_value, __index = MaximumDischargeCurrent.base_type})
