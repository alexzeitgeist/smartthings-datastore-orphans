...
--- @class st.matter.clusters.EnergyEvse.State
--- @alias State
---
--- @field public ID number 0x0000 the ID of this attribute
--- @field public NAME string "State" the name of this attribute
--- @field public data_type st.matter.generated.zap_clusters.EnergyEvse.types.StateEnum the data type of this attribute

local State = {
  ID = 0x0000,
  NAME = "State",
  base_type = require "st.matter.generated.zap_clusters.EnergyEvse.types.StateEnum",
}
...
---
--- @vararg vararg the values needed to construct a StateEnum
--- @return st.matter.generated.zap_clusters.EnergyEvse.types.StateEnum
