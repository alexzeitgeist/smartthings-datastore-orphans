...
--- @class st.matter.clusters.EnergyEvse.SessionDuration
--- @alias SessionDuration
---
--- @field public ID number 0x0041 the ID of this attribute
--- @field public NAME string "SessionDuration" the name of this attribute
...
setmetatable(SessionDuration, {__call = SessionDuration.new_value, __index = SessionDuration.base_type})
