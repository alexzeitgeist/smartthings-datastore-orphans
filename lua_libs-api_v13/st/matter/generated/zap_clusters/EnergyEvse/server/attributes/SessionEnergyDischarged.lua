...
--- @class st.matter.clusters.EnergyEvse.SessionEnergyDischarged
--- @alias SessionEnergyDischarged
---
--- @field public ID number 0x0043 the ID of this attribute
--- @field public NAME string "SessionEnergyDischarged" the name of this attribute
...
setmetatable(SessionEnergyDischarged, {__call = SessionEnergyDischarged.new_value, __index = SessionEnergyDischarged.base_type})
