...
--- @class st.matter.clusters.EnergyEvse.MinimumChargeCurrent
--- @alias MinimumChargeCurrent
---
--- @field public ID number 0x0006 the ID of this attribute
--- @field public NAME string "MinimumChargeCurrent" the name of this attribute
...
setmetatable(MinimumChargeCurrent, {__call = MinimumChargeCurrent.new_value, __index = MinimumChargeCurrent.base_type})
