...
--- @class st.matter.clusters.EnergyEvse.UserMaximumChargeCurrent
--- @alias UserMaximumChargeCurrent
---
--- @field public ID number 0x0009 the ID of this attribute
--- @field public NAME string "UserMaximumChargeCurrent" the name of this attribute
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.data_types.Int64 the value to write
...
setmetatable(UserMaximumChargeCurrent, {__call = UserMaximumChargeCurrent.new_value, __index = UserMaximumChargeCurrent.base_type})
