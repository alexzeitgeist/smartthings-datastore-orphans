...
--- @class st.matter.clusters.EnergyEvse.SupplyState
--- @alias SupplyState
---
--- @field public ID number 0x0001 the ID of this attribute
--- @field public NAME string "SupplyState" the name of this attribute
--- @field public data_type st.matter.generated.zap_clusters.EnergyEvse.types.SupplyStateEnum the data type of this attribute

local SupplyState = {
  ID = 0x0001,
  NAME = "SupplyState",
  base_type = require "st.matter.generated.zap_clusters.EnergyEvse.types.SupplyStateEnum",
}
...
---
--- @vararg vararg the values needed to construct a SupplyStateEnum
--- @return st.matter.generated.zap_clusters.EnergyEvse.types.SupplyStateEnum
...
setmetatable(SupplyState, {__call = SupplyState.new_value, __index = SupplyState.base_type})
return SupplyState
