...
--- @class st.matter.clusters.EnergyEvse.NextChargeTargetTime
--- @alias NextChargeTargetTime
---
--- @field public ID number 0x0024 the ID of this attribute
--- @field public NAME string "NextChargeTargetTime" the name of this attribute
...
setmetatable(NextChargeTargetTime, {__call = NextChargeTargetTime.new_value, __index = NextChargeTargetTime.base_type})
