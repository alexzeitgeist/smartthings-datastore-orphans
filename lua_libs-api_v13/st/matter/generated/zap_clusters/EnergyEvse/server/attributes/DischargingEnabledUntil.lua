...
--- @class st.matter.clusters.EnergyEvse.DischargingEnabledUntil
--- @alias DischargingEnabledUntil
---
--- @field public ID number 0x0004 the ID of this attribute
--- @field public NAME string "DischargingEnabledUntil" the name of this attribute
...
setmetatable(DischargingEnabledUntil, {__call = DischargingEnabledUntil.new_value, __index = DischargingEnabledUntil.base_type})
