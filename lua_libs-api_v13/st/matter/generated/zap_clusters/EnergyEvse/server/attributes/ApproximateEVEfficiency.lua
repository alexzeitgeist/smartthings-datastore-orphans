...
--- @class st.matter.clusters.EnergyEvse.ApproximateEVEfficiency
--- @alias ApproximateEVEfficiency
---
--- @field public ID number 0x0027 the ID of this attribute
--- @field public NAME string "ApproximateEVEfficiency" the name of this attribute
...
setmetatable(ApproximateEVEfficiency, {__call = ApproximateEVEfficiency.new_value, __index = ApproximateEVEfficiency.base_type})
