...
--- @class st.matter.clusters.EnergyEvse.VehicleID
--- @alias VehicleID
---
--- @field public ID number 0x0032 the ID of this attribute
--- @field public NAME string "VehicleID" the name of this attribute
...
setmetatable(VehicleID, {__call = VehicleID.new_value, __index = VehicleID.base_type})
return VehicleID
