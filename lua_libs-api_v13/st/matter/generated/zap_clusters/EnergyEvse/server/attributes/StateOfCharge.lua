...
--- @class st.matter.clusters.EnergyEvse.StateOfCharge
--- @alias StateOfCharge
---
--- @field public ID number 0x0030 the ID of this attribute
--- @field public NAME string "StateOfCharge" the name of this attribute
...
setmetatable(StateOfCharge, {__call = StateOfCharge.new_value, __index = StateOfCharge.base_type})
