...
--- @class st.matter.clusters.EnergyEvse.NextChargeTargetSoC
--- @alias NextChargeTargetSoC
---
--- @field public ID number 0x0026 the ID of this attribute
--- @field public NAME string "NextChargeTargetSoC" the name of this attribute
...
setmetatable(NextChargeTargetSoC, {__call = NextChargeTargetSoC.new_value, __index = NextChargeTargetSoC.base_type})
