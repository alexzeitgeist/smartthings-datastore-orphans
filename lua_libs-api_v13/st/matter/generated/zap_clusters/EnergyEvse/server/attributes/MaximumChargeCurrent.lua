...
--- @class st.matter.clusters.EnergyEvse.MaximumChargeCurrent
--- @alias MaximumChargeCurrent
---
--- @field public ID number 0x0007 the ID of this attribute
--- @field public NAME string "MaximumChargeCurrent" the name of this attribute
...
setmetatable(MaximumChargeCurrent, {__call = MaximumChargeCurrent.new_value, __index = MaximumChargeCurrent.base_type})
