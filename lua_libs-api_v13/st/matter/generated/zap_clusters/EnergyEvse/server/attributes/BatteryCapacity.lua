...
--- @class st.matter.clusters.EnergyEvse.BatteryCapacity
--- @alias BatteryCapacity
---
--- @field public ID number 0x0031 the ID of this attribute
--- @field public NAME string "BatteryCapacity" the name of this attribute
...
setmetatable(BatteryCapacity, {__call = BatteryCapacity.new_value, __index = BatteryCapacity.base_type})
