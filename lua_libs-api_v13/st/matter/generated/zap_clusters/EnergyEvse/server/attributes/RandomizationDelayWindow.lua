...
--- @class st.matter.clusters.EnergyEvse.RandomizationDelayWindow
--- @alias RandomizationDelayWindow
---
--- @field public ID number 0x000A the ID of this attribute
--- @field public NAME string "RandomizationDelayWindow" the name of this attribute
...
setmetatable(RandomizationDelayWindow, {__call = RandomizationDelayWindow.new_value, __index = RandomizationDelayWindow.base_type})
