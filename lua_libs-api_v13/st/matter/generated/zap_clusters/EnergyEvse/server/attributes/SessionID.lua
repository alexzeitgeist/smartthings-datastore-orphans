...
--- @class st.matter.clusters.EnergyEvse.SessionID
--- @alias SessionID
---
--- @field public ID number 0x0040 the ID of this attribute
--- @field public NAME string "SessionID" the name of this attribute
...
setmetatable(SessionID, {__call = SessionID.new_value, __index = SessionID.base_type})
return SessionID
