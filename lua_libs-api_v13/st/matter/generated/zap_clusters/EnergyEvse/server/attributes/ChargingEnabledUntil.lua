...
--- @class st.matter.clusters.EnergyEvse.ChargingEnabledUntil
--- @alias ChargingEnabledUntil
---
--- @field public ID number 0x0003 the ID of this attribute
--- @field public NAME string "ChargingEnabledUntil" the name of this attribute
...
setmetatable(ChargingEnabledUntil, {__call = ChargingEnabledUntil.new_value, __index = ChargingEnabledUntil.base_type})
