...
--- @class st.matter.clusters.EnergyEvse.SessionEnergyCharged
--- @alias SessionEnergyCharged
---
--- @field public ID number 0x0042 the ID of this attribute
--- @field public NAME string "SessionEnergyCharged" the name of this attribute
...
setmetatable(SessionEnergyCharged, {__call = SessionEnergyCharged.new_value, __index = SessionEnergyCharged.base_type})
