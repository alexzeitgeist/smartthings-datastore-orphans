...
--- @class st.matter.clusters.EnergyEvse.CircuitCapacity
--- @alias CircuitCapacity
---
--- @field public ID number 0x0005 the ID of this attribute
--- @field public NAME string "CircuitCapacity" the name of this attribute
...
setmetatable(CircuitCapacity, {__call = CircuitCapacity.new_value, __index = CircuitCapacity.base_type})
