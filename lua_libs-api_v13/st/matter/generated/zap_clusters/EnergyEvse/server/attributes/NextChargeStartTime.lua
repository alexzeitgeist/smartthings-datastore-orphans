...
--- @class st.matter.clusters.EnergyEvse.NextChargeStartTime
--- @alias NextChargeStartTime
---
--- @field public ID number 0x0023 the ID of this attribute
--- @field public NAME string "NextChargeStartTime" the name of this attribute
...
setmetatable(NextChargeStartTime, {__call = NextChargeStartTime.new_value, __index = NextChargeStartTime.base_type})
