...
-----------------------------------------------------------
-- EnergyEvse command Disable
-----------------------------------------------------------

--- @class st.matter.clusters.EnergyEvse.Disable
--- @alias Disable
---
--- @field public ID number 0x0001 the ID of this command
--- @field public NAME string "Disable" the name of this command
local Disable = {}
...
---
--- @param self Disable the template class for this command
--- @param device st.matter.Device the device to build this message to
