...
-----------------------------------------------------------
-- EnergyEvse command SetTargets
-----------------------------------------------------------

--- @class st.matter.clusters.EnergyEvse.SetTargets
--- @alias SetTargets
---
--- @field public ID number 0x0005 the ID of this command
--- @field public NAME string "SetTargets" the name of this command
...
---
--- @param self SetTargets the template class for this command
--- @param device st.matter.Device the device to build this message to
