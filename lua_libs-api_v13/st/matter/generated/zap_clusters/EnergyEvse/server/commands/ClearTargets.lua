...
-----------------------------------------------------------
-- EnergyEvse command ClearTargets
-----------------------------------------------------------

--- @class st.matter.clusters.EnergyEvse.ClearTargets
--- @alias ClearTargets
---
--- @field public ID number 0x0007 the ID of this command
--- @field public NAME string "ClearTargets" the name of this command
local ClearTargets = {}
...
---
--- @param self ClearTargets the template class for this command
--- @param device st.matter.Device the device to build this message to
