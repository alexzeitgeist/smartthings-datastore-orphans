...
-----------------------------------------------------------
-- EnergyEvse command EnableCharging
-----------------------------------------------------------

--- @class st.matter.clusters.EnergyEvse.EnableCharging
--- @alias EnableCharging
---
--- @field public ID number 0x0002 the ID of this command
--- @field public NAME string "EnableCharging" the name of this command
--- @field public charging_enabled_until st.matter.data_types.Uint32
--- @field public minimum_charge_current st.matter.data_types.Int64
--- @field public maximum_charge_current st.matter.data_types.Int64
...
---
--- @param self EnableCharging the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param charging_enabled_until st.matter.data_types.Uint32
--- @param minimum_charge_current st.matter.data_types.Int64
--- @param maximum_charge_current st.matter.data_types.Int64
