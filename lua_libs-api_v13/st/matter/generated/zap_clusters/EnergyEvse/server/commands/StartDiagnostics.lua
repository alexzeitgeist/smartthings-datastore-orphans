...
-----------------------------------------------------------
-- EnergyEvse command StartDiagnostics
-----------------------------------------------------------

--- @class st.matter.clusters.EnergyEvse.StartDiagnostics
--- @alias StartDiagnostics
---
--- @field public ID number 0x0004 the ID of this command
--- @field public NAME string "StartDiagnostics" the name of this command
...
---
--- @param self StartDiagnostics the template class for this command
--- @param device st.matter.Device the device to build this message to
