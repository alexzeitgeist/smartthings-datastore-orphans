...
-----------------------------------------------------------
-- EnergyEvse command GetTargets
-----------------------------------------------------------

--- @class st.matter.clusters.EnergyEvse.GetTargets
--- @alias GetTargets
---
--- @field public ID number 0x0006 the ID of this command
--- @field public NAME string "GetTargets" the name of this command
local GetTargets = {}
...
--- Initialize the GetTargets command
---
--- @param self GetTargets the template class for this command
