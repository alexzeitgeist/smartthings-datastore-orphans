...
-----------------------------------------------------------
-- EnergyEvse command EnableDischarging
-----------------------------------------------------------

--- @class st.matter.clusters.EnergyEvse.EnableDischarging
--- @alias EnableDischarging
---
--- @field public ID number 0x0003 the ID of this command
--- @field public NAME string "EnableDischarging" the name of this command
--- @field public discharging_enabled_until st.matter.data_types.Uint32
--- @field public maximum_discharge_current st.matter.data_types.Int64
...
---
--- @param self EnableDischarging the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param discharging_enabled_until st.matter.data_types.Uint32
--- @param maximum_discharge_current st.matter.data_types.Int64
