...
--- @alias ChargingTargetScheduleStruct
--- @class st.matter.clusters.EnergyEvse.types.ChargingTargetScheduleStruct: st.matter.data_types.Structure
---
--- @field public day_of_week_for_sequence st.matter.generated.zap_clusters.EnergyEvse.types.TargetDayOfWeekBitmap
--- @field public charging_targets st.matter.data_types.Array
...
ChargingTargetScheduleStruct.field_defs = {
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.EnergyEvse.types.TargetDayOfWeekBitmap",
  },
  {
    ...
    element_type = require "st.matter.generated.zap_clusters.EnergyEvse.types.ChargingTargetStruct",
  },
}
