...
--- @alias ChargingTargetStruct
--- @class st.matter.clusters.EnergyEvse.types.ChargingTargetStruct: st.matter.data_types.Structure
---
--- @field public target_time_minutes_past_midnight st.matter.data_types.Uint16
--- @field public target_so_c st.matter.data_types.Uint8
--- @field public added_energy st.matter.data_types.Int64
