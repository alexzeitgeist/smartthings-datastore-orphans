...
-----------------------------------------------------------
-- EnergyEvse command GetTargetsResponse
-----------------------------------------------------------

--- @class st.matter.clusters.EnergyEvse.GetTargetsResponse
--- @alias GetTargetsResponse
---
--- @field public ID number 0x0000 the ID of this command
--- @field public NAME string "GetTargetsResponse" the name of this command
--- @field public charging_target_schedules st.matter.data_types.Array
local GetTargetsResponse = {}

GetTargetsResponse.NAME = "GetTargetsResponse"
GetTargetsResponse.ID = 0x0000
GetTargetsResponse.field_defs = {
  {
    ...
    element_type = require "st.matter.generated.zap_clusters.EnergyEvse.types.ChargingTargetScheduleStruct",
  },
}
...
function GetTargetsResponse:augment_type(base_type_obj)
  local elems = {}
...
--- @param charging_target_schedules st.matter.data_types.Array
--- @return st.matter.st.matter.interaction_model.InteractionResponse of type COMMAND_RESPONSE
function GetTargetsResponse:build_test_command_response(device, endpoint_id, charging_target_schedules, interaction_status)
  local function init(self, device, endpoint_id, charging_target_schedules)
    local out = {}
    ...
    setmetatable(out, {
      __index = GetTargetsResponse,
      __tostring = GetTargetsResponse.pretty_print
    })
  ...
  local self_request =  init(self, device, endpoint_id, charging_target_schedules)
...
---
--- @return nil
function GetTargetsResponse:init()
  return nil
end

function GetTargetsResponse:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

function GetTargetsResponse:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(GetTargetsResponse, {__call = GetTargetsResponse.init})
