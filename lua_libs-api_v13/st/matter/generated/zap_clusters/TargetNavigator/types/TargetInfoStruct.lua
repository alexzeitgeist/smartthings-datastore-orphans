...
--- @alias TargetInfoStruct
--- @class st.matter.clusters.TargetNavigator.types.TargetInfoStruct: st.matter.data_types.Structure
---
--- @field public identifier st.matter.data_types.Uint8
--- @field public name st.matter.data_types.UTF8String1
local TargetInfoStruct = {}
local new_mt = StructureABC.new_mt({NAME = "TargetInfoStruct", ID = data_types.name_to_id_map["Structure"]})

TargetInfoStruct.field_defs = {
  {
    name = "identifier",
    field_id = 0,
    is_nullable = false,
...
TargetInfoStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
TargetInfoStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = TargetInfoStruct.init
new_mt.__index.serialize = TargetInfoStruct.serialize

TargetInfoStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(TargetInfoStruct, new_mt)
