...
--- @class st.matter.clusters.TargetNavigator.TargetUpdated
--- @alias TargetUpdated
---
--- @field public ID number 0x0000 the ID of this event
--- @field public NAME string "TargetUpdated" the name of this event
--- @field public target_list st.matter.data_types.Array
--- @field public current_target st.matter.data_types.Uint8
...
function TargetUpdated:augment_type(base_type_obj)
  local elems = {}
...
function TargetUpdated:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function TargetUpdated:subscribe(device, endpoint_id)
...
--- Builds an TargetUpdated test event report reponse to be used by
...
function TargetUpdated:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "TargetUpdatedEventData", ID = 0x15}))
...
function TargetUpdated:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function TargetUpdated:set_parent_cluster(cluster)
