...
-----------------------------------------------------------
-- TargetNavigator command NavigateTargetResponse
-----------------------------------------------------------

--- @class st.matter.clusters.TargetNavigator.NavigateTargetResponse
--- @alias NavigateTargetResponse
---
--- @field public ID number 0x0001 the ID of this command
--- @field public NAME string "NavigateTargetResponse" the name of this command
--- @field public status st.matter.generated.zap_clusters.TargetNavigator.types.StatusEnum
--- @field public data st.matter.data_types.UTF8String1
local NavigateTargetResponse = {}

NavigateTargetResponse.NAME = "NavigateTargetResponse"
NavigateTargetResponse.ID = 0x0001
NavigateTargetResponse.field_defs = {
  {
    name = "status",
    field_id = 0,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.TargetNavigator.types.StatusEnum",
  },
  {
    name = "data",
    field_id = 1,
...
function NavigateTargetResponse:augment_type(base_type_obj)
  local elems = {}
...
--- Builds an NavigateTargetResponse test command reponse for the driver integration testing framework
---
--- @param device st.matter.Device the device to build this message to
--- @param endpoint_id number|nil
--- @param status st.matter.generated.zap_clusters.TargetNavigator.types.StatusEnum
...
function NavigateTargetResponse:build_test_command_response(device, endpoint_id, status, data, interaction_status)
  local function init(self, device, endpoint_id, status, data)
    ...
    setmetatable(out, {
      __index = NavigateTargetResponse,
      __tostring = NavigateTargetResponse.pretty_print
    })
...
--- Initialize the NavigateTargetResponse command
---
--- @return nil
function NavigateTargetResponse:init()
  return nil
end

function NavigateTargetResponse:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

function NavigateTargetResponse:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(NavigateTargetResponse, {__call = NavigateTargetResponse.init})
