...
--- @field public data_type st.matter.generated.zap_clusters.FanControl.types.FanModeSequenceEnum the data type of this attribute

local FanModeSequence = {
  ID = 0x0001,
  NAME = "FanModeSequence",
  base_type = require "st.matter.generated.zap_clusters.FanControl.types.FanModeSequenceEnum",
}
...
---
--- @vararg vararg the values needed to construct a FanModeSequenceEnum
--- @return st.matter.generated.zap_clusters.FanControl.types.FanModeSequenceEnum
...
setmetatable(FanModeSequence, {__call = FanModeSequence.new_value, __index = FanModeSequence.base_type})
