...
--- @field public data_type st.matter.generated.zap_clusters.FanControl.types.FanModeEnum the data type of this attribute

local FanMode = {
  ID = 0x0000,
  NAME = "FanMode",
  base_type = require "st.matter.generated.zap_clusters.FanControl.types.FanModeEnum",
}
...
---
--- @vararg vararg the values needed to construct a FanModeEnum
--- @return st.matter.generated.zap_clusters.FanControl.types.FanModeEnum
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.generated.zap_clusters.FanControl.types.FanModeEnum the value to write
...
setmetatable(FanMode, {__call = FanMode.new_value, __index = FanMode.base_type})
return FanMode
