...
-----------------------------------------------------------
-- FanControl command Step
-----------------------------------------------------------

--- @class st.matter.clusters.FanControl.Step
--- @alias Step
---
--- @field public ID number 0x0000 the ID of this command
--- @field public NAME string "Step" the name of this command
--- @field public direction st.matter.generated.zap_clusters.FanControl.types.StepDirectionEnum
--- @field public wrap st.matter.data_types.Boolean
--- @field public lowest_off st.matter.data_types.Boolean
local Step = {}
...
Step.field_defs = {
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.FanControl.types.StepDirectionEnum",
  },
  {
    name = "wrap",
    field_id = 1,
...
--- @param device st.matter.Device the device to build this message to
--- @param direction st.matter.generated.zap_clusters.FanControl.types.StepDirectionEnum
--- @param wrap st.matter.data_types.Boolean
--- @param lowest_off st.matter.data_types.Boolean

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function Step:init(device, endpoint_id, direction, wrap, lowest_off)
  local out = {}
  local args = {direction, wrap, lowest_off}
