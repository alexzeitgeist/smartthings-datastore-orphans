...
--- @field public move_mode st.matter.generated.zap_clusters.LevelControl.types.MoveModeEnum
...
MoveWithOnOff.field_defs = {
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.LevelControl.types.MoveModeEnum",
  },
  {
    name = "rate",
    field_id = 1,
...
--- @param device st.matter.Device the device to build this message to
--- @param move_mode st.matter.generated.zap_clusters.LevelControl.types.MoveModeEnum
