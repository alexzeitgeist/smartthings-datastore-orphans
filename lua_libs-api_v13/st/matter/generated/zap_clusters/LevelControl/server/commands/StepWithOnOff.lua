...
--- @field public step_mode st.matter.generated.zap_clusters.LevelControl.types.StepModeEnum
--- @field public step_size st.matter.data_types.Uint8
--- @field public transition_time st.matter.data_types.Uint16
--- @field public options_mask st.matter.generated.zap_clusters.LevelControl.types.OptionsBitmap
--- @field public options_override st.matter.generated.zap_clusters.LevelControl.types.OptionsBitmap
local StepWithOnOff = {}
...
StepWithOnOff.field_defs = {
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.LevelControl.types.StepModeEnum",
  },
  {
    name = "step_size",
    field_id = 1,
  ...
  },
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.LevelControl.types.OptionsBitmap",
  },
  {
...
--- @param device st.matter.Device the device to build this message to
--- @param step_mode st.matter.generated.zap_clusters.LevelControl.types.StepModeEnum
--- @param step_size st.matter.data_types.Uint8
--- @param transition_time st.matter.data_types.Uint16
--- @param options_mask st.matter.generated.zap_clusters.LevelControl.types.OptionsBitmap
--- @param options_override st.matter.generated.zap_clusters.LevelControl.types.OptionsBitmap
