...
do
  local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.LevelControl.server.attributes")
  if has_aliases then
    for alias, _ in pairs(aliases) do
      LevelControl.attribute_direction_map[alias] = "server"
    end
  end
end
...
do
  local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.LevelControl.server.commands")
  if has_aliases then
    for alias, _ in pairs(aliases) do
      LevelControl.command_direction_map[alias] = "server"
    end
  end
end

do
  local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.LevelControl.client.commands")
  if has_aliases then
    for alias, _ in pairs(aliases) do
      LevelControl.command_direction_map[alias] = "client"
    end
  end
end

LevelControl.FeatureMap = LevelControl.types.Feature
