...
--- @class st.matter.clusters.LevelControl.types.OptionsBitmap
--- @alias OptionsBitmap
---
...
OptionsBitmap.COUPLE_COLOR_TEMP_TO_LEVEL = 0x0002

OptionsBitmap.mask_fields = {
  BASE_MASK = 0xFFFF,
  EXECUTE_IF_OFF = 0x0001,
  COUPLE_COLOR_TEMP_TO_LEVEL = 0x0002,
}
...
--- @function OptionsBitmap:is_couple_color_temp_to_level_set
--- @return boolean True if the value of COUPLE_COLOR_TEMP_TO_LEVEL is non-zero
OptionsBitmap.is_couple_color_temp_to_level_set = function(self)
  return (self.value & self.COUPLE_COLOR_TEMP_TO_LEVEL) ~= 0
end

--- @function OptionsBitmap:set_couple_color_temp_to_level
--- Set the value of the bit in the COUPLE_COLOR_TEMP_TO_LEVEL field to 1
OptionsBitmap.set_couple_color_temp_to_level = function(self)
  if self.value ~= nil then
    self.value = self.value | self.COUPLE_COLOR_TEMP_TO_LEVEL
  else
    self.value = self.COUPLE_COLOR_TEMP_TO_LEVEL
  end
end

--- @function OptionsBitmap:unset_couple_color_temp_to_level
--- Set the value of the bits in the COUPLE_COLOR_TEMP_TO_LEVEL field to 0
OptionsBitmap.unset_couple_color_temp_to_level = function(self)
...
OptionsBitmap.mask_methods = {
  ...
  is_couple_color_temp_to_level_set = OptionsBitmap.is_couple_color_temp_to_level_set,
  set_couple_color_temp_to_level = OptionsBitmap.set_couple_color_temp_to_level,
  unset_couple_color_temp_to_level = OptionsBitmap.unset_couple_color_temp_to_level,
}
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.LevelControl.types.OptionsBitmap")
if has_aliases then
