...
--- @alias MeasurementAccuracyRangeStruct
--- @class st.matter.clusters.Global.types.MeasurementAccuracyRangeStruct: st.matter.data_types.Structure
---
--- @field public range_min st.matter.data_types.Int64
--- @field public range_max st.matter.data_types.Int64
--- @field public percent_max st.matter.data_types.Uint16
--- @field public percent_min st.matter.data_types.Uint16
--- @field public percent_typical st.matter.data_types.Uint16
--- @field public fixed_max st.matter.data_types.Uint64
--- @field public fixed_min st.matter.data_types.Uint64
--- @field public fixed_typical st.matter.data_types.Uint64
