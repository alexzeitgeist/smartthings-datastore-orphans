...
--- @alias ICEServerStruct
--- @class st.matter.clusters.Global.types.ICEServerStruct: st.matter.data_types.Structure
---
--- @field public urls st.matter.data_types.Array
--- @field public username st.matter.data_types.UTF8String1
--- @field public credential st.matter.data_types.UTF8String1
--- @field public caid st.matter.data_types.Uint16
local ICEServerStruct = {}
local new_mt = StructureABC.new_mt({NAME = "ICEServerStruct", ID = data_types.name_to_id_map["Structure"]})

ICEServerStruct.field_defs = {
  {
    name = "urls",
    field_id = 1,
    is_nullable = false,
...
ICEServerStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
ICEServerStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = ICEServerStruct.init
new_mt.__index.serialize = ICEServerStruct.serialize

ICEServerStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(ICEServerStruct, new_mt)

return ICEServerStruct
