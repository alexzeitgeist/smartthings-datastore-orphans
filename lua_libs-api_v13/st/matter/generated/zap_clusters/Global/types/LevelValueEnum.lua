...
--- @class st.matter.clusters.Global.types.LevelValueEnum: st.matter.data_types.Uint8
--- @alias LevelValueEnum
---
...
--- @field public CRITICAL number 4
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.Global.types.LevelValueEnum")
if has_aliases then
