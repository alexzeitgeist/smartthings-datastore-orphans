...
--- @alias ApplicationStruct
--- @class st.matter.clusters.Global.types.ApplicationStruct: st.matter.data_types.Structure
---
--- @field public catalog_vendor_id st.matter.data_types.Uint16
--- @field public application_id st.matter.data_types.UTF8String1
local ApplicationStruct = {}
local new_mt = StructureABC.new_mt({NAME = "ApplicationStruct", ID = data_types.name_to_id_map["Structure"]})

ApplicationStruct.field_defs = {
  {
    name = "catalog_vendor_id",
    field_id = 0,
    is_nullable = false,
    is_optional = false,
...
ApplicationStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
ApplicationStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = ApplicationStruct.init
new_mt.__index.serialize = ApplicationStruct.serialize

ApplicationStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(ApplicationStruct, new_mt)
