...
--- @alias TestGlobalStruct
--- @class st.matter.clusters.Global.types.TestGlobalStruct: st.matter.data_types.Structure
---
--- @field public name st.matter.data_types.UTF8String1
--- @field public my_bitmap st.matter.generated.zap_clusters.Global.types.TestGlobalBitmap
--- @field public my_enum st.matter.generated.zap_clusters.Global.types.TestGlobalEnum
local TestGlobalStruct = {}
local new_mt = StructureABC.new_mt({NAME = "TestGlobalStruct", ID = data_types.name_to_id_map["Structure"]})

TestGlobalStruct.field_defs = {
  {
    name = "name",
    field_id = 0,
    is_nullable = false,
  ...
  },
  {
    ...
    is_nullable = true,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.Global.types.TestGlobalBitmap",
  },
  {
    name = "my_enum",
    field_id = 2,
    is_nullable = true,
    is_optional = true,
    data_type = require "st.matter.generated.zap_clusters.Global.types.TestGlobalEnum",
  },
}

TestGlobalStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
TestGlobalStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = TestGlobalStruct.init
new_mt.__index.serialize = TestGlobalStruct.serialize

TestGlobalStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(TestGlobalStruct, new_mt)
