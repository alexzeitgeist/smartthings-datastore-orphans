...
--- @class st.matter.clusters.Global.types.ModeOptionStruct: st.matter.data_types.Structure
---
--- @field public label st.matter.data_types.UTF8String1
--- @field public mode st.matter.data_types.Uint8
--- @field public mode_tags st.matter.data_types.Array
...
ModeOptionStruct.field_defs = {
  ...
  },
  {
    ...
    element_type = require "st.matter.generated.zap_clusters.Global.types.ModeTagStruct",
  },
}
