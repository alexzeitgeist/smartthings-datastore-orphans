...
--- @class st.matter.clusters.Global.types.ChangeIndicationEnum: st.matter.data_types.Uint8
--- @alias ChangeIndicationEnum
---
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.Global.types.ChangeIndicationEnum")
if has_aliases then
