...
--- @class st.matter.clusters.Global.types.LocationDescriptorStruct: st.matter.data_types.Structure
---
--- @field public location_name st.matter.data_types.UTF8String1
--- @field public floor_number st.matter.data_types.Int16
--- @field public area_type st.matter.generated.zap_clusters.Global.types.AreaTypeTag
...
LocationDescriptorStruct.field_defs = {
  ...
  },
  {
    ...
    is_nullable = true,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.Global.types.AreaTypeTag",
  },
}
