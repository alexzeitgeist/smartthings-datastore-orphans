...
--- @alias LabelStruct
--- @class st.matter.clusters.Global.types.LabelStruct: st.matter.data_types.Structure
---
--- @field public label st.matter.data_types.UTF8String1
--- @field public value st.matter.data_types.UTF8String1
local LabelStruct = {}
local new_mt = StructureABC.new_mt({NAME = "LabelStruct", ID = data_types.name_to_id_map["Structure"]})

LabelStruct.field_defs = {
  {
    name = "label",
    field_id = 0,
    is_nullable = false,
...
LabelStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
LabelStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = LabelStruct.init
new_mt.__index.serialize = LabelStruct.serialize

LabelStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(LabelStruct, new_mt)
