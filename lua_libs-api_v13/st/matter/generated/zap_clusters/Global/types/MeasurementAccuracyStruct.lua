...
--- @alias MeasurementAccuracyStruct
--- @class st.matter.clusters.Global.types.MeasurementAccuracyStruct: st.matter.data_types.Structure
---
--- @field public measurement_type st.matter.generated.zap_clusters.Global.types.MeasurementTypeEnum
--- @field public measured st.matter.data_types.Boolean
--- @field public min_measured_value st.matter.data_types.Int64
--- @field public max_measured_value st.matter.data_types.Int64
--- @field public accuracy_ranges st.matter.data_types.Array
...
MeasurementAccuracyStruct.field_defs = {
  {
    ...
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.Global.types.MeasurementTypeEnum",
  },
  {
    name = "measured",
    field_id = 1,
  ...
  },
  {
    ...
    element_type = require "st.matter.generated.zap_clusters.Global.types.MeasurementAccuracyRangeStruct",
  },
}
