...
--- @alias AtomicAttributeStatusStruct
--- @class st.matter.clusters.Global.types.AtomicAttributeStatusStruct: st.matter.data_types.Structure
---
--- @field public attribute_id st.matter.data_types.Uint32
--- @field public status_code st.matter.data_types.Uint8
local AtomicAttributeStatusStruct = {}
local new_mt = StructureABC.new_mt({NAME = "AtomicAttributeStatusStruct", ID = data_types.name_to_id_map["Structure"]})

AtomicAttributeStatusStruct.field_defs = {
  {
    name = "attribute_id",
    field_id = 0,
    is_nullable = false,
...
AtomicAttributeStatusStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
AtomicAttributeStatusStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = AtomicAttributeStatusStruct.init
new_mt.__index.serialize = AtomicAttributeStatusStruct.serialize

AtomicAttributeStatusStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(AtomicAttributeStatusStruct, new_mt)

return AtomicAttributeStatusStruct
