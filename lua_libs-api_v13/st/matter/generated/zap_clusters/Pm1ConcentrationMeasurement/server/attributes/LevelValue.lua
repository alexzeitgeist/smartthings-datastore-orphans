...
--- @class st.matter.clusters.Pm1ConcentrationMeasurement.LevelValue
--- @alias LevelValue
---
--- @field public ID number 0x000A the ID of this attribute
--- @field public NAME string "LevelValue" the name of this attribute
--- @field public data_type st.matter.generated.zap_clusters.Pm1ConcentrationMeasurement.types.LevelValueEnum the data type of this attribute

local LevelValue = {
  ID = 0x000A,
  NAME = "LevelValue",
  base_type = require "st.matter.generated.zap_clusters.Pm1ConcentrationMeasurement.types.LevelValueEnum",
}
...
--- @return st.matter.generated.zap_clusters.Pm1ConcentrationMeasurement.types.LevelValueEnum
