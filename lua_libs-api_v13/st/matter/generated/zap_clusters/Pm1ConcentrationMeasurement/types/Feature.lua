...
--- @class st.matter.clusters.Pm1ConcentrationMeasurement.types.Feature
--- @alias Feature
---
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.Pm1ConcentrationMeasurement.types.Feature")
if has_aliases then
