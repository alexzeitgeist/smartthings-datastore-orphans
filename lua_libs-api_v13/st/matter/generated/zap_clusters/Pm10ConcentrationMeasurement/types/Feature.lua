...
--- @class st.matter.clusters.Pm10ConcentrationMeasurement.types.Feature
--- @alias Feature
---
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.Pm10ConcentrationMeasurement.types.Feature")
if has_aliases then
