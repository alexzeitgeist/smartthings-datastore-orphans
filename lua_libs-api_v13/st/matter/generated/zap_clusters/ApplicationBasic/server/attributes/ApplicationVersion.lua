...
--- @class st.matter.clusters.ApplicationBasic.ApplicationVersion
...
function ApplicationVersion:read(device, endpoint_id)
...
--- Reporting policy: ApplicationVersion => true => mandatory
...
--- @param endpoint_id number|nil
--- @return any
function ApplicationVersion:subscribe(device, endpoint_id)
...
--- Builds an ApplicationVersion test attribute reponse for the driver integration testing framework
---
...
function ApplicationVersion:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ApplicationVersion:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(ApplicationVersion, {__call = ApplicationVersion.new_value, __index = ApplicationVersion.base_type})
