...
--- @alias AirQualityEnum
---
--- @field public byte_length number 1
--- @field public UNKNOWN number 0
--- @field public GOOD number 1
--- @field public FAIR number 2
--- @field public MODERATE number 3
--- @field public POOR number 4
--- @field public VERY_POOR number 5
--- @field public EXTREMELY_POOR number 6
