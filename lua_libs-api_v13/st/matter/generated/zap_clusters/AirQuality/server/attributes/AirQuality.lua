...
--- @field public NAME string "AirQuality" the name of this attribute
--- @field public data_type st.matter.generated.zap_clusters.AirQuality.types.AirQualityEnum the data type of this attribute

local AirQuality = {
  ID = 0x0000,
  NAME = "AirQuality",
  base_type = require "st.matter.generated.zap_clusters.AirQuality.types.AirQualityEnum",
}
...
--- @return st.matter.generated.zap_clusters.AirQuality.types.AirQualityEnum
