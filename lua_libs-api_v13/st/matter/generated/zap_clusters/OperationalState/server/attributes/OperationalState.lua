...
--- @field public data_type st.matter.generated.zap_clusters.OperationalState.types.OperationalStateEnum the data type of this attribute

local OperationalState = {
  ID = 0x0004,
  NAME = "OperationalState",
  base_type = require "st.matter.generated.zap_clusters.OperationalState.types.OperationalStateEnum",
}
...
--- @return st.matter.generated.zap_clusters.OperationalState.types.OperationalStateEnum
