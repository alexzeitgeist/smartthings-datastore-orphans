...
--- @field public data_type st.matter.generated.zap_clusters.OperationalState.types.ErrorStateStruct the data type of this attribute

local OperationalError = {
  ID = 0x0005,
  NAME = "OperationalError",
  base_type = require "st.matter.generated.zap_clusters.OperationalState.types.ErrorStateStruct",
}
...
--- @return st.matter.generated.zap_clusters.OperationalState.types.ErrorStateStruct
