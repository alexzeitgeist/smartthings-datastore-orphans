...
--- @class st.matter.clusters.BasicInformation.SoftwareVersion
...
setmetatable(SoftwareVersion, {__call = SoftwareVersion.new_value, __index = SoftwareVersion.base_type})
