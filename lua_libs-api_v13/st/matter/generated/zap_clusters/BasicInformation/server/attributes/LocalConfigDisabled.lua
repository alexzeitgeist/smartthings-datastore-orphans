...
--- @class st.matter.clusters.BasicInformation.LocalConfigDisabled
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.data_types.Boolean the value to write
...
setmetatable(LocalConfigDisabled, {__call = LocalConfigDisabled.new_value, __index = LocalConfigDisabled.base_type})
