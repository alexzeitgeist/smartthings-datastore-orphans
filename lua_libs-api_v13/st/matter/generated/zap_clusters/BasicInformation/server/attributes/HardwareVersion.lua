...
--- @class st.matter.clusters.BasicInformation.HardwareVersion
...
setmetatable(HardwareVersion, {__call = HardwareVersion.new_value, __index = HardwareVersion.base_type})
