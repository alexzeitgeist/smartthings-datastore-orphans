...
--- @class st.matter.clusters.BasicInformation.ManufacturingDate
...
setmetatable(ManufacturingDate, {__call = ManufacturingDate.new_value, __index = ManufacturingDate.base_type})
