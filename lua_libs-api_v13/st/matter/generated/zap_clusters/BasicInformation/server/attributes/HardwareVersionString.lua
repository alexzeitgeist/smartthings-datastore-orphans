...
--- @class st.matter.clusters.BasicInformation.HardwareVersionString
...
setmetatable(HardwareVersionString, {__call = HardwareVersionString.new_value, __index = HardwareVersionString.base_type})
