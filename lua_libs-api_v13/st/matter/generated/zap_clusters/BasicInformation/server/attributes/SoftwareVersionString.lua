...
--- @class st.matter.clusters.BasicInformation.SoftwareVersionString
...
setmetatable(SoftwareVersionString, {__call = SoftwareVersionString.new_value, __index = SoftwareVersionString.base_type})
