...
--- @class st.matter.clusters.BasicInformation.DataModelRevision
...
setmetatable(DataModelRevision, {__call = DataModelRevision.new_value, __index = DataModelRevision.base_type})
