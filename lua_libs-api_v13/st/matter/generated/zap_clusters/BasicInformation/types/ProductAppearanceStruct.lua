...
--- @alias ProductAppearanceStruct
--- @class st.matter.clusters.BasicInformation.types.ProductAppearanceStruct: st.matter.data_types.Structure
---
--- @field public finish st.matter.generated.zap_clusters.BasicInformation.types.ProductFinishEnum
--- @field public primary_color st.matter.generated.zap_clusters.BasicInformation.types.ColorEnum
local ProductAppearanceStruct = {}
local new_mt = StructureABC.new_mt({NAME = "ProductAppearanceStruct", ID = data_types.name_to_id_map["Structure"]})

ProductAppearanceStruct.field_defs = {
  {
    name = "finish",
    field_id = 0,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.BasicInformation.types.ProductFinishEnum",
  },
  {
    name = "primary_color",
    field_id = 1,
    is_nullable = true,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.BasicInformation.types.ColorEnum",
  },
}

ProductAppearanceStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
ProductAppearanceStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = ProductAppearanceStruct.init
new_mt.__index.serialize = ProductAppearanceStruct.serialize

ProductAppearanceStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(ProductAppearanceStruct, new_mt)
