...
--- @field public data_type st.matter.generated.zap_clusters.WindowCovering.types.Mode the data type of this attribute

local Mode = {
  ID = 0x0017,
  NAME = "Mode",
  base_type = require "st.matter.generated.zap_clusters.WindowCovering.types.Mode",
}

--- Create a Mode object of this attribute with any additional features provided for the attribute
--- This is also usable with the Mode(...) syntax
---
--- @vararg vararg the values needed to construct a Mode
--- @return st.matter.generated.zap_clusters.WindowCovering.types.Mode
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.generated.zap_clusters.WindowCovering.types.Mode the value to write
...
setmetatable(Mode, {__call = Mode.new_value, __index = Mode.base_type})
return Mode
