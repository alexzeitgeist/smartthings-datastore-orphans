...
--- @field public data_type st.matter.generated.zap_clusters.WindowCovering.types.Type the data type of this attribute

local Type = {
  ID = 0x0000,
  NAME = "Type",
  base_type = require "st.matter.generated.zap_clusters.WindowCovering.types.Type",
}
...
--- @return st.matter.generated.zap_clusters.WindowCovering.types.Type
...
setmetatable(Type, {__call = Type.new_value, __index = Type.base_type})
return Type
