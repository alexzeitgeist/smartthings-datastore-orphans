...
--- @field public data_type st.matter.generated.zap_clusters.WindowCovering.types.EndProductType the data type of this attribute

local EndProductType = {
  ID = 0x000D,
  NAME = "EndProductType",
  base_type = require "st.matter.generated.zap_clusters.WindowCovering.types.EndProductType",
}

--- Create a EndProductType object of this attribute with any additional features provided for the attribute
--- This is also usable with the EndProductType(...) syntax
---
--- @vararg vararg the values needed to construct a EndProductType
--- @return st.matter.generated.zap_clusters.WindowCovering.types.EndProductType
...
setmetatable(EndProductType, {__call = EndProductType.new_value, __index = EndProductType.base_type})
