...
--- @field public data_type st.matter.generated.zap_clusters.WindowCovering.types.SafetyStatus the data type of this attribute

local SafetyStatus = {
  ID = 0x001A,
  NAME = "SafetyStatus",
  base_type = require "st.matter.generated.zap_clusters.WindowCovering.types.SafetyStatus",
}

--- Create a SafetyStatus object of this attribute with any additional features provided for the attribute
--- This is also usable with the SafetyStatus(...) syntax
---
--- @vararg vararg the values needed to construct a SafetyStatus
--- @return st.matter.generated.zap_clusters.WindowCovering.types.SafetyStatus
...
setmetatable(SafetyStatus, {__call = SafetyStatus.new_value, __index = SafetyStatus.base_type})
return SafetyStatus
