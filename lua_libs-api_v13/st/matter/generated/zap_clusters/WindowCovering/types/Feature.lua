...
function Feature.bits_are_valid(feature)
  local max =
    Feature.LIFT |
    Feature.TILT |
    Feature.POSITION_AWARE_LIFT |
    Feature.ABSOLUTE_POSITION |
    Feature.POSITION_AWARE_TILT
...
local has_aliases, aliases = pcall(require, "st.matter.clusters.aliases.WindowCovering.types.Feature")
if has_aliases then
