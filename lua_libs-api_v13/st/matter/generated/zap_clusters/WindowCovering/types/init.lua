...
types_mt.__index = function(self, key)
  if types_mt.__types_cache[key] == nil then
    types_mt.__types_cache[key] = require("st.matter.generated.zap_clusters.WindowCovering.types." .. key)
  end
...
local status, aliases = pcall(require, "st.matter.clusters.aliases.WindowCovering.types")
if status then
  aliases:add_to_class(WindowCoveringTypes)
end
