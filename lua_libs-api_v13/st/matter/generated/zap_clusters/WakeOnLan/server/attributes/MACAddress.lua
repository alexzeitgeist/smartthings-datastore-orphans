...
--- @class st.matter.clusters.WakeOnLan.MACAddress
--- @alias MACAddress
---
--- @field public ID number 0x0000 the ID of this attribute
--- @field public NAME string "MACAddress" the name of this attribute
...
function MACAddress:read(device, endpoint_id)
...
--- Reporting policy: MACAddress => true => mandatory
...
--- @param endpoint_id number|nil
--- @return any
function MACAddress:subscribe(device, endpoint_id)
...
function MACAddress:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

--- Builds an MACAddress test attribute reponse for the driver integration testing framework
---
...
function MACAddress:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MACAddress:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(MACAddress, {__call = MACAddress.new_value, __index = MACAddress.base_type})
return MACAddress
