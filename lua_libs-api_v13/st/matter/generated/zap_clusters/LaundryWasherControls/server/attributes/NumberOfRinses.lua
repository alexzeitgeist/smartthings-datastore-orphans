...
--- @class st.matter.clusters.LaundryWasherControls.NumberOfRinses
--- @alias NumberOfRinses
---
--- @field public ID number 0x0002 the ID of this attribute
--- @field public NAME string "NumberOfRinses" the name of this attribute
--- @field public data_type st.matter.generated.zap_clusters.LaundryWasherControls.types.NumberOfRinsesEnum the data type of this attribute

local NumberOfRinses = {
  ID = 0x0002,
  NAME = "NumberOfRinses",
  base_type = require "st.matter.generated.zap_clusters.LaundryWasherControls.types.NumberOfRinsesEnum",
}

--- Create a NumberOfRinsesEnum object of this attribute with any additional features provided for the attribute
--- This is also usable with the NumberOfRinses(...) syntax
---
--- @vararg vararg the values needed to construct a NumberOfRinsesEnum
--- @return st.matter.generated.zap_clusters.LaundryWasherControls.types.NumberOfRinsesEnum
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.generated.zap_clusters.LaundryWasherControls.types.NumberOfRinsesEnum the value to write
...
--- Reporting policy: NumberOfRinses => true => mandatory
...
--- Builds an NumberOfRinses test attribute reponse for the driver integration testing framework
---
