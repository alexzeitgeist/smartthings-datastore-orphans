...
--- @class st.matter.clusters.LaundryWasherControls.SpinSpeeds
--- @alias SpinSpeeds
---
--- @field public ID number 0x0000 the ID of this attribute
--- @field public NAME string "SpinSpeeds" the name of this attribute
...
--- This is also usable with the SpinSpeeds(...) syntax
---
...
--- Reporting policy: SpinSpeeds => true => mandatory
...
--- Builds an SpinSpeeds test attribute reponse for the driver integration testing framework
---
