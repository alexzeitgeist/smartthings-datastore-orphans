...
--- @class st.matter.clusters.LaundryWasherControls.SpinSpeedCurrent
--- @alias SpinSpeedCurrent
---
--- @field public ID number 0x0001 the ID of this attribute
--- @field public NAME string "SpinSpeedCurrent" the name of this attribute
...
--- This is also usable with the SpinSpeedCurrent(...) syntax
---
...
--- Reporting policy: SpinSpeedCurrent => true => mandatory
...
--- Builds an SpinSpeedCurrent test attribute reponse for the driver integration testing framework
---
