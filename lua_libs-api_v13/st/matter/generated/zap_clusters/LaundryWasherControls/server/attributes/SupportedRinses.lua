...
--- @class st.matter.clusters.LaundryWasherControls.SupportedRinses
--- @alias SupportedRinses
---
--- @field public ID number 0x0003 the ID of this attribute
--- @field public NAME string "SupportedRinses" the name of this attribute
...
local SupportedRinses = {
  ...
  element_type = require "st.matter.generated.zap_clusters.LaundryWasherControls.types.NumberOfRinsesEnum",
}
...
--- This is also usable with the SupportedRinses(...) syntax
---
...
--- Reporting policy: SupportedRinses => true => mandatory
...
--- Builds an SupportedRinses test attribute reponse for the driver integration testing framework
---
