...
--- @class st.matter.clusters.ActivatedCarbonFilterMonitoring.LastChangedTime
--- @alias LastChangedTime
---
--- @field public ID number 0x0004 the ID of this attribute
--- @field public NAME string "LastChangedTime" the name of this attribute
...
function LastChangedTime:new_value(...)
...
function LastChangedTime:read(device, endpoint_id)
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.data_types.Uint32 the value to write
--- @return st.matter.interaction_model.InteractionRequest
function LastChangedTime:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function LastChangedTime:subscribe(device, endpoint_id)
...
function LastChangedTime:set_parent_cluster(cluster)
...
function LastChangedTime:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function LastChangedTime:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(LastChangedTime, {__call = LastChangedTime.new_value, __index = LastChangedTime.base_type})
