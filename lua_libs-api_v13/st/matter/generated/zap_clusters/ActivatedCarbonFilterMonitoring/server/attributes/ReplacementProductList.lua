...
--- @class st.matter.clusters.ActivatedCarbonFilterMonitoring.ReplacementProductList
--- @alias ReplacementProductList
---
--- @field public ID number 0x0005 the ID of this attribute
--- @field public NAME string "ReplacementProductList" the name of this attribute
--- @field public data_type st.matter.data_types.Array the data type of this attribute

local ReplacementProductList = {
  ID = 0x0005,
  NAME = "ReplacementProductList",
  base_type = require "st.matter.data_types.Array",
  element_type = require "st.matter.generated.zap_clusters.ActivatedCarbonFilterMonitoring.types.ReplacementProductStruct",
}

--- Add additional functionality to the base type object
---
--- @param base_type_obj st.matter.data_types.Array the base data type object to add functionality to
function ReplacementProductList:augment_type(data_type_obj)
  for i, v in ipairs(data_type_obj.elements) do
    data_type_obj.elements[i] = data_types.validate_or_build_type(v, ReplacementProductList.element_type)
  end
end
...
function ReplacementProductList:new_value(...)
...
function ReplacementProductList:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ReplacementProductList:subscribe(device, endpoint_id)
...
function ReplacementProductList:set_parent_cluster(cluster)
...
function ReplacementProductList:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ReplacementProductList:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(ReplacementProductList, {__call = ReplacementProductList.new_value, __index = ReplacementProductList.base_type})
