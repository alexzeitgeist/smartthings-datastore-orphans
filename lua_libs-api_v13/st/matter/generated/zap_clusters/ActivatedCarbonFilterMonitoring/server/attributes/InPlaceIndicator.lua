...
--- @class st.matter.clusters.ActivatedCarbonFilterMonitoring.InPlaceIndicator
--- @alias InPlaceIndicator
---
--- @field public ID number 0x0003 the ID of this attribute
--- @field public NAME string "InPlaceIndicator" the name of this attribute
--- @field public data_type st.matter.data_types.Boolean the data type of this attribute

local InPlaceIndicator = {
  ID = 0x0003,
...
function InPlaceIndicator:new_value(...)
...
function InPlaceIndicator:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function InPlaceIndicator:subscribe(device, endpoint_id)
...
function InPlaceIndicator:set_parent_cluster(cluster)
...
function InPlaceIndicator:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function InPlaceIndicator:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)

  return data
end

setmetatable(InPlaceIndicator, {__call = InPlaceIndicator.new_value, __index = InPlaceIndicator.base_type})
