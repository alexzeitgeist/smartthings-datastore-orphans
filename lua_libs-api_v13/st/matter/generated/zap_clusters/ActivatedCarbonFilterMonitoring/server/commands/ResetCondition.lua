...
-----------------------------------------------------------
-- ActivatedCarbonFilterMonitoring command ResetCondition
-----------------------------------------------------------

--- @class st.matter.clusters.ActivatedCarbonFilterMonitoring.ResetCondition
--- @alias ResetCondition
---
--- @field public ID number 0x0000 the ID of this command
--- @field public NAME string "ResetCondition" the name of this command
...
---
--- @param self ResetCondition the template class for this command
--- @param device st.matter.Device the device to build this message to
