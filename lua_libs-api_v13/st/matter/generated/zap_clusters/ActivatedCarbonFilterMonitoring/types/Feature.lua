...
--- @class st.matter.clusters.ActivatedCarbonFilterMonitoring.types.Feature
--- @alias Feature
---
--- @field public CONDITION number 1
--- @field public WARNING number 2
--- @field public REPLACEMENT_PRODUCT_LIST number 4
...
--- @function Feature:is_condition_set
--- @return boolean True if the value of CONDITION is non-zero
Feature.is_condition_set = function(self)
  return (self.value & self.CONDITION) ~= 0
end

--- @function Feature:set_condition
...
--- @function Feature:unset_condition
...
--- @function Feature:is_warning_set
--- @return boolean True if the value of WARNING is non-zero
Feature.is_warning_set = function(self)
  return (self.value & self.WARNING) ~= 0
end

--- @function Feature:set_warning
...
--- @function Feature:unset_warning
...
--- @function Feature:is_replacement_product_list_set
--- @return boolean True if the value of REPLACEMENT_PRODUCT_LIST is non-zero
Feature.is_replacement_product_list_set = function(self)
  return (self.value & self.REPLACEMENT_PRODUCT_LIST) ~= 0
end

--- @function Feature:set_replacement_product_list
...
--- @function Feature:unset_replacement_product_list
