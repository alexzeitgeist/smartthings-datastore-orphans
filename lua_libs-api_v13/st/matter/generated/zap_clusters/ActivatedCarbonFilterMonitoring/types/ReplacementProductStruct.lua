...
--- @alias ReplacementProductStruct
--- @class st.matter.clusters.ActivatedCarbonFilterMonitoring.types.ReplacementProductStruct: st.matter.data_types.Structure
---
--- @field public product_identifier_type st.matter.generated.zap_clusters.ActivatedCarbonFilterMonitoring.types.ProductIdentifierTypeEnum
--- @field public product_identifier_value st.matter.data_types.UTF8String1
local ReplacementProductStruct = {}
local new_mt = StructureABC.new_mt({NAME = "ReplacementProductStruct", ID = data_types.name_to_id_map["Structure"]})

ReplacementProductStruct.field_defs = {
  {
    name = "product_identifier_type",
    field_id = 0,
    is_nullable = false,
    is_optional = false,
    data_type = require "st.matter.generated.zap_clusters.ActivatedCarbonFilterMonitoring.types.ProductIdentifierTypeEnum",
  },
  {
...
ReplacementProductStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
ReplacementProductStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = ReplacementProductStruct.init
new_mt.__index.serialize = ReplacementProductStruct.serialize

ReplacementProductStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(ReplacementProductStruct, new_mt)

return ReplacementProductStruct
